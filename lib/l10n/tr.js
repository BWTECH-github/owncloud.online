OC.L10N.register(
    ...
    "Server version %s or higher is required." : "owncloud.online %s veya daha üstü gerekli.",
    "Server version %s or lower is required." : "owncloud.online %s veya daha düşük sürüm gerekli.",
    "%s is member of a group not allowed to access through this login mechanism" : "%s, bu oturum açma mekanizması aracılığıyla erişmesine izin verilmeyen bir grubun üyesidir",
    "%s isn't member of a group allowed to access through this login mechanism" : "%s, bu oturum açma mekanizması aracılığıyla erişmesine izin verilen bir grubun üyesi değil",
    "A login policy has blocked the login" : "Bir oturum açma politikası oturum açmayı engelledi",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "owncloud.online sürümünüz ile uyumsuz olduğu için uygulama kurulamıyor",
    ...
    "No license key available." : "Kullanılabilir lisans anahtarı yok.",
    "Invalid license key!" : "Geçersiz lisans anahtarı!",
    "Please contact your administrator or %s for a new license key." : "Yeni bir lisans anahtarı için lütfen yöneticinizle veya %s ile iletişime geçin.",
    "Your Enterprise license key has expired." : "Kurumsal lisans anahtarınızın süresi doldu.",
    "Enterprise features have been disabled." : "Kurumsal özellikler devre dışı bırakıldı.",
    "Evaluation - expires today." : "Değerlendirme - bugün sona eriyor.",
    "Evaluation - expires in %d days." : "Değerlendirme - %d gün içinde sona eriyor.",
    "Your Enterprise license key is about to expire (days remaining: %d)." : "Kurumsal lisans anahtarınızın süresi dolmak üzere (kalan gün sayısı: %d).",
    "The registered enterprise license key expires in %d days" : "Kayıtlı kurumsal lisans anahtarının süresi %d gün içinde doluyor",
    ...
    "Can't update %s - it is a directory" : "%s güncellenemiyor - bu bir dizin",
    ...
    "The special username %s is not allowed" : "Özel kullanıcı adı %s'e izin verilmiyor",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "Bu ayarı php.ini içerisinde ayarlamak owncloud.online'ı tekrar çalıştıracak.",
