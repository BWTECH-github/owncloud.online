OC.L10N.register(
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "Официалните приложения се разработват от и в рамките на owncloud.online общността. Те предлагат допълнителна функционалност на owncloud.online и са готови за производствена употреба.",
    ...
    "This app has no minimum server version assigned. This will be an error in version 11 and later." : "Това приложение няма зададена минимална версия на owncloud.online. Това ще доведе до грешка в owncloud.online 11 и по-нови версии.",
    "This app has no maximum server version assigned. This will be an error in version 11 and later." : "Това приложение няма зададена максимална версия на owncloud.online. Това ще доведе до грешка в owncloud.online 11 и по-нови версии.",
    ...
    "Encryption alone does not guarantee security of the system. Please see the owncloud.online documentation for more information about how the encryption app works, and the supported use cases." : "Криптирането не гарантира сигурността на системата. Моля, вижте owncloud.online документацията за повече информация за това как функционира приложението за шифроване и за поддържаните случаи на използване.",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "Трябва да прехвърлите ключовете си за криптиране от старото криптиране (owncloud.online <= 8.0) към новото. Моля, активирайте \"Модул за криптиране по подразбиране\" и стартирайте \"occ encryption:migrate\"",
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : "Трябва да прехвърлите ключовете си за криптиране от старото криптиране (owncloud.online <= 8.0) към новото.",
