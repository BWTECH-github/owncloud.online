OC.L10N.register(
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "Oficiální aplikace jsou vyvíjeny komunitou owncloud.online. Nabízejí funkce důležité pro owncloud.online a jsou připraveny pro nasazení v produkčním prostředí.",
    ...
    "This app has no minimum server version assigned. This will be an error in version 11 and later." : "Tato aplikace nemá přiřazenou nejnižší verzi owncloud.online. Toto povede k chybě v owncloud.online 11 a vyšším.",
    "This app has no maximum server version assigned. This will be an error in version 11 and later." : "Tato aplikace nemá přiřazenou nejvyšší verzi owncloud.online. Toto povede k chybě v owncloud.online 11 a vyšším.",
    ...
    "Encryption alone does not guarantee security of the system. Please see the owncloud.online documentation for more information about how the encryption app works, and the supported use cases." : "Samotné šifrování nezajistí bezpečnost systému. Projděte si dokumentaci aplikace owncloud.online pro více informací o tom jak šifrovací aplikace funguje a jejím správném použití.",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "Musíte přenést své šifrovací klíče ze staré verze šifrování (owncloud.online <= 8.0) na novou. Povolte prosím \"Default encryption module\" a spusťte příkaz 'occ encryption:migrate'",
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : "Musíte přenést své šifrovací klíče ze staré verze šifrování (owncloud.online <= 8.0) na novou.",
