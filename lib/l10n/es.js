OC.L10N.register(
    ...
    "Server version %s or higher is required." : "Se requiere owncloud.online %s o superior.",
    "Server version %s or lower is required." : "Se requiere owncloud.online %s o una versión inferior.",
    "%s is member of a group not allowed to access through this login mechanism" : "%s es miembro de un grupo en el que no se permite el acceso a través del mecanismo de inicio de sesión",
    "%s isn't member of a group allowed to access through this login mechanism" : "%s no es miembro de un grupo en el que se permita el acceso a través del mecanismo de inicio de sesión",
    "A login policy has blocked the login" : "Una política de inicio de sesión ha bloqueado el inicio de sesión",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "La aplicación no se puede instalar porque no es compatible con esta versión de owncloud.online",
    ...
    "No license key available." : "La Clave de licencia no está disponible",
    "Invalid license key!" : "La clave de licencia no es válida",
    "Please contact your administrator or %s for a new license key." : "Comuníquese con su administrador o con %s para obtener una nueva clave de licencia.",
    "Your Enterprise license key has expired." : "Su clave de licencia Enterprise ha caducado.",
    "Enterprise features have been disabled." : "Se han desactivado las funciones empresariales.",
    "Evaluation - expires today." : "Evaluación - expira hoy.",
    "Evaluation - expires in %d days." : "Evaluación - caduca en %d días.",
    "Your Enterprise license key is about to expire (days remaining: %d)." : "Su clave de licencia Enterprise está a punto de caducar (días restantes: %d).",
    "The registered enterprise license key expires in %d days" : "La clave de licencia empresarial registrada caduca en %d días",
    "New Design" : "Nuevos diseños",
    "Apps" : "Aplicaciones",
    "General" : "General",
    ...
    "%s enter the database name or connection string." : "%s introduzca el nombre de la base de datos o cadena de conexión.",
    ...
    "Can't create or write into the apps-external directory %s" : "No puedo crear o escribir en la carpeta externa %s",
    "Can't update %s - it is a directory" : "No es posible actualizar %s -  es una carpeta",
    "Can't update %s" : "No se puede actualizar %s",
    "Invalid Federated Cloud ID" : "ID Nube federada inválida",
    "Internal mail notification for shared files is not allowed" : "No se permite la notificación por correo interno para archivos compartidos",
    "%s shared »%s« with you" : "%s ha compartido »%s« contigo",
    "Public link mail notification is not allowed" : "No se permite la notificación por correo de enlaces públicos",
    "%s" : "%s",
    "%s via %s" : "%s vía %s",
    "Sharing %s failed, because the backend does not allow shares from type %d" : "Compartir %s ha fallado porque el mecanismo no permite compartidos del tipo %d",
    ...
    "The special username %s is not allowed" : "El nombre especial %s NO está permitido",
    ...
    "Access to this resource or one of its sub-items has been denied." : "El acceso a este recurso o uno de sus sub-elementos ha sido denegado.",
    "File cannot be downloaded" : "El archivo no puede ser descargado",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "Ajustando esta opción en php.ini permitirá que owncloud.online vuelva a funcionar",
