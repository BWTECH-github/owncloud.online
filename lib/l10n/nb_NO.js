OC.L10N.register(
    ...
    "Server version %s or higher is required." : "owncloud.online %s eller høyere kreves.",
    "Server version %s or lower is required." : "owncloud.online %s eller lavere kreves.",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "App kan ikke installeres fordi den ikke er kompatibel med denne versjonen av owncloud.online",
    ...
    "%s" : "%s",
    "%s via %s" : "%s via %s",
    "Sharing %s failed, because the backend does not allow shares from type %d" : "Deling av %s feilet, fordi serveren ikke tillater delinger fra type %d",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "Endring av denne innstillingen i php.ini vil få owncloud.online til å kjøre igjen.",
