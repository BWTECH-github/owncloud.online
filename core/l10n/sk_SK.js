OC.L10N.register(
    "core",
    {
    "Login paused for a moment" : "Prihlásenie je na chvíľu pozastavené",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "Z vášho pripojenia prebehlo niekoľko neúspešných pokusov, preto prihlasovanie nakrátko spomaľujeme, aby sme ochránili váš účet.",
    "You can try again in %s." : "Do ďalšieho pokusu zostáva: %s.",
    "You can try again now." : "Teraz to môžete skúsiť znova.",
    "Forgotten your password? Use the reset link instead of trying again." : "Zabudli ste heslo? Použite odkaz na obnovenie namiesto ďalších pokusov.",
    "_%n second_::_%n seconds_" : ["%n sekunda", "%n sekundy", "%n sekúnd", "%n sekúnd"],
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "Konfigurácia hlavičiek reverse proxy nie je správna alebo pristupujete k owncloud.online z dôveryhodného proxy servera. Ak k owncloud.online nepristupujete z dôveryhodného proxy servera, vzniká bezpečnostné riziko - IP adresa potenciálneho útočníka, ktorú vidí owncloud.online, môže byť falošná. Viac informácií nájdete v našej <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">dokumentácii</a>.",
    ...
    "User" : "Používateľ",
    "Group" : "Skupina",
    "Share with people on other servers using the syntax username@example.com/owncloud" : "Zdieľať s ľuďmi na iných serveroch owncloud.onlines pomocou syntaxe používateľ@doména.com/owncloud",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "Aktualizácia nebola úspešná. Problém nahláste <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online comunite</a>.",
    "The update was successful. There were warnings." : "Aktualizácia bola úspešná. Vyskytli sa upozornenia.",
    "The update was successful. Redirecting you to owncloud.online now." : "Aktualizácia bola úspešná. Presmerovávam vás na prihlasovaciu stránku.",
    ...
    "This owncloud.online instance is currently in single user mode." : "Táto inštancia owncloud.onlineu je teraz v jednopoužívateľskom móde.",
