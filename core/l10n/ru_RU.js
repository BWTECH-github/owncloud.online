OC.L10N.register(
    "core",
    {
    "Login paused for a moment" : "Вход ненадолго приостановлен",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "С вашего подключения было несколько неудачных попыток, поэтому вход ненадолго замедлен для защиты вашей учётной записи.",
    "You can try again in %s." : "До следующей попытки осталось: %s.",
    "You can try again now." : "Вы можете повторить попытку прямо сейчас.",
    "Forgotten your password? Use the reset link instead of trying again." : "Забыли пароль? Воспользуйтесь ссылкой для сброса вместо повторных попыток.",
    "_%n second_::_%n seconds_" : ["%n секунда", "%n секунды", "%n секунд", "%n секунды"],
    "_%n minute_::_%n minutes_" : ["%n минута", "%n минуты", "%n минут", "%n минуты"],
    ...
    "You have enabled one or more Enterprise apps but your installation does not have a valid license yet." : "Вы включили одно или несколько приложений owncloud.online для Enterprise, но у вашей установки ещё нет допустимого лицензионного ключа.",
    ...
    "To try the Enterprise apps, just start a 30-day demo and enter the provided license key below." : "Чтобы попробовать owncloud.online Enterprise, просто запустите 30-дневную демонстрацию и введите ниже предоставленный лицензионный ключ.",
    "Upgrade to Enterprise" : "Обновление owncloud.online до Enterprise",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "Конфигурация заголовков обратного прокси не верна, либо доступ к owncloud.online осуществлён через доверенный прокси. Если owncloud.online открыт не через доверенный прокси то это проблема безопасности, которая может позволить атакующему подделать IP адрес, который видит owncloud.online. Дополнительная информация доступна в нашей  <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">документации</a>.",
    ...
    "The \"{header}\" HTTP header is misconfigured. Expected values are \"none\" or \"noindex, nofollow\". This is a potential security or privacy risk and we recommend adjusting this setting." : "Неправильно настроен HTTP-заголовок \"{header}\". Ожидаемые значения - \"none\" или \"noindex, nofollow\". Это потенциальный риск для безопасности или конфиденциальности, и мы рекомендуем изменить этот параметр.",
    ...
    "Filename" : "Имя файла",
    "Password" : "Пароль",
    "Download / View / Upload / Edit" : "Загрузка / просмотр / загрузка / редактирование",
    ...
    "Edit link share: {name}" : "Редактировать ссылку поделиться: {имя}",
    ...
    "An error occurred while sending email" : "Произошла ошибка при отправке электронной почты",
    "Email link to person" : "Ссылка на человека по электронной почте",
    ...
    "Sending" : "Отправка",
    "E-Mail sent" : "Электронная почта отправлена",
    ...
    "notify by email" : "Уведомление по электронной почте",
    ...
    "No users or groups found" : "Не найдено ни пользователей, ни групп",
    ...
    "User" : "Пользователь",
    "Group" : "Группа",
    "Federated Group" : "Федеративная группа",
    "Guest" : "Гость",
    "At {server}" : "На {server}",
    "Federated" : "Федеративный",
    ...
    "Share with people on other servers using the syntax username@example.com/owncloud" : "Поделиться с людьми на других серверах owncloud.online используя формат username@example.com/owncloud",
    "Share with users…" : "Поделиться с пользователями...",
    "Share with users, groups or federated users…" : "Делиться с пользователям, группами или федеративными пользователями…",
    "Share with users or groups…" : "Поделиться с пользователями или группами...",
    "Share with users or federated users…" : "Делиться с пользователями или федеративными пользователями…",
    "Could not be shared with the following users: {users}" : "Не удалось предоставить доступ к файлам следующим пользователям: _BOS_{пользователи}",
    "Add multiple users" : "Добавить несколько пользователей",
    ...
    "Do you really want to remove the tag \"{tagName}\" and unassign it from all files and folders ?" : "Вы действительно хотите удалить метку \"{tagName}\" и убрать её назначение со всех файлов и каталогов ?",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "Обновление прошло неудачно. Пожалуйста, сообщите об этом результате в <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online community</a>.",
    "The update was successful. There were warnings." : "Обновление прошло успешно. Были предупреждения.",
    "The update was successful. Redirecting you to owncloud.online now." : "Обновление прошло успешно. Немедленное перенаправление Вас на owncloud.online.",
    ...
    "The application was authorized successfully. You will now get redirected to the requested page, otherwise you can close this window." : "Приложение было успешно авторизовано. Теперь вы будете перенаправлены на запрашиваемую страницу, в противном случае вы можете закрыть это окно.",
    ...
    "Please specify the port number along with the host name (e.g., localhost:5432)." : "Пожалуйста, вместе с именем хоста укажите и номер порта (e.g., например, localhost: 5432).",
    ...
    "This owncloud.online instance is currently in single user mode." : "Сервер owncloud.online в настоящее время работает в однопользовательском режиме.",
    ...
    "You are accessing the server through an untrusted domain." : "Вы получаете доступ к серверу через ненадежный домен.",
    ...
    "Automatic upgrading is not enabled in config.php. To upgrade your instance, please use the command line updater (occ upgrade)." : "Автоматическое обновление не разрешено в config.php. Чтобы обновить ваш экземпляр, пожалуйста используйте обновление через командную строку (occ upgrade).",
