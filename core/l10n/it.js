OC.L10N.register(
    "core",
    {
    "Login paused for a moment" : "Accesso momentaneamente in pausa",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "Ci sono stati diversi tentativi non riusciti dalla tua connessione, quindi stiamo rallentando brevemente l'accesso per proteggere il tuo account.",
    "You can try again in %s." : "Puoi riprovare tra %s.",
    "You can try again now." : "Puoi riprovare adesso.",
    "Forgotten your password? Use the reset link instead of trying again." : "Password dimenticata? Usa il collegamento di ripristino invece di riprovare.",
    "_%n second_::_%n seconds_" : ["%n secondo", "%n secondi", "%n secondi"],
    ...
    "You have enabled one or more Enterprise apps but your installation does not have a valid license yet." : "Hai abilitato una o più app owncloud.online Enterprise ma la tua installazione non ha ancora una licenza valida.",
    "A grace period of 24 hours has started to allow you to get going right away. Once the grace period ends, all Enterprise apps will become disabled unless you supply a valid license key." : "È stato avviato un periodo di prova di 24 ore per consentirti di iniziare subito.Al termine del periodo di prova, tutte le app Enterprise verranno disattivate a meno chenon venga fornita una chiave di licenza valida.",
    "To try the Enterprise apps, just start a 30-day demo and enter the provided license key below." : "Per provare owncloud.online Enterprise, basta avviare una demo di 30 giorni e inserire la chiave di licenza fornita qui sotto.",
    "Upgrade to Enterprise" : "Aggiorna a owncloud.online Enterprise",
    "Remaining time: {rtime}" : "Tempo rimanente: {rtime}",
    "Get your demo key" : "Ottieni la tua chiave demo",
    "Enter license key" : "Inserisci license key",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "La configurazione delle intestazioni del proxy inverso non è corretta, o stai effettuando l'accesso a owncloud.online da un proxy affidabile. Se non stai effettuando l'accesso da un proxy affidabile, questo è un problema di sicurezza e può consentire a un attaccante di falsificare il suo indirizzo IP, rendendolo visibile a owncloud.online. Ulteriori informazioni sono disponibili nella nostra <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentazione</a>.",
    ...
    "The \"{header}\" HTTP header is misconfigured. Expected values are \"none\" or \"noindex, nofollow\". This is a potential security or privacy risk and we recommend adjusting this setting." : "L'intestazione HTTP \"{header}\" non è configurata correttamente. I valori previsti sono \"none\" o \"noindex, nofollow\". Questo è un potenziale rischio per la sicurezza o la privacy e ti consigliamo di modificare questa impostazione.",
    ...
    "Choose a password - password policy may apply" : "Scegli una password - potrebbero essere applicati criteri relativi alle password",
    "Password required" : "Password richiesta",
    "Link name" : "Nome collegamento",
    "Name" : "Nome",
    "Filename" : "Nome del file",
    "Password" : "Password",
    "Download / View / Upload / Edit" : "Scarica / Visualizza / Carica / Modifica",
    "Recipients can view, download and edit contents." : "I destinatari possono visualizzare, scaricare e modificare contenuti.",
    ...
    "An error occurred while sending email" : "Si è verificato un errore durante l'invio dell'e-mail",
    ...
    "User" : "Utente",
    "Group" : "Gruppo",
    "Federated Group" : "Gruppo Federato",
    "Guest" : "Ospite",
    "At {server}" : "Su {server}",
    "Federated" : "Federato",
    ...
    "Share with users, groups or federated users…" : "Condividi con utenti, gruppi o utenti federati...",
    "Share with users or groups…" : "Condividi con utenti o gruppi...",
    "Share with users or federated users…" : "Condividi con utenti o utenti federati...",
    "Could not be shared with the following users: {users}" : "Impossibile condividere con gli utenti seguenti: {users}",
    "Add multiple users" : "Aggiungi più utenti",
    ...
    "({scope})" : "({scope})",
    "Rename" : "Rinomina",
    "Do you really want to remove the tag \"{tagName}\" and unassign it from all files and folders ?" : "Vuoi davvero rimuovere l'etichetta \"{tagName}\" e dissociarla da tutti i file e cartelle?",
    "Remove tag" : "Rimuovere etichetta",
    "Delete" : "Elimina",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "L'aggiornamento non è riuscito. Segnala il problema alla <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">comunità di owncloud.online</a>.",
    "The update was successful. There were warnings." : "L'aggiornamento è stato effettuato correttamente. Ci sono degli avvisi.",
    "The update was successful. Redirecting you to owncloud.online now." : "L'aggiornamento è stato effettuato correttamente. Stai per essere reindirizzato a owncloud.online.",
    ...
    "Cheers!" : "Saluti!",
    "The application was authorized successfully. You will now get redirected to the requested page, otherwise you can close this window." : "L'applicazione è stata autorizzata correttamente. Ora verrai reindirizzato alla pagina richiesta, altrimenti puoi chiudere questa finestra.",
    ...
    "Please specify the port number along with the host name (e.g., localhost:5432)." : "Per favore specifica il numero di porta insieme al nome host (ad esempio, localhost:5432).",
    ...
    "You took too long to log in, please try again now" : "Hai impiegato troppo tempo per accedere, riprova ora",
    ...
    "This owncloud.online instance is currently in single user mode." : "Questa istanza di owncloud.online è in modalità utente singolo.",
    ...
    "You are accessing the server through an untrusted domain." : "Stai accedendo al server tramite un dominio non attendibile.",
    ...
    "Automatic upgrading is not enabled in config.php. To upgrade your instance, please use the command line updater (occ upgrade)." : "L'aggiornamento automatico è disattivato in config.php. Per aggiornare la tua istanza, usa l'updater da riga di comando (occ upgrade).",
