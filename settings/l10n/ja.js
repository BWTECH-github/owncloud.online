OC.L10N.register(
    ...
    "Invalid url '%s'. Urls should be set up like 'http://www.example.com' or 'https://www.example.com'" : "無効なURL '%s' です。URLは'http://www.example.com' や 'https://www.example.com' のように設定する必要があります。",
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "公式アプリは owncloud.online コミュニティにより開発されています。公式アプリは owncloud.online の中心的な機能を提供し、製品として可能です。",
    ...
    "Hey there,<br><br>just letting you know that you now have an %s account.<br><br>Your username: %s<br>Please set the password by accessing it: <a href=\"%s\">Here</a><br><br>" : "こんにちは、<br><br> %s アカウントが作成できました。<br><br>あなたのユーザー名： %s<br>こちらにアクセスしてパスワードを設定してください：<a href=\"%s\">こちら</a><br><br>",
    "Cheers!" : "それでは！",
    ...
    "This app has no minimum server version assigned. This will be an error in version 11 and later." : "このアプリはowncloud.onlineの最小バージョンが指定されていません．owncloud.online 11 以降でエラーが発生する可能性があります.",
    "This app has no maximum server version assigned. This will be an error in version 11 and later." : "このアプリはowncloud.online バージョンの上限が指定されていません．owncloud.online 11 以降でエラーが発生する可能性があります.",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "古い暗号化(owncloud.online <= 8.0) から新しいものに暗号化キーを移行する必要があります。\"デフォルトの暗号化モジュール\" を有効にして 'occ encryption:migrate' を実行してください。",
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : "古い暗号化(owncloud.online <= 8.0) から新しいものに暗号化キーを移行する必要があります。",
    ...
    "White-listed Domains" : "ホワイトリストドメイン",
