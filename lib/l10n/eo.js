OC.L10N.register(
    ...
    "Server version %s or higher is required." : "owncloud.online %s aŭ pli alta necesas.",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "La aplikaĵo ne povas instaliĝi ĉar ĝi ne kongruas kun ĉi tiu eldono de owncloud.online",
    "Apps" : "Aplikaĵoj",
    "General" : "Ĝenerala",
    "Storage" : "Konservejo",
    "Security" : "Sekuro",
    ...
    "%s" : "%s",
    "%s via %s" : "%s per %s",
    "Sharing %s failed, because the backend does not allow shares from type %d" : "Kunhavigo de %s malsukcesis, ĉar la motoro ne permesas kunhavojn el tipo %d",
