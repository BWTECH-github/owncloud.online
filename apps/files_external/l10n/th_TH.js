OC.L10N.register(
    ...
    "An error occurred while adding the external storage, please check the logs or contact the administrator" : "เกิดข้อผิดพลาดขณะเพิ่มที่จัดเก็บข้อมูลภายนอก โปรดตรวจสอบ log หรือติดต่อผู้ดูแลระบบ",
    "External storage has been added successfully" : "เพิ่มที่เก็บข้อมูลภายนอกเรียบร้อยแล้ว",
    "An error occurred while adding the external storage please check the logs" : "เกิดข้อผิดพลาดขณะเพิ่มที่จัดเก็บข้อมูลภายนอก โปรดตรวจสอบ log",
    "An error occurred while loading external mount point: {name}" : "เกิดข้อผิดพลาดขณะกำลังโหลดจากจุดต่อเชื่อมภายนอก: {name}",
    "Saved" : "บันทึกแล้ว",
    ...
    "Couldn't get the information from the remote server: {code} {type}" : "ไม่สามารถรับข้อมูลจากเซิร์ฟเวอร์ owncloud.online: {code} {type}",
