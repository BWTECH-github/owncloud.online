OC.L10N.register(
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "יישומים רישמיים מפותחים על ידי קהילת owncloud.online. הם מציעים פונקיונאליות, התאמה ל- owncloud.online ומוכנים לשימוש כבד.",
    ...
    "This app has no minimum server version assigned. This will be an error in version 11 and later." : "ליישום זה לא הוקצתה גרסה מינמלית של owncloud.online. מצב זה יהיה שגוי בגרסה 11 או מאוחרת יותר של owncloud.online.",
    "This app has no maximum server version assigned. This will be an error in version 11 and later." : "ליישום זה לא הוקצתה גרסה מקסימלית של owncloud.online. מצב זה יהיה שגוי בגרסה 11 או מאוחרת יותר של owncloud.online.",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "יש להמיר את מפתחות ההצפנה שלך בממערכת ההצפנה הישנה (owncloud.online <= 8.0) למערכת החדשה. יש לאפשר את \"מודול הצפנה ברירת מחדש\" ולהריץ 'occ encryption:migrate'",
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : "יש להמיר את מפתחות ההצפנה שלך בממערכת ההצפנה הישנה (owncloud.online <= 8.0) למערכת החדשה.",
