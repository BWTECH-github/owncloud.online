OC.L10N.register(
    ...
    "You have enabled one or more Enterprise apps but your installation does not have a valid license yet." : "Has habilitado una o más aplicaciones de owncloud.online Enterprise, pero tu instalación aún no posee una licencia válida.",
    "A grace period of 24 hours has started to allow you to get going right away. Once the grace period ends, all Enterprise apps will become disabled unless you supply a valid license key." : "Ha comenzado un período de gracia de 24 horas para que pueda empezar de inmediato. Una vez que finaliza el período de gracia, todas las aplicaciones empresariales se deshabilitaran a menos que proporcione una clave de licencia válida.",
    "To try the Enterprise apps, just start a 30-day demo and enter the provided license key below." : "Para probar owncloud.online Enterprise, solo comienza tu demo de 30 días e ingresa la clave de licencia proporcionada a continuación.",
    "Upgrade to Enterprise" : "Actualice a owncloud.online Enterprise",
    "Remaining time: {rtime}" : "Tiempo restante: {rtime}",
    "Get your demo key" : "Obtenga una clave de prueba",
    "Enter license key" : "Introducir la clave de licencia",
    "Set new key" : "Establecer nueva clave",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "La configuración de las cabeceras inversas del proxy son incorrectas, o está accediendo a owncloud.online desde un proxy confiable. Si no está accediendo a owncloud.online desde un proxy certificado y confiable, este es un problema de seguridad y puede permitirle a un hacker camuflar su dirección IP a owncloud.online. Más información puede ser encontrada en nuestra <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentación</a>.",
    ...
    "Filename" : "Nombre",
    "Password" : "Contraseña",
    "Download / View / Upload / Edit" : "Descargar / Ver / Subir / Editar",
    ...
    "An error occurred while sending email" : "Ocurrió un error al enviar el email",
    ...
    "No users or groups found" : "No se encontraron usuarios o grupos",
    ...
    "_Please enter at least {chars} character for suggestions_::_Please enter at least {chars} characters for suggestions_" : ["Por favor introduzca al menos {chars} carácter para sugerencia","Por favor introduzca al menos {chars} carácteres para sugerencia","Por favor introduzca al menos {chars} carácteres para sugerencia"],
    ...
    "Share with people on other servers using the syntax username@example.com/owncloud" : "Comparta con personas en otros owncloud.onlines utilizando la sintáxis username@example.com/owncloud",
    ...
    "Share with users or federated users…" : "Compartir con los usuarios o los usuarios federados...",
    "Could not be shared with the following users: {users}" : "No se pudo compartir con los siguientes usuarios: {users}",
    "Add multiple users" : "Añadir múltiples usuarios",
    ...
    "({scope})" : "({scope})",
    "Rename" : "Renombrar",
    "Do you really want to remove the tag \"{tagName}\" and unassign it from all files and folders ?" : "¿Realmente quieres eliminar la etiqueta \"{tagName}\" y desasignarla de todos los archivos y carpetas?",
    "Remove tag" : "Eliminar la etiqueta",
    "Delete" : "Eliminar",
    ...
    "new" : "Nuevo",
    "_download %n file_::_download %n files_" : ["descargar %n ficheros","descargar %n archivos","descargar %n archivos"],
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "La actualización ha fracasado. Por favor, informe de este problema a la <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">Comunidad de owncloud.online</a>.",
    "The update was successful. There were warnings." : "La actualización fue exitosa. Había advertencias.",
    "The update was successful. Redirecting you to owncloud.online now." : "La actualización se ha realizado con éxito. Redireccionando a owncloud.online ahora.",
    ...
    "_{count} search result in another folder_::_{count} search results in other folders_" : ["{count} resultado de búsqueda en otra carpeta","{count} resultados de búsqueda en otras carpetas","{count} resultados de búsqueda en otras carpetas"],
    "Personal" : "Personal",
    "Users" : "Usuarios",
    "Apps" : "Aplicaciones",
    ...
    "Cheers!" : "¡Saludos!",
    "The application was authorized successfully. You will now get redirected to the requested page, otherwise you can close this window." : "La aplicación fue autorizada correctamente. Va a ser redirigido a la página buscada, de lo contrario puede cerrar la ventana.",
    ...
    "Please specify the port number along with the host name (e.g., localhost:5432)." : "Por favor, especifique el puerto tras el nombre de la máquina (p. ej. localhost:5432)",
    ...
    "You took too long to log in, please try again now" : "Ha tardado demasiado en iniciar sesión, por favor inténtelo de nuevo",
    ...
    "This owncloud.online instance is currently in single user mode." : "Esta instalación de owncloud.online se encuentra en modo de usuario único.",
    ...
    "You are accessing the server through an untrusted domain." : "Está accediendo al servidor mediante un dominio inseguro",
    ...
    "It looks like your instance may host many files and/or users. To ensure a smooth upgrade process, please use the command line upgrade command (occ upgrade)." : "Parece que su instancia puede albergar muchos archivos y/o usuarios. Para garantizar un proceso de actualización sin problemas, utilice el comando de actualización de la línea de comandos (occ upgrade).",
    "Automatic upgrading is not enabled in config.php. To upgrade your instance, please use the command line updater (occ upgrade)." : "La actualización automática no está habilitada en config.php. Para actualizar su instancia, utilice el actualizador de línea de comandos (occ upgrade).",
