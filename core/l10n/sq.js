OC.L10N.register(
    "core",
    {
    "Login paused for a moment" : "Hyrja u ndal për një çast",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "Pati disa përpjekje të dështuara nga lidhja juaj, prandaj po e ngadalësojmë përkohësisht hyrjen për të mbrojtur llogarinë tuaj.",
    "You can try again in %s." : "Mund të provoni sërish pas %s.",
    "You can try again now." : "Tani mund të provoni sërish.",
    "Forgotten your password? Use the reset link instead of trying again." : "Harruat fjalëkalimin? Përdorni lidhjen e rivendosjes në vend që të provoni sërish.",
    "_%n second_::_%n seconds_" : ["%n sekondë", "%n sekonda"],
    ...
    "Image too large" : "Figurë shumë e madhe",
    ...
    "Updated \"%s\" to %s" : "U përditësua “%s” si %s",
    ...
    "Nov." : "Nën.",
    "Dec." : "Dhj.",
    "<a href=\"{docUrl}\">There were problems with the code integrity check. More information…</a>" : "<a href=\"{docUrl}\">Pati probleme me kontrollin e integritetit të kodit. Më tepër hollësi…</a>",
    "Settings" : "Rregullime",
    "Problem loading page, reloading in 5 seconds" : "Gabim në ngarkimin e faqes, do të ringarkohet pas 5 sekondash",
    "Saving..." : "Po ruhet …",
    "Dismiss" : "Mos e merr parasysh",
    "seconds ago" : "sekonda më parë",
    "You have enabled one or more Enterprise apps but your installation does not have a valid license yet." : "Keni aktivizuar një ose më tepër aplikacione për owncloud.online Enterprise, por instalimi juaj ende s’ka një licencë të vlefshme.",
    ...
    "To try the Enterprise apps, just start a 30-day demo and enter the provided license key below." : "Që të provoni owncloud.online Enterprise, thjesht filloni një demonstrim 30-ditësh dhe jepni kyçin e licencës së ofruar më poshtë.",
    "Upgrade to Enterprise" : "Përmirësojeni me owncloud.online Enterprise",
    "Remaining time: {rtime}" : "Kohë e mbetur: {rtime}",
    "Get your demo key" : "Merrni kyçin e demonistrimit tuaj",
    "Enter license key" : "Jepni kyç licence",
    "Set new key" : "Ujdisni kyç të ri",
    "The link to reset your password has been sent to your email. If you do not receive it within a reasonable amount of time, check your spam/junk folders.<br>If it is not there ask your local administrator." : "Lidhja për ricaktimin e fjalëkalimi tuaj u dërgua tek email-i juaj. Nëse s’e merrni brenda një kohe të arsyeshme, kontrolloni dosjet e postës së padëshirueshme/postës së pavlerë.<br>Nëse s’është as aty, pyetni përgjegjësin tuaj lokal.",
    ...
    "Password can not be changed. Please contact your administrator." : "Fjalëkalimi s’mund të ndryshohet. Ju lutemi, lidhuni me përgjegjësin tuaj.",
    ...
    "Your web server is not yet set up properly to allow file synchronization because the WebDAV interface seems to be broken." : "Shërbyesi juaj ende s’është ujdisur për të lejuar njëkohësim kartelash, ngaqë ndërfaqja WebDAV duket se është e dëmtuar.",
    "Your web server is not set up properly to resolve \"{url}\". Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "Shërbyesi juaj s’është ujdisur si duhet për të kuptuar “{url}”. Hollësi të mëtejshme mund të gjenden te <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">dokumentimi</a> ynë.",
    ...
    "No memory cache has been configured. To enhance your performance please configure a memcache if available. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "S’ka të formësuar fshehtinë kujtese. Që të përmirësoni punimin, ju lutemi, formësoni një të tillë, në pastë. Më tepër hollësi mund të gjeni te <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">dokumentimi</a> ynë.",
    "/dev/urandom is not readable by PHP which is highly discouraged for security reasons. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "/dev/urandom s’lexohet dot nga PHP-ja, çka shkëshillohet me forcë, për arsye sigurie. Më tepër hollësi mund të gjenden te <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">dokumentimi</a> ynë.",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "Formësimi për krye ndërmjetësi “reverse” është i pasaktë, ose jeni duke hyrë në owncloud.online prej një ndërmjetësi të besuar. Nëse s’jeni duke hyrë në owncloud.online prej një ndërmjetësi të besuar, ky është një problem sigurie dhe mund t’i lejojë një agresori të maskojë adresën e vet IP si një të pranueshme nga owncloud.online-i. Hollësi të mëtejshme mund të gjeni te <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">dokumentimi</a> ynë.",
    ...
    "Some files have not passed the integrity check. Further information on how to resolve this issue can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>. (<a href=\"{codeIntegrityDownloadEndpoint}\">List of invalid files…</a> / <a href=\"{rescanEndpoint}\">Rescan…</a>)" : "Disa kartela s’e kaluan dot kontrollin e pacenueshmërisë. Më tepër hollësi se si të zgjidhet ky problem mund të gjeni te <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">dokumentimi</a> ynë. (<a href=\"{codeIntegrityDownloadEndpoint}\">Listë e kartelave të pavlefshme…</a> / <a href=\"{rescanEndpoint}\">Rikontrollojini…</a>)",
    "You are running in DEBUG mode, this can cause unwanted side effects. Please remove the \"debug\" flag from \"config.php\"." : "Po e xhironi nën mënyrën DEBUG, kjo mund të shkaktojë efekte anësore të padëshiruara. Ju lutemi, hiqeni parametrin “debug” nga “config.php”.",
    ...
    "The \"{header}\" HTTP header is misconfigured. Expected values are \"none\" or \"noindex, nofollow\". This is a potential security or privacy risk and we recommend adjusting this setting." : "Kryet HTTP “{header}” janë formësuar keq. Vlerat e pritshme janë “none” ose “noindex, nofollow”. Kjo përbën një rrezik potencial sigurie ose privatësie dhe \nkëshillojmë të ndreqet ky rregullim.",
    "The \"{header}\" HTTP header is not configured to equal to \"{expected}\". This is a potential security or privacy risk and we recommend adjusting this setting." : "Kryet HTTP “{header}” s’është formësuar të jenë të njëjta me “{expected}”. Ky është një rrezik potencial sigurie dhe privatësie dhe këshillojmë të ndreqet ky rregullim.",
    "The \"Strict-Transport-Security\" HTTP header is not configured to at least \"{seconds}\" seconds. For enhanced security we recommend enabling HSTS as described in our <a href=\"{docUrl}\" rel=\"noreferrer\">security tips</a>." : "Parametri HTTP “Strict-Transport-Security” s’është formësuar të paktën “{seconds}” sekonda. Për siguri të thelluar, ju këshillojmë aktivizimin e HSTS-së, ashtu si përshkruhet në <a href=\"{docUrl}\" rel=\"noreferrer\">këshillat tona mbi sigurinë</a>.",
    ...
    "Password" : "Fjalëkalim",
    "Download / View / Upload / Edit" : "Shkarkoje / Shiheni / Ngarkoje / Përpunojeni",
    ...
    "Share details could not be loaded for this item." : "Për këtë objekt s’u ngarkuan dot hollësi pjese.",
    "No users or groups found" : "S’u gjetën përdorues ose grupe",
    ...
    "Share with people on other servers using the syntax username@example.com/owncloud" : "Ndajeni me persona në owncloud.online-e të tjera duke përdorur sintaksën emërpërdoruesi@example.com/owncloud",
    "Share with users…" : "Ndajeni me përdorues…",
    "Share with users, groups or federated users…" : "Ndajeni me përdorues, grupe ose përdorues të federuar…",
    "Share with users or groups…" : "Ndajeni me përdorues ose grupe…",
    "Share with users or federated users…" : "Ndajeni me përdorues ose përdorues të federuar…",
    "Could not be shared with the following users: {users}" : "S’u nda dot me përdoruesit vijues: {users}",
    "Add multiple users" : "Shtoni disa përdorues njëherësh",
    "Error removing share" : "Gabim në heqjen e ndarjes",
    "Unknown Share" : "Pjesë e Panjohur",
    ...
    "({scope})" : "({scope})",
    "Rename" : "Riemërtoje",
    "Do you really want to remove the tag \"{tagName}\" and unassign it from all files and folders ?" : "Doni vërtet të hiqet etiketa “{tagName}” dhe krejt përshoqërimet e saj me kartela dhe dosje ?",
    "Remove tag" : "Hiqe etiketën",
    "Delete" : "Fshije",
    ...
    "The update was unsuccessful. For more information <a href=\"{url}\">check our forum post</a> covering this issue." : "Përditësimi qe i pasuksesshëm. Për më tepër hollësi <a href=\"{url}\">shihni postimin te forumi ynë</a> lidhur me këtë çështje.",
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "Përditësimi dështoi. Ju lutemi, njoftojani këtë problem <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">bashkësisë owncloud.online</a>.",
    "The update was successful. There were warnings." : "Përditësimi qe i suksesshëm. Pati sinjalizime.",
    "The update was successful. Redirecting you to owncloud.online now." : "Përditësimi qe i suksesshëm. Po ridrejtoheni te owncloud.online-i.",
    ...
    "Cheers!" : "Gëzuar!",
    "The application was authorized successfully. You will now get redirected to the requested page, otherwise you can close this window." : "Aplikacioni u autorizua me sukses. Tani do të ridrejtoheni te faqja e kërkuar, përndryshe, mund ta mbyllni këtë dritare.",
    ...
    "This owncloud.online instance is currently in single user mode." : "Kjo instancë owncloud.online është aktualisht në gjendjen me përdorues të vetëm.",
    ...
    "You are accessing the server through an untrusted domain." : "Po hyni në shërbyes përmes një përkatësie jo të besuar.",
    ...
    "Upgrade needed" : "Lypset përmirësim",
    "It looks like your instance may host many files and/or users. To ensure a smooth upgrade process, please use the command line upgrade command (occ upgrade)." : "Duket sikur instanca juaj mund të strehojë mjaft kartela dhe/ose përdorues. Për të siguruar një proces të rrjedhshëm përmirësimi, ju lutemi, përdorni urdhrin për përmirësim që nga rresht urdhrash (occ upgrade).",
    "Automatic upgrading is not enabled in config.php. To upgrade your instance, please use the command line updater (occ upgrade)." : "Te config.php s’është formësuar përmirësim i automatizuar. Që të përmirësohet instanca juaj, ju lutemi, përdorni përditësuesin për rresht urdhrash (occ upgrade).",
