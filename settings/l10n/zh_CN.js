OC.L10N.register(
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "官方应用是由 owncloud.online 社区开发。他们提供 owncloud.online 的功能核心并准备用于生产。",
    ...
    "This app has no minimum server version assigned. This will be an error in version 11 and later." : "这个程序没有指定最低的owncloud.online版本。这是在owncloud.online11之后版本的错误。",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "你需要升级你的加密密钥 (旧版 owncloud.online <= 8.0) 。 请在应用中启用 \\\"Default encryption module\\\" 并运行 'occ encryption:migrate'",
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : "您需要将加密密钥从旧版(owncloud.online<=8.0)迁移到新版。",
