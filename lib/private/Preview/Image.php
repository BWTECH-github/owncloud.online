 ...
 * Changes:
 *   - CI-verified reproducible bundle + version sync
 *   - keep pixel-flood protection in the imagick fallback
 *   - stop double-decoding oversized images
 *   - use Imagick::autoOrientate for EXIF orientation
 */
