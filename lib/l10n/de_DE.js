OC.L10N.register(
    ...
    "Server version %s or higher is required." : "owncloud.online %s oder höher wird benötigt.",
    "Server version %s or lower is required." : "owncloud.online %s oder niedriger wird benötigt.",
    "%s is member of a group not allowed to access through this login mechanism" : "%s ist Mitglied einer Gruppe, der kein Zugriff über dieses Anmeldeverfahren gewährt wird.",
    "%s isn't member of a group allowed to access through this login mechanism" : "%s ist kein Mitglied einer Gruppe, der Zugriff über dieses Anmeldeverfahren gewährt wird.",
    "A login policy has blocked the login" : "Eine Anmelderichtline blockiert die Anmeldung.",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "Die Anwendung konnte nicht installiert werden, weil Sie nicht mit dieser Version von owncloud.online kompatibel ist.",
    "App can't be installed because it contains the <shipped>true</shipped> tag which is not allowed for non shipped apps" : "Die App kann nicht installiert werden, weil sie den <shipped>true</shipped>-Tag enthält, der bei Apps, die nicht zum Standardumfang von owncloud.online gehören, nicht erlaubt ist",
    ...
    "Please contact your administrator or %s for a new license key." : "Bitte kontaktieren Sie Ihren Administrator oder %s für einen neuen Lizenzschlüssel.",
    ...
    "Evaluation - expires today." : "Evaluierung - endet heute.",
    "Evaluation - expires in %d days." : "Evaluieringsphase - läuft ab in %d Tag(en).",
    "Your Enterprise license key is about to expire (days remaining: %d)." : "Ihr Enterprise-Lizenzschlüssel wird bald ablaufen (verbleibende Tage: %d).",
    "The registered enterprise license key expires in %d days" : "Der registrierte Enterprise-Lizenzschlüssel läuft in %d Tag(en) ab.",
    ...
    "%s enter the database name or connection string." : "%s geben Sie den Datenbank-Namen oder den Verbindungsnamen an.",
    ...
    "%s is not supported and %s will not work properly on this platform. Use it at your own risk! " : "%s wird nicht unterstützt und 1%s wird auf dieser Plattform nicht ordnungsgemäß funktionieren. Benutzung auf eigene Gefahr!",
    ...
    "Internal mail notification for shared files is not allowed" : "Interne E-Mail Benachrichtigung für geteilte Dateien ist nicht erlaubt",
    "%s shared »%s« with you" : "%s hat „%s“ mit Ihnen geteilt",
    "Public link mail notification is not allowed" : "Öffentlicher Link E-Mail Benachrichtigung ist nicht erlaubt",
    "%s" : "%s",
    "%s via %s" : "%s via %s",
    ...
    "Cannot set the requested share permissions for %s" : "Die angeforderten Freigabeberechtigungen können nicht für %s festgelegt werden",
    "Cannot set the requested share attributes for %s" : "Die angeforderten Freigabeattribute können für %s nicht festgelegt werden",
    ...
    "The special username %s is not allowed" : "Der spezielle Benutzername %s ist nicht erlaubt.",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "Durch das Anpassen dieser Einstellung in der php.ini wird owncloud.online wieder laufen",
