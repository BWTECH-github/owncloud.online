OC.L10N.register(
    ...
    "Server version %s or higher is required." : "owncloud.online %s o superior es requesit.",
    "Server version %s or lower is required." : "owncloud.online %s o inferior es requesit.",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "L'aplicacion pòt pas èsser installada perque es pas compatibla amb aquesta version d'owncloud.online",
    ...
    "%s" : "%s",
    "%s via %s" : "%s via %s",
    "Sharing %s failed, because the backend does not allow shares from type %d" : "Lo partiment de %s a fracassat perque l’infrastructura autoriza pas los partiments de tipe %d",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "Ajustar aqueste paramètre dins php.ini permetrà a owncloud.online de foncionar tornamai",
