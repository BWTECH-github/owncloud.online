OC.L10N.register(
    "core",
    {
    "Login paused for a moment" : "Prijava je za trenutek zaustavljena",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "Z vaše povezave je bilo več neuspešnih poskusov, zato prijavo za kratek čas upočasnjujemo, da zaščitimo vaš račun.",
    "You can try again in %s." : "Do naslednjega poskusa je preostalo: %s.",
    "You can try again now." : "Zdaj lahko poskusite znova.",
    "Forgotten your password? Use the reset link instead of trying again." : "Ste pozabili geslo? Uporabite povezavo za ponastavitev, namesto da poskušate znova.",
    "_%n second_::_%n seconds_" : ["%n sekunda", "%n sekundi", "%n sekunde", "%n sekund"],
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "Nastavitve glav posredniškega strežnika so nepravilne, ali pa poskušate dostopiti owncloud.online prek varne posredniške povezave. V kolikor slednje ne drži, je problem varnostne narave, ki lahko omogoči napadalcu javljanje z izmišljenega naslova IP.  Več podrobnosti je zabeleženih v <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">dokumentaciji</a>.",
    ...
    "Share with people on other servers using the syntax username@example.com/owncloud" : "Souporaba z uporabniki, ki so na drugih oblakih owncloud.online s povezavo uporabnik@domena.si/owncloud",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "Posodobitev je spodletela uspela. Pošljite poročilo o napaki razvijalcem sistema <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online</a>.",
    "The update was successful. There were warnings." : "Posodobitev je uspešno končana, vendar z nekaj opozorili.",
    "The update was successful. Redirecting you to owncloud.online now." : "Posodobitev je uspešno končana. Stran bo preusmerjena na oblak owncloud.online.",
    ...
    "This owncloud.online instance is currently in single user mode." : "Ta seja oblaka owncloud.online je trenutno v načinu enega sočasnega uporabnika.",
