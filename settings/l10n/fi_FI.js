OC.L10N.register(
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "Viralliset sovellukset kehitetään owncloud.online-yhteisön toimesta. Sovellukset tarjoavat lisäominaisuuksia owncloud.onlinein keskeisiin toimintoihin liittyen ja ovat valmiita tuotantokäyttöön.",
    ...
    "This app has no minimum server version assigned. This will be an error in version 11 and later." : "Tälle sovellukselle ei ole määritelty owncloud.onlinein vähimmäisversiota. Tämä johtaa virheeseen owncloud.online 11:stä alkaen.",
    "This app has no maximum server version assigned. This will be an error in version 11 and later." : "Tälle sovellukselle ei ole määritelty owncloud.onlinein enimmäisversiota. Tämä johtaa virheeseen owncloud.online 11:stä alkaen.",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "Sinun täytyy siirtää salausavaimet vanhasta salaustekniikasta (owncloud.online <= 8.0) uuteen. Ota \"Default encryption module\" käyttöön ja suorita komento 'occ encryption:migrate'",
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : "Sinun täytyy siirtää salausavaimet vanhasta salaustekniikasta (owncloud.online <= 8.0) uuteen.",
