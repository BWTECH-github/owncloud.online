OC.L10N.register(
    ...
    "(group)" : "(skupina)",
    "Compatibility with Mac NFD encoding (slow)" : "Skladnost s kodiranjem Mac NFD (počasneje)",
    ...
    "Couldn't get the information from the remote server: {code} {type}" : "Ni mogoče pridobiti podrobnosti s strežnika owncloud.online:{koda} {vrsta}",
    ...
    "You can add external storages in the storage settings" : "Zunanjo shrambo je mogoče dodati med nastavitvami.",
    "Name" : "Ime",
    ...
    "Enable external storage" : "Omogoči zunanjo shrambo",
    "External storage has been disabled by the administrator" : "Zunanja shramba je skrbniško onemogočena.",
