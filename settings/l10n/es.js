OC.L10N.register(
    ...
    "Invalid url '%s'. Urls should be set up like 'http://www.example.com' or 'https://www.example.com'" : "URL '%s' no válido. Las URLs deben configurarse como  'http://www.example.com' o 'https://www.example.com'",
    ...
    "Updated log level" : "Nivel de registro actualizado",
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "Las aplicaciones oficiales se desarrollan por y dentro de la comunidad owncloud.online. Estas ofrecen una funcionalidad crucial en owncloud.online y están listas para su uso en producción. ",
    ...
    "Resend invitation email" : "Reenviar invitación de correo electrónico",
    "never" : "nunca",
    "unknown" : "desconocido",
    ...
    "This app has no minimum server version assigned. This will be an error in version 11 and later." : "Esta aplicación no tiene ninguna versión mínima de owncloud.online asignada. Este será un error en owncloud.online 11 y posteriores.",
    "This app has no maximum server version assigned. This will be an error in version 11 and later." : "Esta aplicación no tiene ninguna versión máxima de owncloud.online asignada. Este será un error en owncloud.online 11 y posteriores.",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "Necesita migrar sus claves de cifrado provenientes del antiguo sistema (owncloud.online <= 8.0) al nuevo. Por favor habilite el \"Módulo de cifrado predeterminado\" y ejecute 'occ encryption:migrate'",
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : "Se necesita migrar las claves de cifrado del antiguo sistema (owncloud.online <= 8.0) al nuevo sistema.",
    "Start migration" : "Iniciar migración",
    "Two-factor Authentication" : "Autenticación en dos factores",
    "This section requires a two-factor authentication app to be installed in owncloud.online" : "Esta sección requiere que la aplicación de autenticación en dos factores esté instalada en owncloud.online",
    ...
    "At least one two-factor authentication app is installed and enabled in owncloud.online." : "Al menos una aplicación de autenticación en dos factores esta instalada y habilitada en owncloud.online.",
    ...
    "Set default expiration date for federated shares" : "Establecer la fecha de vencimiento predeterminada para los recursos compartidos federados",
    ...
    "Privacy Policy URL" : "URL de política de privacidad",
    "Enterprise license key" : "Clave de licencia empresarial",
    "Enter a new license:" : "Ingrese una nueva licencia:",
    "Save" : "Guardar",
    "Remove current license key" : "Eliminar la actual clave de licencia",
    ...
    "Test receiver email" : "Correo electrónico de prueba del receptor ",
    "Test email settings" : "Probar configuración de correo electrónico",
    "Send email" : "Enviar mensaje",
    "Manual File Locking" : "Bloqueo manual de archivos",
    "Default timeout for the locks if not specified (in seconds)" : "Tiempo de espera predeterminado para las cerraduras si no se especifica (en segundos)",
    "Maximum timeout for the locks (in seconds)" : "Tiempo máximo de espera para las cerraduras (en segundos)",
    "Enable manual file locking in the web interface" : "Activar el bloqueo manual de archivos en la interfaz web",
    "Allow users in the following groups to unlock files they have access to:" : "Permitir a los usuarios de los siguientes grupos desbloquear los archivos a los que tienen acceso:",
    "Users in these groups can unlock files even if they are not the owner of the lock." : "Los usuarios de estos grupos pueden desbloquear archivos incluso si no son los propietarios del bloqueo.",
    ...
    "Your database does not run with \"READ COMMITTED\" transaction isolation level. This can cause problems when multiple actions are executed in parallel." : "Su base de datos no se ejecuta con el nivel de aislamiento de transacciones \"READ COMMITTED\". Esto puede causar problemas cuando se ejecutan varias acciones en paralelo.",
    ...
    "Our imprint conditions:" : "Condiciones de nuestra marca:",
    "Our Privacy Policy conditions:" : "Condiciones de nuestra Política de Privacidad:",
    ...
    "Done" : "Hecho",
    "To access your files through WebDAV, please use the following URL:" : "Para acceder a tus ficheros a través de WebDAV, por favor, utiliza la siguiente URL:",
    "Version" : "Versión",
    ...
    "Currently no settings are available in this category" : "Actualmente no hay configuraciones disponibles en esta categoría",
    "The administrators can enable additional apps which add settings sections here." : "Los administradores pueden habilitar aplicaciones adicionales que agregan secciones de configuración aquí.",
    ...
    "Show creation time" : "Mostrar el momento de creación",
    ...
    "Creation Time" : "Momento de creación",
