OC.L10N.register(
    ...
    "Couldn't get the information from the remote server: {code} {type}" : "owncloud.onlineサーバーから情報を取得できません: {code} {type}",
    ...
    "SMB / CIFS using OC login" : "owncloud.onlineログインを利用したSMB / CIFS",
