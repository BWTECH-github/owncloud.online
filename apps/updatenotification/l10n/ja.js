OC.L10N.register(
    ...
    "owncloud.online core" : "owncloud.online コア",
    ...
    "Only notification for app updates are available, because the selected update channel for the server itself does not allow notifications." : "アプリの更新のみ通知が有効です。選択したサーバーのアップデートチャンネルは、サーバーの更新については通知を許可していないからです。",
    "Online updater has been automatically disabled as you are currently running an Enterprise edition. Please update your instance manually." : "現在、owncloud.online Enterprise エディションを実行しているため、オンラインアップデートは自動的に無効になっています。owncloud.online インスタンスを手動で更新してください。"
},
"nplurals=1; plural=0;");
