OC.L10N.register(
    ...
    "Upgrade to Enterprise" : "Upgradujte na owncloud.online Enterprise",
    ...
    "This server has no working Internet connection. This means that some of the features like mounting external storage, notifications about updates or installation of third-party apps will not work. Accessing files remotely and sending of notification emails might not work, either. We suggest to enable Internet connection for this server if you want to have all features." : "Tento server nemá funkční připojení k Internetu. Některé moduly jako např. externí úložiště, oznámení o dostupných aktualizacích nebo instalace aplikací třetích stran nebudou fungovat. Přístup k souborům z jiných míst a odesílání oznamovacích emailů také nemusí fungovat. Pokud chcete využívat všechny možnosti owncloud.online, doporučujeme povolit pro tento server připojení k Internetu.",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "Konfigurace hlaviček reverzní proxy není správná nebo přistupujete na owncloud.online z důvěryhodné proxy. Pokud nepřistupujete k owncloud.online z důvěryhodné proxy, potom je toto bezpečností chyba a může útočníkovi umožnit falšovat IP adresu, kterou owncloud.online vidí. Další informace lze nalézt v naší <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">dokumentaci</a>.",
    ...
    "Share with people on other servers using the syntax username@example.com/owncloud" : "Sdílejte s lidmi na owncloud.onlines použitím syntaxe username@example.com/owncloud",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "Aktualizace neproběhla úspěšně. Nahlaste prosím problém <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">komunitě owncloud.online</a>",
    "The update was successful. There were warnings." : "Aktualizace byla úspěšná. Zachycen výskyt varování.",
    "The update was successful. Redirecting you to owncloud.online now." : "Aktualizace byla úspěšná. Přesměrovávám na owncloud.online.",
    ...
    "This owncloud.online instance is currently in single user mode." : "Tato instalace owncloud.onlineu je momentálně v jednouživatelském módu.",
