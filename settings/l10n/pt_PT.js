OC.L10N.register(
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "As apps oficiais são desenvolvidas por e na comunidade da owncloud.online. Elas oferecem funcionalidade central para a owncloud.online e está pronta para uma utilização na produção.",
    ...
    "This app has no minimum server version assigned. This will be an error in version 11 and later." : "Esta aplicação não tem uma versão mínima de owncloud.online atribuída. Isto será um erro no owncloud.online 11 e seguintes.",
    "This app has no maximum server version assigned. This will be an error in version 11 and later." : "Esta aplicação não tem uma versão máxima de owncloud.online atribuída. Isto será um erro no owncloud.online 11 e seguintes.",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "Precisa de migrar as suas chaves de encriptação da encriptação antiga (owncloud.online <= 8.0) para a nova. Por favor, ative o \"Módulo de encriptação padrão\" e execute 'occ encryption:migrate'",
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : "Precisa de migrar as suas chaves de encriptação da encriptação antiga (owncloud.online <= 8.0) para a nova.",
