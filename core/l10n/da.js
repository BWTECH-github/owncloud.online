OC.L10N.register(
    "core",
    {
    "Login paused for a moment" : "Login er kort sat på pause",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "Der var flere mislykkede forsøg fra din forbindelse, så vi sætter kortvarigt tempoet ned for at beskytte din konto.",
    "You can try again in %s." : "Du kan prøve igen om %s.",
    "You can try again now." : "Du kan prøve igen nu.",
    "Forgotten your password? Use the reset link instead of trying again." : "Glemt din adgangskode? Brug nulstillingslinket i stedet for at prøve igen.",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "Konfigurationen af reverse proxy-headere er ikke korrekt eller du tilgår owncloud.online fra en betroet proxy. Hvis du ikke tilgår owncloud.online fra en betroet proxy, så er dette et sikkerhedsproblem og kan tillade en angriber af forfalske deres IP-adresse som synlig for owncloud.online. Yderligere information kan findes i vores <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">dokumentation</a>.",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "Opdateringen blev ikke udført korrekt. Rapporter venligst problemet til <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.onlines fællesskabet</a>.",
    "The update was successful. There were warnings." : "Opdateringen blev gennemført. Der fremkom advarsler.",
    "The update was successful. Redirecting you to owncloud.online now." : "Opdateringen blev udført korrekt. Du bliver nu viderestillet til owncloud.online.",
    ...
    "This owncloud.online instance is currently in single user mode." : "Denne owncloud.online instans er lige nu i enkeltbruger tilstand.",
    "This means only administrators can use the instance." : "Det betyder at det kun er administrator, som kan benytte owncloud.online.",
