OC.L10N.register(
    ...
    "Server version %s or higher is required." : "Der kræves owncloud.online %s eller højere.",
    "Server version %s or lower is required." : "owncloud.online %s eller lavere er påkrævet.",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "Appen kan ikke installeres, da den ikke er kompatibel med denne version af owncloud.online.",
    ...
    "Storage" : "Opbevaring",
    "Security" : "Sikkerhed",
    "User Authentication" : "Brugerautorisation",
    "Encryption" : "Kryptering",
    "Workflows & Tags" : "Arbejdsflow & Tags",
    "Sharing" : "Deling",
    "Search" : "Søg",
    ...
    "%s" : "%s",
    "%s via %s" : "%s via %s",
    "Sharing %s failed, because the backend does not allow shares from type %d" : "Deling af %s mislykkedes, fordi backenden ikke tillader delinger fra typen %d",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "Justeres denne indstilling i php.ini, så vil owncloud.online kunne køre igen",
