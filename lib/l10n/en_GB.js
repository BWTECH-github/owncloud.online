OC.L10N.register(
    ...
    "Server version %s or higher is required." : "owncloud.online %s or higher is required.",
    "Server version %s or lower is required." : "owncloud.online %s or lower is required.",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "App can't be installed because it is not compatible with this version of owncloud.online",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "Adjusting this setting in php.ini will make owncloud.online run again",
