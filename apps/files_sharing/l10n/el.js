OC.L10N.register(
    ...
    "Add" : "Προσθήκη",
    "No compatible server installation found at {remote}" : "Δεν βρέθηκε εγκατάσταση owncloud.online (7 ή νεώτερη) στο {remote}",
    "Invalid server url" : "Μη έγκυρη url owncloud.online",
    "Share" : "Διαμοιρασμός",
