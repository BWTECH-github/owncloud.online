OC.L10N.register(
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "برنامه های رسمی توسط و درون جامعه owncloud.online توسعه می یابند. آن ها قابلیت های مرکزی خود را برای owncloud.online ارائه می دهند و آماده استفاده برای تولید هستند.",
