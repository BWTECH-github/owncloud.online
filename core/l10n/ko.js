OC.L10N.register(
    ...
    "Dismiss" : "닫기",
    "seconds ago" : "초 지남",
    "You have enabled one or more Enterprise apps but your installation does not have a valid license yet." : "하나 이상의 owncloud.online Enterprise 앱을 켰으나 아직 유효한 라이선스가 없습니다.",
    ...
    "To try the Enterprise apps, just start a 30-day demo and enter the provided license key below." : "owncloud.online Enterprise를 체험하려면, 30일 데모를 시작하고 제공된 라이선스 키를 하단에 입력하세요.",
    "Upgrade to Enterprise" : "owncloud.online Enterprise로 업그레이드",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "역방향 프록시 헤더 설정이 올바르지 않거나 신뢰하는 프록시를 통해 owncloud.online에 접근하고 있을 수 있습니다 만약 owncloud.online를 신뢰하는 프록시를 통해 접근하고 있지 않다면 이는 보안 문제이며 공격자가 IP 주소를 속이고 있을 수 있습니다. 자세한 내용은 <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">문서</a>를 참고하십시오.",
    ...
    "The \"{header}\" HTTP header is misconfigured. Expected values are \"none\" or \"noindex, nofollow\". This is a potential security or privacy risk and we recommend adjusting this setting." : "\"{header}\" HTTP header가 설정되지 않았습니다. 예상되는 값은 \"none\" 또는 \"noindex, nofolow\"입니다. 이것은 잠재적 보안 또는 비밀정보 위험이 있으며 우리는 설정을 조정할 것을 권고합니다.",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "업데이트가 실패하였습니다. 이 문제를 <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online 커뮤니티</a>에 보고해 주십시오.",
    "The update was successful. There were warnings." : "업데이트가 성공했습니다. 일부 경고가 있습니다.",
    "The update was successful. Redirecting you to owncloud.online now." : "업데이트가 성공했습니다. owncloud.online로 돌아갑니다.",
    ...
    "This owncloud.online instance is currently in single user mode." : "owncloud.online 인스턴스가 현재 단일 사용자 모드로 동작 중입니다.",
