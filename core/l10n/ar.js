OC.L10N.register(
    "core",
    {
    "Login paused for a moment" : "تم إيقاف تسجيل الدخول مؤقتًا للحظة",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "حدثت عدة محاولات فاشلة من اتصالك، لذا نُبطئ تسجيل الدخول لفترة وجيزة لحماية حسابك.",
    "You can try again in %s." : "الوقت المتبقي قبل المحاولة التالية: %s.",
    "You can try again now." : "يمكنك المحاولة مرة أخرى الآن.",
    "Forgotten your password? Use the reset link instead of trying again." : "هل نسيت كلمة المرور؟ استخدم رابط إعادة التعيين بدلاً من المحاولة مرة أخرى.",
    "_%n second_::_%n seconds_" : ["%n ثانية", "ثانية واحدة", "ثانيتان", "%n ثوانٍ", "%n ثانية", "%n ثانية"],
    "_%n minute_::_%n minutes_" : ["%n دقيقة", "دقيقة واحدة", "دقيقتان", "%n دقائق", "%n دقيقة", "%n دقيقة"],
    ...
    "You have enabled one or more Enterprise apps but your installation does not have a valid license yet." : "لقد قمت بتمكين تطبيق واحد أو أكثر من تطبيقات owncloud.online Enterprise ، ولكن التثبيت الخاص بك ليس لديه ترخيص صالح حتى الآن.",
    ...
    "To try the Enterprise apps, just start a 30-day demo and enter the provided license key below." : "لتجربة owncloud.online Enterprise ، ما عليك سوى بدء العرض التوضيحي لمدة 30 يومًا وإدخال مفتاح الترخيص المقدم أدناه.",
    "Upgrade to Enterprise" : "التطور إلى owncloud.online Enterprise",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "تكوين عناوين الوكيل العكسي غير صحيح، أو أنت تدخل إلى owncloud.online من وكيل موثوق. إذا لم تدخل إلى owncloud.online من وكيل موثوق، فإن ذلك مشكلة أمنية، ويمكن أن تسمح للمتطفل بانتحال عنوان IP الخاص بها على أنه مرئي لـ owncloud.online. ويمكن العثور على مزيد من المعلومات في <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">مستنداتنا</a>.",
    ...
    "Share with people on other servers using the syntax username@example.com/owncloud" : "المشاركة مع الأشخاص على owncloud.onlines الأخرى باستخدام العبارة username@example.com/owncloud",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "فشل التحديث. يُرجى الإبلاغ عن هذه المشكلة <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">لمجتمع owncloud.online</a>.",
    "The update was successful. There were warnings." : "نجح التحديث. توجد تحذيرات.",
    "The update was successful. Redirecting you to owncloud.online now." : "تم التحديث بنجاح، تتم إعادة توجيهك إلى Owncloud الآن.",
    ...
    "This owncloud.online instance is currently in single user mode." : "مثيل owncloud.online هذا في وضع المستخدم الواحد حاليًا.",
