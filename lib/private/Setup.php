 ...
 * Changes:
 *   - Fix PHP 8.4 null config deprecations
 *   - htaccess RewriteBase rules block API requests for files with common exten...
...
class Setup {
	...
	public static function protectDataDirectory() {
		...
		$content = "# Generated by owncloud.online on $now\n";
