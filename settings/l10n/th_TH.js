OC.L10N.register(
    ...
    "Unable to change display name" : "ไม่สามารถเปลี่ยนชื่อที่แสดงได้",
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "แอปพลิเคชันได้รับการพัฒนาอย่างเป็นทางการภายในชุมชน owncloud.online และพร้อมสำหรับการใช้งานแล้ว",
    ...
    "This app has no minimum server version assigned. This will be an error in version 11 and later." : "แอปฯนี้ได้ไม่บ่งบอกเวอร์ชันต่ำสุดของ owncloud.online นี้จะเป็นปัญหาใน owncloud.online เวอร์ชัน 11 และเวอร์ชันต่อไป",
    "This app has no maximum server version assigned. This will be an error in version 11 and later." : "แอปฯนี้ได้ไม่บ่งบอกเวอร์ชันสูงสุดของ owncloud.online  นี้จะเป็นข้อผิดพลาดใน owncloud.online ที่ 11 และเวอร์ชันต่อมา",
    ...
    "Encryption alone does not guarantee security of the system. Please see the owncloud.online documentation for more information about how the encryption app works, and the supported use cases." : "การเข้ารหัสลับเพียงอย่างเดียวไม่ได้รับประกันความปลอดภัยของระบบ โปรดดูเอกสาร owncloud.online สำหรับข้อมูลเพิ่มเติมเกี่ยวกับวิธีการเข้ารหัสแอปพลิเคชันและกรณีการสนับสนุน",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "คุณจำเป็นต้องโอนย้ายคีย์การเข้ารหัสลับของคุณจากการเข้ารหัสเก่า (owncloud.online <= 8.0) ไปใหม่ กรุณาเปิดใช้งาน \"โมดูลการเข้ารหัสเริ่มต้น\" และเรียกใช้ 'occ encryption:migrate'",
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : "คุณจำเป็นต้องโอนย้ายคีย์การเข้ารหัสลับของคุณจากการเข้ารหัสเก่า (owncloud.online <= 8.0) ไปใหม่",
    ...
    "Set default expiration date for federated shares" : "ตั้งค่าวันหมดอายุเริ่มต้นสำหรับการแชร์สหพันธ์",
    ...
    "Allow users to send mail notification for shared files to other users" : "อนุญาตให้ผู้ใช้ส่งการแจ้งเตือนทางอีเมลสำหรับไฟล์ที่แชร์กับผู้ใช้คนอื่น ๆ",
    ...
    "Test receiver email" : "ทดสอบผู้รับอีเมล",
    "Test email settings" : "ทดสอบส่งอีเมล",
    "Send email" : "ส่งอีเมล",
    ...
    "Enable manual file locking in the web interface" : "เปิดใช้งานการล็อกไฟล์ด้วยตนเองบนเว็บอินเทอร์เฟซ",
    "Allow users in the following groups to unlock files they have access to:" : "อนุญาตให้ผู้ใช้ในกลุ่มต่อไปนี้ปลดล็อกไฟล์ที่เข้าถึงได้:",
    "Users in these groups can unlock files even if they are not the owner of the lock." : "ผู้ใช้ในกลุ่มเหล่านี้สามารถปลดล็อกไฟล์ได้แม้ว่าจะไม่ใช่เจ้าของก็ตาม",
    "Security & setup warnings" : "คำเตือนความปลอดภัยและการติดตั้ง",
    "php does not seem to be setup properly to query system environment variables. The test with getenv(\"PATH\") only returns an empty response." : "ไม่ได้ติดตั้ง PHP อย่างถูกต้องค้นหาตัวแปรสภาพแวดล้อมของระบบการทดสอบกับ getenv(\"PATH\") ส่งกลับเฉพาะการตอบสนองที่ว่างเปล่า",
    ...
    "Your database does not run with \"READ COMMITTED\" transaction isolation level. This can cause problems when multiple actions are executed in parallel." : "ฐานข้อมูลของคุณไม่ทำงานด้วย \"READ COMMITTED\" โดยการแยกเลเวลของแต่ละธุรกรรม ซึ่งอาจทำให้เกิดปัญหาเมื่อมีการดำเนินการหลายอย่างพร้อมกัน",
