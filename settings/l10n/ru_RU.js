OC.L10N.register(
    ...
    "Data too long" : "Слишком длинные данные",
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "Официальные приложения разработаны силами сообщества owncloud.online. Они составляют основу возможностей owncloud.online и готовы к эксплуатации.",
    ...
    "This app has no minimum server version assigned. This will be an error in version 11 and later." : "Для этого приложения не указана минимальная версия ownClowd. Будет считаться ошибкой начиная с версии ownClowd 11.",
    "This app has no maximum server version assigned. This will be an error in version 11 and later." : "Для этого приложения не указана максимальная версия ownClowd. Будет считаться ошибкой начиная с версии ownClowd 11.",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "Вам необходимо произвести конвертацию ключей шифрования из старого формата (owncloud.online <= 8.0) в новый. Пожалуйста включите \"Модуль шифрования по умолчанию\" и запустите команду 'occ encryption:migrate'.",
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : "Вам необходимо произвести конвертацию ключей шифрования из старого формата (owncloud.online <= 8.0) в новый.",
    "Start migration" : "Запустить миграцию",
    "Two-factor Authentication" : "Двухфакторная аутентификация",
    "This section requires a two-factor authentication app to be installed in owncloud.online" : "В этом разделе необходимо установить приложение двухфакторной аутентификации в owncloud.online",
    ...
    "At least one two-factor authentication app is installed and enabled in owncloud.online." : "В owncloud.online установлено и включено как минимум одно приложение для двухфакторной аутентификации.",
    ...
    "Set default expiration date for federated shares" : "Установить дату устаревания по умолчанию для федеративных ресурсов общего доступа",
    ...
    "Save" : "Сохранить",
    "Remove current license key" : "Удалить текущий лицензионный ключ",
    ...
    "Test receiver email" : "Получатель тестового сообщения",
    "Test email settings" : "Проверить настройки почты",
    ...
    "Enable manual file locking in the web interface" : "Разрешить ручную блокировку в веб-интерфейсе",
    "Allow users in the following groups to unlock files they have access to:" : "Разрешить пользователям из следующих групп разблокировать файлы, к которым у них есть доступ:",
    "Users in these groups can unlock files even if they are not the owner of the lock." : "Пользователи из этих групп могут разблокировать файлы, даже если они не являются владельцами блокировки.",
    ...
    "Your database does not run with \"READ COMMITTED\" transaction isolation level. This can cause problems when multiple actions are executed in parallel." : "Ваша база данных работает не в режиме изоляции транзакций «READ COMMITTED». Это может вызвать проблемы, если несколько действий выполняются одновременно.",
    ...
    "If your installation is not installed in the root of the domain and uses system cron, there can be issues with the URL generation. To avoid these problems, please set the \"overwrite.cli.url\" option in your config.php file to the webroot path of your installation (Suggested: \"%s\")" : "Если ваша копия owncloud.online установлена не в корне домена и использует системный планировщик cron, возможны проблемы с правильной генерацией URL. Чтобы избежать этого, установите опцию \"overwrite.cli.url\" в файле config.php равной пути папки установки. (Предположительно: \"%s\".)",
    ...
    "Our imprint conditions:" : "Наши импринтные условия:",
    ...
    "The administrators can enable additional apps which add settings sections here." : "Администраторы могут включать дополнительные приложения, которые Добавить сюда настройки.",
    ...
    "change full name" : "измените полное имя",
