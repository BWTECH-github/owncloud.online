OC.L10N.register(
    ...
    "Server version %s or higher is required." : "оунКлауд %s или новији је потребан.",
    "Server version %s or lower is required." : "оунКлауд %s или старији је потребан.",
    ...
    "File name contains at least one invalid character" : "Назив садржи бар један недозвољен карактер",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "Апликације не може бити инсталирана јер није компатибилна са овом верзијом оунКлауда",
    ...
    "%s via %s" : "%s путем %s",
    "Sharing %s failed, because the backend does not allow shares from type %d" : "Дељење %s није успело зато што поздина не дозвољава дељење од типа %d",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "Подешавање ове поставке у php.ini фајлу ће омогућити да оунКлауд поново ради",
