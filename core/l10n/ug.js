OC.L10N.register(
    ...
    "You have enabled one or more Enterprise apps but your installation does not have a valid license yet." : "سىز بىر ياكى بىر قانچە owncloud.online ئەپلىرىنى قوزغاتتىڭىز لىكىن سىزنىڭ قاچىلانمىڭىزدا ئىناۋەتلىك ئىجازەتنامە يوق.",
    ...
    "To try the Enterprise apps, just start a 30-day demo and enter the provided license key below." : "owncloud.online ئورگان نەشىرىنى ئىشلىتىش ئۈچۈن، 30-كۈنلۈك سىناقنى باشلاڭ ھەمدە تەمىنلەنگەن گۇۋاھنامە ئاچقۇچىنى تۆۋەنگە كىرگۈزۈڭ.",
    "Upgrade to Enterprise" : "owncloud.online ئورگان نەشىرىگە يۈكسەلدۈرۈش",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "تەتۈر ۋاكالەتچى باشلانما تەڭشىكى خاتا، ياكى سىز owncloud.online غا بىر ئىشەنچلىك ۋاكالەتچى ئارقىلىق كىردىڭىز. ئەگەر سىز owncloud.online غا بىر ئىشەنچلىك ۋاكالەتچى ئارقىلىق كىرمىسىڭىز، بۇ بىر بىخەتەرلىك مەسىلىسى ھەمدە ھۇجۇمچىلارنىڭ IP ئادىرىسىنى owncloud.online  غا كۆرۈنمەيدىغان قىلالىشىغا يول قۇيىدۇ. <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">پۈتۈك</a> تە تېخىمۇ كۆپ ئۇچۇرلارغا ئېرىشەلەيسىز.",
    ...
    "Share with people on other servers using the syntax username@example.com/owncloud" : "تۆۋەندىكى بەلگە ئارقىلىق باشقا owncloud.onlines دىكى كىشلەر بىلەن ھەمبەھىرلەڭ username@example.com/owncloud",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "بۇ يېڭىلاش مۇۋەپپەقىيەتلىك بولمىدى. بۇ مەسىلىنى <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online community</a> غا مەلۇم قىلىڭ.",
    "The update was successful. There were warnings." : "يېڭىلاش مۇۋەپپەقىيەتلىك بولدى. ئاگاھلاندۇرۇشلار مەۋجۇت.",
    "The update was successful. Redirecting you to owncloud.online now." : "يېڭىلاش مۇۋەپپىقىيەتلىك بولدى. سىزنى ھازىرلا owncloud.online غا يۆتكەيمىز.",
    ...
    "This owncloud.online instance is currently in single user mode." : "بۇ owncloud.online ئۈلگىسى ھازىر يالغۇز ئىشلەتكۈچى ھالەتتە.",
