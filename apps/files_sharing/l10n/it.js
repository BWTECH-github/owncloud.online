OC.L10N.register(
    ...
    "Do you want to add the federated share {name} from {owner}@{remote}?" : "Vuoi aggiungere la condivisione federata {name} da {owner}@{remote}?",
    "Federated share" : "Condivisione federata",
    "Federated share password" : "Password della condivisione federata",
    "Cancel" : "Annulla",
    "Add federated share" : "Aggiungi condivisione federata",
    "The video cannot be played because your browser does not support the file type. Please try another browser." : "Il video non può essere riprodotto in quanto il tuo browser non supporta il tipo di file. Provare un altro browser.",
    "You can upload into this folder" : "Puoi caricare in questa cartella",
    "Add to another cloud" : "Aggiungi a un altro cloud",
    "Enter the server address to add the content to" : "Inserisci l'indirizzo del server per aggiungere il contenuto a",
    "Add" : "Aggiungi",
    "No compatible server installation found at {remote}" : "Nessuna installazione di owncloud.online (7 o superiore) trovata su {remote}",
    "Invalid server url" : "URL di owncloud.online non valido",
    "Share" : "Condividi",
    ...
    "You received a new federated share %2$s from %1$s" : "Hai ricevuto una nuova condivisione federata %2$s da %1$s",
    "You received a new federated share from %s" : "Hai ricevuto una nuova condivisione federata da %s",
    "%1$s accepted federated share %2$s" : "%1$s ha accettato la condivisione federata %2$s",
    "%1$s declined federated share %2$s" : "%1$s ha rifiutato la condivisione federata %2$s",
    ...
    "Received federated share from %s" : "Condivisione federata ricevuta da %s",
    "Shares" : "Condivisioni",
    ...
    "Public link creation is only possible for certain groups" : "La creazione di link pubblici è disponibile solamente per certi gruppi",
