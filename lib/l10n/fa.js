OC.L10N.register(
    ...
    "Server version %s or higher is required." : "owncloud.online با نسخه‎ی %s یا بالاتر نیاز است.",
    "Server version %s or lower is required." : "owncloud.online با نسخه‎ی %s یا پایین‌تر نیاز است.",
