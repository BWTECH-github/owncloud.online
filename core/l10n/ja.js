OC.L10N.register(
    "core",
    {
    "Login paused for a moment" : "ログインを一時停止しています",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "お使いの接続から複数回のログイン失敗があったため、アカウント保護のためログインを一時的に制限しています。",
    "You can try again in %s." : "%s後に再試行できます。",
    "You can try again now." : "今すぐ再試行できます。",
    "Forgotten your password? Use the reset link instead of trying again." : "パスワードをお忘れですか？再試行する代わりに、リセットリンクをご利用ください。",
    ...
    "Image too large" : "画像/イメージが大きすぎます",
    ...
    "Recipients can view, download and upload contents." : "受信者はコンテンツの閲覧、ダウンロード、アップロードができます。",
    ...
    "Dismiss" : "閉じる",
    "seconds ago" : "数秒前",
    "You have enabled one or more Enterprise apps but your installation does not have a valid license yet." : "1つ以上の owncloud.online Enterpriseアプリを有効にしましたが、インストールに有効なライセンスがまだありません。",
    "A grace period of 24 hours has started to allow you to get going right away. Once the grace period ends, all Enterprise apps will become disabled unless you supply a valid license key." : "すぐに作業を開始できるように、24 時間の猶予期間を開始しました。 猶予期間が終了すると、有効なライセンスキーを設定しない限り、すべてのエンタープライズ アプリは無効になります。",
    "To try the Enterprise apps, just start a 30-day demo and enter the provided license key below." : "owncloud.online Enterpriseの30日間のデモを試すには、提供されたパスキーを下に入力してください",
    "Upgrade to Enterprise" : "owncloud.online Enterpriseにアップグレード",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "リバースプロキシのヘッダー設定が間違っているか、または信頼されたプロキシ経由でowncloud.onlineにアクセスしています。もし、信頼されたプロキシ経由でowncloud.onlineにアクセスしていない場合、攻撃者が彼らのサーバーのIPアドレスをowncloud.onlineの物であるように詐称してなりすますことができる状態で、セキュリティ上の問題があります。詳細な情報は、 <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">ドキュメント</a>を確認してください。",
    ...
    "The \"{header}\" HTTP header is misconfigured. Expected values are \"none\" or \"noindex, nofollow\". This is a potential security or privacy risk and we recommend adjusting this setting." : "「{header}」HTTP ヘッダーの構成が間違っています。 期待される値は「none」または「noindex, nofollow」です。 これはセキュリティまたはプライバシーの潜在的なリスクとなるため、この設定を調整することをお勧めします。",
    ...
    "An error occurred while sending email" : "メール送信中にエラーが発生しました",
    ...
    "No users or groups found" : "ユーザあるいはグループが見つかりませんでした。",
    ...
    "Share with people on other servers using the syntax username@example.com/owncloud" : "ユーザー名@example.com/owncloud の形式で他のowncloud.onlineのユーザーと共有",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "更新に失敗しました。この問題を <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online コミュニティ</a> に報告してください。",
    "The update was successful. There were warnings." : "更新は成功しました。警告がありました。",
    "The update was successful. Redirecting you to owncloud.online now." : "更新に成功しました。今すぐowncloud.onlineにリダイレクトします。",
    ...
    "This owncloud.online instance is currently in single user mode." : "このowncloud.onlineインスタンスは、現在シングルユーザーモードです。",
