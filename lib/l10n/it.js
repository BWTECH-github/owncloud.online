OC.L10N.register(
    ...
    "Server version %s or higher is required." : "Richiesto owncloud.online %s o superiore.",
    "Server version %s or lower is required." : "Richiesto owncloud.online %s o inferiore.",
    "%s is member of a group not allowed to access through this login mechanism" : "%sè membro di un gruppo a cui non è consentito l'accesso tramite questo meccanismo di login",
    "%s isn't member of a group allowed to access through this login mechanism" : "%snon è membro di un gruppo a cui è consentito l'accesso tramite questo meccanismo di login",
    "A login policy has blocked the login" : "Un criterio di accesso ha bloccato il login",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "L'applicazione non può essere installata poiché non è compatibile con questa versione di owncloud.online",
    ...
    "No license key available." : "Nessuna chiave di licenza disponibile.",
    "Invalid license key!" : "Chiave di licenza non valida!",
    "Please contact your administrator or %s for a new license key." : "Si prega di contattare l'amministratore o %s per una nuova chiave di licenza.",
    "Your Enterprise license key has expired." : "La tua chiave di licenza Enterprise è scaduta.",
    "Enterprise features have been disabled." : "Le funzionalità Enterprise sono state disattivate.",
    "Evaluation - expires today." : "Valutazione - scade oggi.",
    "Evaluation - expires in %d days." : "Valutazione - scade tra %d giorni.",
    "Your Enterprise license key is about to expire (days remaining: %d)." : "La tua chiave di licenza Enterprise sta per scadere (giorni rimanenti: %d).",
    "The registered enterprise license key expires in %d days" : "La chiave di licenza enterprise registrata scade tra %d giorni",
    ...
    "%s enter the database name or connection string." : "%s immettere il nome del database o la stringa di connessione.",
    ...
    "Can't create or write into the apps-external directory %s" : "Impossibile creare o scrivere nella cartella apps-external %s",
    "Can't update %s - it is a directory" : "Impossibile aggiornare %s - è una cartella",
    "Can't update %s" : "Impossibile aggiornare %s",
    "Invalid Federated Cloud ID" : "ID di cloud federata non valido",
    "Internal mail notification for shared files is not allowed" : "La notifica di posta interna per i file condivisi non è consentita",
    "%s shared »%s« with you" : "%s ha condiviso «%s» con te",
    "Public link mail notification is not allowed" : "Non è consentita la notifica via posta con collegamento pubblico",
    "%s" : "%s",
    "%s via %s" : "%s tramite %s",
    "Sharing %s failed, because the backend does not allow shares from type %d" : "Condivisione %s fallita, perché il backend non consente condivisioni dal tipo %d",
    ...
    "Cannot remove all permissions" : "Impossibile rimuovere tutti i permessi",
    "Cannot set the requested share permissions for %s" : "Impossibile impostare le autorizzazioni di condivisione richieste per %s",
    "Cannot set the requested share attributes for %s" : "Impossibile impostare gli attributi di condivisione richiesti per %s",
    ...
    "Only the following characters are allowed in a username: \"a-z\", \"A-Z\", \"0-9\", and \"+_.@-'\"" : "In un nome utente sono consentiti solo i seguenti caratteri: \"a-z\", \"A-Z\", \"0-9\" e \"+_.@-'\"",
    ...
    "The username can not be longer than 64 characters" : "Il nome utente non può essere più lungo di 64 caratteri",
    "The special username %s is not allowed" : "Il nome utente speciale %s non è consentito",
    ...
    "Access to this resource or one of its sub-items has been denied." : "L'accesso a questa risorsa o a uno dei suoi elementi secondari è stato negato.",
    "File cannot be downloaded" : "Impossibile scaricare il file",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "La modifica di questa impostazione nel file php.ini permetterà nuovamente l'esecuzione di owncloud.online",
