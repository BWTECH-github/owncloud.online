OC.L10N.register(
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "Les applications officielles sont développées par et avec la communauté owncloud.online. Elles permettent à owncloud.online d'offrir ses fonctionnalités principales et sont prêtes pour une utilisation en environnement de production. ",
    ...
    "Resend invitation email" : "Renvoyer l'e-mail d'invitation",
    "never" : "jamais",
    "unknown" : "Inconnu",
    ...
    "This app has no minimum server version assigned. This will be an error in version 11 and later." : "Cette app ne spécifie pas de version d'owncloud.online minimale requise. Cela provoquera une erreur dans owncloud.online 11+",
    "This app has no maximum server version assigned. This will be an error in version 11 and later." : "Cette app ne spécifie pas de version d'owncloud.online maximale requise. Cela provoquera une erreur dans owncloud.online 11+",
    ...
    "Encryption alone does not guarantee security of the system. Please see the owncloud.online documentation for more information about how the encryption app works, and the supported use cases." : "Le chiffrement seul ne peut garantir la sécurité du système. Veuillez consulter la documentation owncloud.online pour comprendre comment fonctionne l'application de chiffrement, et les cas d'utilisation pris en charge.",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "Vous devez migrer vos clés de chiffrement de l'ancienne version (owncloud.online <= 8.0) vers la nouvelle. Veuillez activer l'application \"Default Encryption Module\" et exécuter 'occ encryption:migrate'",
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : "Vous devez migrer vos clés de chiffrement de l'ancienne version (owncloud.online <= 8.0) vers la nouvelle.",
    ...
    "Set default expiration date for user shares" : "Définir la date d'expiration par défaut pour les partages d'utilisateur",
    "Set default expiration date for group shares" : "Définir la date d'expiration par défaut pour les partages de groupe",
    ...
    "Privacy Policy URL" : "adresse de la Politique de confidentialité",
    "Enterprise license key" : "Clé de licence \"Entreprise\"",
    "Save" : "Enregistrer",
    "Remove current license key" : "Supprimer la clé de licence actuelle",
