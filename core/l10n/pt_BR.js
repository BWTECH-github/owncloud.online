OC.L10N.register(
    "core",
    {
    "Login paused for a moment" : "Login pausado por um momento",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "Houve várias tentativas malsucedidas a partir da sua conexão, por isso estamos desacelerando brevemente o login para proteger sua conta.",
    "You can try again in %s." : "Você pode tentar novamente em %s.",
    "You can try again now." : "Você pode tentar novamente agora.",
    "Forgotten your password? Use the reset link instead of trying again." : "Esqueceu sua senha? Use o link de redefinição em vez de tentar novamente.",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "A configuração de cabeçalhos do proxy reverso está incorreta, ou você está acessando owncloud.online de um proxy confiável. Se você não estiver acessando owncloud.online de um proxy de confiança, esta é uma questão de segurança e pode permitir a um invasor falsificar o endereço IP como visíveis para owncloud.online. Mais informação pode ser encontrada na nossa <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentação</a>.",
    ...
    "Share with people on other servers using the syntax username@example.com/owncloud" : "Compartilhar com usuários em outros owncloud.onlines usando a sintaxe username@example.com/owncloud",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "A atualização falhou. Por favor, relate este problema para a <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">comunidade owncloud.online</a>.",
    "The update was successful. There were warnings." : "A atualização foi bem sucedida. Havia advertências.",
    "The update was successful. Redirecting you to owncloud.online now." : "A atualização teve êxito. Você será redirecionado ao owncloud.online agora.",
    ...
    "This owncloud.online instance is currently in single user mode." : "Nesta instância owncloud.online está em modo de usuário único.",
