OC.L10N.register(
    "core",
    {
    "Login paused for a moment" : "Pieteikšanās uz brīdi apturēta",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "No jūsu savienojuma bija vairāki neveiksmīgi mēģinājumi, tāpēc mēs uz īsu brīdi palēninām pieteikšanos, lai aizsargātu jūsu kontu.",
    "You can try again in %s." : "Līdz nākamajam mēģinājumam atlicis: %s.",
    "You can try again now." : "Tagad varat mēģināt vēlreiz.",
    "Forgotten your password? Use the reset link instead of trying again." : "Aizmirsāt paroli? Izmantojiet atiestatīšanas saiti, nevis mēģiniet vēlreiz.",
    "_%n second_::_%n seconds_" : ["%n sekunde", "%n sekundes", "%n sekundes"],
    "_%n minute_::_%n minutes_" : ["%n minūte", "%n minūtes", "%n minūtes"],
    ...
    "An error occurred while sending email" : "Nosūtot e-pasta ziņojumu, radās kļūda",
    ...
    "Share with people on other servers using the syntax username@example.com/owncloud" : "Kopīgojiet saturu ar cilvēkiem, kas izmanto citu owncloud.online, izmantojot sintaksi - lietotājvārds@example.com/owncloud",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "Atjaunināšana beidzās nesekmīgi. Lūdzu, ziņojiet par šo problēmu <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online kopienai</a>.",
    "The update was successful. Redirecting you to owncloud.online now." : "Atjaunināšana beidzās sekmīgi. Tagad pārsūta jūs uz owncloud.online.",
    "Personal" : "Personīgi",
    "Users" : "Lietotāji",
    "Apps" : "Lietotnes",
    ...
    "Search" : "Meklēt",
    "You are trying to access a private link. Please log in first." : "Jūs mēģināt piekļūt privātai saitei. Nepieciešams pieteikties (ielogoties).",
