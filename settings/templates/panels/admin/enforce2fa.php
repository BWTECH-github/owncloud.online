...
<div class="section" id="2fa">
	...
	<p>
		<em><?php p($l->t('This section requires a two-factor authentication app to be installed in owncloud.online')); ?></em>
	</p>
	...
	<ul>
		<li><?php p($l->t('At least one two-factor authentication app is installed and enabled in owncloud.online.')); ?></li>
