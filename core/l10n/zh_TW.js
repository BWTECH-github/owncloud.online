OC.L10N.register(
    ...
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "您的連線有多次失敗的登入嘗試，為保護您的帳號，我們暫時放慢了登入速度。",
    ...
    "Dismiss" : "忽略",
    "seconds ago" : "幾秒前",
    "You have enabled one or more Enterprise apps but your installation does not have a valid license yet." : "您已啟用一個或多個 owncloud.online Enterprise 應用程式，但安裝無效的許可證。",
    ...
    "To try the Enterprise apps, just start a 30-day demo and enter the provided license key below." : "要試用 owncloud.online Enterprise，只需啟動一個為期 30 天的測試，然後輸入下面提供的許可證金鑰。",
    "Upgrade to Enterprise" : "升級到 owncloud.online Enterprise",
    ...
    "Share with people on other servers using the syntax username@example.com/owncloud" : "與其他在owncloud.online上的人們分享，請使用此格式 username@example.com/owncloud",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "升級失敗，請將此問題回報 <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online 社群</a>。",
    "The update was successful. There were warnings." : "更新成功，有警告訊息",
    "The update was successful. Redirecting you to owncloud.online now." : "升級成功，正將您重新導向至 owncloud.online 。",
