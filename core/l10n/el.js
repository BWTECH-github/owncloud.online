OC.L10N.register(
    ...
    "You have enabled one or more Enterprise apps but your installation does not have a valid license yet." : "Έχετε ενεργοποιήσει μία ή περισσότερες εφαρμογές στο owncloud.online Enterprise, αλλά η εγκατάστασή σας δεν έχει ακόμη έγκυρη άδεια.",
    "A grace period of 24 hours has started to allow you to get going right away. Once the grace period ends, all Enterprise apps will become disabled unless you supply a valid license key." : "Μια περίοδος χάριτος 24 ωρών έχει αρχίσει να σας επιτρέπει να ξεκινήσετε αμέσως. Μόλις λήξει η περίοδος χάριτος, όλες οι εφαρμογές Enterprise θα απενεργοποιηθούν, εκτός εάν παρέχετε έγκυρο κλειδί άδειας χρήσης.",
    "To try the Enterprise apps, just start a 30-day demo and enter the provided license key below." : "Για να δοκιμάσετε το owncloud.online Enterprise, απλώς ξεκινήστε μια επίδειξη 30 ημερών και εισαγάγετε παρακάτω το παρεχόμενο κλειδί άδειας χρήσης.",
    "Upgrade to Enterprise" : "Αναβάθμιση στο owncloud.online Enterprise",
    "Remaining time: {rtime}" : "Απομένων χρόνος: {rtime}",
    "Get your demo key" : "Λήψη κλειδιού επίδειξης",
    "Enter license key" : "Εισαγωγή κλειδιού άδειας χρήσης",
    "Set new key" : "Ορισμός νέου κλειδιού",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "Η ρύθμιση των reverse proxy headers δεν είναι σωστή ή συνδέεστε στο owncloud.online από ένα έμπιστο διαμεσολαβητή. Αν δεν συνδέεστε στο owncloud.online από έμπιστο διαμεσολαβητή, αυτό είναι ένα θέμα ασφαλείας και μπορεί να επιτρέψει σε έναν εισβολέα να εισάγει την IP διεύθυνσή του παραπλανητικά ως ορατή owncloud.online. Περισσότερες πληροφορίες υπάρχουν στην <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">τεκμηρίωση</a>.",
    ...
    "Share with people on other servers using the syntax username@example.com/owncloud" : "Διαμοιρασμός με άτομα σε άλλα owncloud.onlines χρησιμοποιώντας την σύνταξη username@example.com/owncloud",
    ...
    "Share with users or federated users…" : "Διαμοιρασμός με τους χρήστες ή με τους federated χρήστες…",
    ...
    "({scope})" : "({scope})",
    "Rename" : "Μετονομασία",
    "Do you really want to remove the tag \"{tagName}\" and unassign it from all files and folders ?" : "Θέλετε πραγματικά να καταργήσετε την ετικέτα «{tagName}» και να καταργήσετε την ανάθεση από όλα τα αρχεία και τους φακέλους;",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "Η ενημέρωση ήταν ανεπιτυχής. Παρακαλούμε στείλτε αναφορά στην <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">κοινότητα owncloud.online</a>.",
    "The update was successful. There were warnings." : "Η ενημέρωση ήταν επιτυχής. Υπήρχαν προειδοποιήσεις.",
    "The update was successful. Redirecting you to owncloud.online now." : "Η ενημέρωση ήταν επιτυχής. Μετάβαση στο owncloud.online.",
    ...
    "You took too long to log in, please try again now" : "Χρειάστηκε πολύς χρόνος για να συνδεθείτε, παρακαλούμε δοκιμάστε ξανά τώρα",
    ...
    "This owncloud.online instance is currently in single user mode." : "Αυτή η εγκατάσταση owncloud.online είναι τώρα σε κατάσταση ενός χρήστη.",
    ...
    "It looks like your instance may host many files and/or users. To ensure a smooth upgrade process, please use the command line upgrade command (occ upgrade)." : "Φαίνεται ότι η εγκατάστασή σας μπορεί να φιλοξενεί πολλά αρχεία ή/και χρήστες. Για να διασφαλίσετε μια ομαλή διαδικασία αναβάθμισης, παρακαλούμε χρησιμοποιήστε την εντολή αναβάθμισης μέσω της γραμμής εντολών (occ upgrade).",
    "Automatic upgrading is not enabled in config.php. To upgrade your instance, please use the command line updater (occ upgrade)." : "Η αυτόματη αναβάθμιση δεν είναι ενεργοποιημένη στο config.php. Για να αναβαθμίσετε την εγκατάστασή σας, παρακαλούμε χρησιμοποιήστε την εντολή αναβάθμισης μέσω της γραμμής εντολών (occ upgrade).",
