OC.L10N.register(
    "core",
    {
    "Login paused for a moment" : "Aanmelding is vir 'n oomblik onderbreek",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "Daar was verskeie mislukte pogings vanaf u verbinding, daarom vertraag ons die aanmelding kortliks om u rekening te beskerm.",
    "You can try again in %s." : "U kan oor %s weer probeer.",
    "You can try again now." : "U kan nou weer probeer.",
    "Forgotten your password? Use the reset link instead of trying again." : "Wagwoord vergeet? Gebruik die herstelskakel eerder as om weer te probeer.",
    "_%n second_::_%n seconds_" : ["%n sekonde", "%n sekondes"],
    "_%n minute_::_%n minutes_" : ["%n minuut", "%n minute"],
    ...
    "Share with people on other servers using the syntax username@example.com/owncloud" : "Deel met mense op ander owncloud.onlines deur die sintaks gebruikernaam@voorbeeld.com/owncloud te gebruik",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "Die bywerking was onsuksesvol. Rapporteer hierdie probleem by <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online-gemeenskap</a>.",
    "The update was successful. There were warnings." : "Die bywerking was suksesvol. Daar was waarskuwings.",
    "The update was successful. Redirecting you to owncloud.online now." : "Die bywerking was suksesvol. U word nou na owncloud.online herlei.",
    "Personal" : "Persoonlik",
    "Users" : "Gebruikers",
    "Apps" : "Toepassings",
    "Admin" : "Admin",
