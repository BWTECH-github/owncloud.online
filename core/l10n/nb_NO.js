OC.L10N.register(
    "core",
    {
    "Login paused for a moment" : "Innloggingen er satt på pause et øyeblikk",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "Det kom flere mislykkede forsøk fra tilkoblingen din, så vi bremser innloggingen en kort stund for å beskytte kontoen din.",
    "You can try again in %s." : "Du kan prøve igjen om %s.",
    "You can try again now." : "Du kan prøve igjen nå.",
    "Forgotten your password? Use the reset link instead of trying again." : "Glemt passordet? Bruk tilbakestillingslenken i stedet for å prøve igjen.",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "Konfigurasjon av reverse proxy-headers er ikke korrekt, eller du aksesserer owncloud.online fra en \"trusted proxy\". Hvis du ikke aksesserer owncloud.online fra en \"trusted proxy\", er dette en sikkerhetsrisiko som kan la en angriper forfalske IP-addressen sin slik den oppfattes av owncloud.online. Mer informasjon i <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">dokumentasjonen</a>.",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "Oppdateringen mislyktes. Vennligst rapporter dette problemet til <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online-fellesskapet</a>.",
    "The update was successful. There were warnings." : "Oppdateringen var vellykket. Det oppstod advarsler.",
    "The update was successful. Redirecting you to owncloud.online now." : "Oppdateringen var vellykket. Du omdirigeres nå til owncloud.online.",
    ...
    "This owncloud.online instance is currently in single user mode." : "Denne owncloud.online-instansen er for øyeblikket i enbrukermodus.",
