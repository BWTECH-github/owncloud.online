OC.L10N.register(
    "core",
    {
    "Login paused for a moment" : "Kirjautuminen on hetken tauolla",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "Yhteydestäsi tuli useita epäonnistuneita yrityksiä, joten hidastamme kirjautumista hetkeksi tilisi suojaamiseksi.",
    "You can try again in %s." : "Aikaa seuraavaan yritykseen: %s.",
    "You can try again now." : "Voit yrittää uudelleen nyt.",
    "Forgotten your password? Use the reset link instead of trying again." : "Unohditko salasanasi? Käytä palautuslinkkiä sen sijaan, että yrittäisit uudelleen.",
    "_%n second_::_%n seconds_" : ["%n sekunti", "%n sekuntia"],
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "Päivitys epäonnistui. Ilmoita ongelmasta <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online-yhteisölle</a>.",
    "The update was successful. There were warnings." : "Päivitys onnistui, tosin ilmeni varoituksia.",
    "The update was successful. Redirecting you to owncloud.online now." : "Päivitys onnistui. Selain ohjautuu nyt owncloud.onlineiisi.",
    ...
    "This owncloud.online instance is currently in single user mode." : "Tämä owncloud.online-asennus on parhaillaan single user -tilassa.",
    "This means only administrators can use the instance." : "Se tarkoittaa, että vain ylläpitäjät voivat nyt käyttää tätä owncloud.onlineia.",
