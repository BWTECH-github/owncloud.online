OC.L10N.register(
    ...
    "Sharing cannot be enabled due to the chosen authentication method" : "Seçilen kimlik doğrulama yöntemi nedeniyle paylaşım etkinleştirilemiyor",
    ...
    "An error occurred while adding the external storage, please check the logs or contact the administrator" : "Harici depolama eklenirken bir hata oluştu, lütfen günlükleri kontrol edin veya yönetici ile iletişime geçin.",
    "External storage has been added successfully" : "Harici depolama başarıyla eklendi",
    "An error occurred while adding the external storage please check the logs" : "Harici depolama eklenirken bir hata oluştu, lütfen günlükleri kontrol edin",
    "An error occurred while loading external mount point: {name}" : "Harici bağlama noktası yüklenirken bir hata oluştu: {name}",
    "Saved" : "Kaydedildi",
    ...
    "Couldn't get the information from the remote server: {code} {type}" : "owncloud.online sunucusundan bilgi alınamadı: {code} {type}",
    ...
    "SMB Personal (unique file IDs)" : "SMB Kişisel (benzersiz dosya ID'leri)",
    "Share" : "Paylaş",
    "Domain" : "Alan adı",
    "SMB Collaborative (shared file IDs)" : "SMB İşbirlikçi (paylaşılan dosya ID'leri)",
    "Service Account" : "Servis Hesabı",
    "Service Account Password" : "Servis Hesabı Parolası",
