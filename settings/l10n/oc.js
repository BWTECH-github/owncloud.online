OC.L10N.register(
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "Las aplicacions oficialas son desvolopadas per e amb la comunautat owncloud.online. Ofrisson sas foncionalitats principalas a owncloud.online e son prèstas per una utilizacion en produccion. ",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "Vos cal migrar vòstras claus de chiframent de l'anciana version (owncloud.online <= 8.0) cap a la novèla. Activatz \"owncloud.online Default Encryption Modul\" e executatz 'occ encryption:migrate'",
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : "Vos cal migrar vòstras claus de chiframent de l'anciana version (owncloud.online <= 8.0) cap a la novèla.",
