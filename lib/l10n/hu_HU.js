OC.L10N.register(
    ...
    "Server version %s or higher is required." : "ownCoud %s vagy ennél újabb szükséges.",
    "Server version %s or lower is required." : "ownCoud %s vagy ennél régebbi szükséges.",
    "Unknown filetype" : "Ismeretlen file tipús",
    "Invalid image" : "Hibás kép",
    "Avatar image is not square" : "Az avatar kép nem négyzet alakú",
    "today" : "ma",
    "yesterday" : "tegnap",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "Az alkalmazás nem telepíthető, mert nem kompatibilis az owncloud.online jelen verziójával.",
    ...
    "Workflows & Tags" : "Munkafolyamatok & Cimkék",
    "Sharing" : "Megosztás",
    "Search" : "Keresés",
    "Help & Tips" : "Segítség & Tippek",
    ...
    "%s" : "%s",
    "%s via %s" : "%s - %s",
    "Sharing %s failed, because the backend does not allow shares from type %d" : "%s megosztása sikertelen, mert a megosztási alrendszer nem engedi a %l típus megosztását",
    ...
    "Cannot set expiration date more than %s days in the future" : "Nem lehet beállítani a lejárat dátumát, %s napnál többre",
    ...
    "Username contains whitespace at the beginning or at the end" : "A felhasználónév üres karaktert tartalmaz, az elején, vagy a végén",
    "A valid password must be provided" : "Érvényes jelszót kell megadnia",
    "The username is already being used" : "Ez a bejelentkezési név már foglalt",
    "User disabled" : "Felhasználó letiltva",
    "Login canceled by app" : "A belépés megszakítva egy kiegészítő által",
    ...
    "Cannot write into \"config\" directory" : "Nem írható a \"config\" könyvtár",
    "Cannot create \"data\" directory" : "Nem lehet az \"adat\" mappát létrehozni",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "Ennek a beállításnak a szabályozásával a php.ini fájlban, újra futni fog az owncloud.online",
    "To fix this issue update your libxml2 version and restart your web server." : "A probléma megoldásához, frissítse a libxml2 verziót és indítsa újra a web kiszolgálót.",
    ...
    "Your Data directory is readable by other users" : "Az Adat mappáját olvashatják más felhasználók is.",
    "Your Data directory must be an absolute path" : "Az Adat mappájának teljes elérési úttal kell rendelkeznie",
    "Check the value of \"datadirectory\" in your configuration" : "Ellenőrízze a \"datadirectory\" értéket a konfigurációban",
    "Your Data directory  is invalid" : "Az Adat mappája érvénytelen",
    ...
    "User unknown" : "Felhasználó ismeretlen",
    "Could not obtain lock type %d on \"%s\"." : "Nem sikerült %d típusú zárolást elérni itt: \"%s\".",
    "Storage unauthorized. %s" : "Jogosulatlan tároló. %s",
    "Storage incomplete configuration. %s" : "A tároló konfiguráció hiányos. %s",
    "Storage connection error. %s" : "Tároló csatlakozási hiba. %s",
    "Storage is temporarily not available" : "A tároló átmenetileg nem elérhető",
    "Storage connection timeout. %s" : "Tároló csatlakozási időtúllépés. %s"
},
