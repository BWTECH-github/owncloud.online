OC.L10N.register(
    ...
    "Add" : "Додати",
    "No compatible server installation found at {remote}" : "Немає установленого OwnCloud (7 або вище), можна знайти на {remote}",
    "Invalid server url" : "Невірний owncloud.online URL",
    "Share" : "Поділитися",
    ...
    "%2$s shared %1$s with %3$s" : "%2$s поділився %1$s з %3$s",
    "You shared %1$s with group %2$s" : "Ви поділилися %1$s з групою %2$s",
    "%2$s shared %1$s via link" : "%2$s поділився %1$s через посилання",
