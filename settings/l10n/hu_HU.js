OC.L10N.register(
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "A hivatalos alkalmazásokat az owncloud.online közösségen belül fejlesztik. \nAz általuk nyújtott központi owncloud.online funkciók készen állnak a produktív használatra.",
    ...
    "This app has no minimum server version assigned. This will be an error in version 11 and later." : "Ennek az alkalmazásnak nincs minimális owncloud.online verzió megadva. Ez hibát okoz majd az owncloud.online 11-es és későbbi verziókban.",
    "This app has no maximum server version assigned. This will be an error in version 11 and later." : "Ennek az alkalmazásnak nincs maximális owncloud.online verzió megadva. Ez hibát okoz majd az owncloud.online 11-es és későbbi verziókban.",
    ...
    "Encryption alone does not guarantee security of the system. Please see the owncloud.online documentation for more information about how the encryption app works, and the supported use cases." : "A titkosítás nem garantálja a rendszer biztonságát. Kérjük, bővebb információért keresse fel az owncloud.online dokumentációját, ahol megtudhatja, hogy hogyan működik a titkosító alkalmazás és mikor érdemes használni.",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "Migrálni kell a titkosítási kulcsokat a régi titkosításból (owncloud.online <= 8.0) egy újba. Kérjük, engedélyezd az „Alapértelmezett titkosítási modul”-t és futtasd ezt: occ encryption:migrate",
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : "Migrálni kell a titkosítási kulcsokat a régi titkosításból (owncloud.online <= 8.0) egy újba.",
