OC.L10N.register(
    ...
    "Server version %s or higher is required." : "owncloud.online %s 以上が必要です。",
    "Server version %s or lower is required." : "owncloud.online %s 以下が必要です。",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "アプリは、このバージョンのowncloud.onlineと互換性がないためインストールできません。",
    ...
    "%s" : "%s",
    "%s via %s" : "%s に %s から",
    "Sharing %s failed, because the backend does not allow shares from type %d" : "%s を共有できませんでした。%d タイプからの共有は許可されていません。",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "php.ini 中の設定を調整するとowncloud.onlineはもう一度動作するでしょう。 ",
