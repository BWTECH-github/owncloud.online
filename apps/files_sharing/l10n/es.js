OC.L10N.register(
    ...
    "Do you want to add the federated share {name} from {owner}@{remote}?" : "Desea añadir la compartición federada {name} from {owner}@{remote}?",
    "Federated share" : "compartido federado",
    "Federated share password" : "Contraseña de la compartición federada",
    "Cancel" : "Cancelar",
    "Add federated share" : "Añadir compartición federada",
    "The video cannot be played because your browser does not support the file type. Please try another browser." : "El vídeo no se pudo reproducir porque su navegador no soporta el tipo de fichero. Por favor, inténtelo de nuevo con otro navegador.",
    "You can upload into this folder" : "Usted puede cargar en esta carpeta",
    "Add to another cloud" : "Agregar a otra nube",
    "Enter the server address to add the content to" : "Ingrese la dirección del servidor para agregar el contenido",
    "Add" : "Añadir",
    "No compatible server installation found at {remote}" : "No se encontró una instalación de owncloud.online (7 o mayor) en {remote}",
    "Invalid server url" : "URL de owncloud.online inválida",
    "Share" : "Compartir",
    "Create public link" : "Crear un link público",
    "Create and copy public link" : "Crear y copiar enlace público",
    "Public quick link" : "Enlace público rápido",
    "Public link has been copied to the clipboard." : "El enlace público ha sido copiado al portapapeles",
    "A new public link with download & view permissions has been created and copied to the clipboard." : "Un nuevo enlace público con permiso de descarga y visualización ha sido creado y copiado al portapapeles.",
    "The public link could not be created. Please contact the administrator for help." : "El enlace público no se pudo crear. Por favor, contacte con su administrador.",
    ...
    "You received a new federated share %2$s from %1$s" : "Ha recibido una nueva compartición federada %2$s de %1$s",
    "You received a new federated share from %s" : "Ha recibido una nueva compartición federada de %s",
    "%1$s accepted federated share %2$s" : "%1$s aceptó la compartición federada %2$s",
    "%1$s declined federated share %2$s" : "%1$s declinó la compartición federada %2$s",
    ...
    "The share for %1$s expired" : "El recurso compartido para %1$s expiró",
    ...
    "Received federated share from %1$s" : "Recibida compartición federada de %1$s",
    "Received federated share from %s" : "Recibida compartición federada de %s",
    "Shares" : "Compartidos",
    ...
    "Share points to a node not available" : "Compartir puntos a un nodo no disponible",
    ...
    "Public link creation is only possible for certain groups" : "La creación de enlaces públicos solo es posible para ciertos grupos",
