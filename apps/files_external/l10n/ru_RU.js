OC.L10N.register(
    ...
    "Sharing cannot be enabled due to the chosen authentication method" : "Общий доступ не может быть включен из-за выбранного метода аутентификации.",
    ...
    "An error occurred while adding the external storage, please check the logs or contact the administrator" : "При добавлении внешнего хранилища возникла ошибка, пожалуйста проверьте журналы или свяжитесь с администратором",
    "External storage has been added successfully" : "Внешнее хранилище добавлено успешно",
    "An error occurred while adding the external storage please check the logs" : "При добавлении внешнего хранилища возникла ошибка, пожалуйста проверьте журналы",
    "An error occurred while loading external mount point: {name}" : "Произошла ошибка при загрузке внешней точки монтирования: {name}",
    "Saved" : "Сохранено",
    ...
    "Couldn't get the information from the remote server: {code} {type}" : "Не удалось получить информацию от сервера OwnCloud: {code} {type}",
