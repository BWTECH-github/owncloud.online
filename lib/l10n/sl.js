OC.L10N.register(
    ...
    "Server version %s or higher is required." : "Zahtevana je različica owncloud.online %s ali višja.",
    "Server version %s or lower is required." : "Zahtevana je različica owncloud.online %s ali nižja.",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "Programa ni mogoče namestiti, ker ni skladen z trenutno nameščeno različico oblaka owncloud.online.",
    ...
    "Storage" : "Shramba",
    "Security" : "Varnost",
    "User Authentication" : "Overitev uporabnika",
    ...
    "%s" : "%s",
    "%s via %s" : "%s prek %s",
    "Sharing %s failed, because the backend does not allow shares from type %d" : "Omogočanje souporabe %s je spodletelo, ker ozadnji program ne dopušča souporabe vrste %d.",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "Prilagoditev te nastavitve v datoteki php.ini lahko omogoči delovanje oblaka owncloud.online.",
