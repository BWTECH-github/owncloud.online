OC.L10N.register(
    "core",
    {
    "Login paused for a moment" : "הכניסה הושהתה לרגע",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "היו מספר ניסיונות כושלים מהחיבור שלך, ולכן אנו מאטים לזמן קצר את הכניסה כדי להגן על החשבון שלך.",
    "You can try again in %s." : "ניתן לנסות שוב בעוד %s.",
    "You can try again now." : "ניתן לנסות שוב כעת.",
    "Forgotten your password? Use the reset link instead of trying again." : "שכחת סיסמה? יש להשתמש בקישור האיפוס במקום לנסות שוב.",
    "_%n second_::_%n seconds_" : ["%n שנייה", "%n שניות", "%n שניות"],
    ...
    "Dismiss" : "שחרור",
    "seconds ago" : "שניות",
    "You have enabled one or more Enterprise apps but your installation does not have a valid license yet." : "הפעלת יישום במסגרת תכנית ארגונית של owncloud.online אבל ההתקנה עדיין לא כוללת רישיון תקף.",
    ...
    "To try the Enterprise apps, just start a 30-day demo and enter the provided license key below." : "לניסיון של התכנית הארגונית של owncloud.online, ניתן להתחיל תכנית ניסיון בת 30 יום ולהכניס את מפתח הרישיון שמסופק מטה.",
    "Upgrade to Enterprise" : "שדרוג לתכנית עסקית של owncloud.online",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "תצורת כותרות פרוקסי ההפוכה אינה נכונה, או שהגישה ל- owncloud.online מתבצעת מ- proxy אמין. אם הגישה ל- owncloud.online אינה מ- proxy אמין, מדובר בבעיית אבטחה שמאפשרת לתוקף לזייף את כתובת ה- IP כגלויה ל- owncloud.online. מידע נוסף ניתן למצוא ב- <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">מסמכי התיעוד</a> שלנו.",
    ...
    "Share with people on other servers using the syntax username@example.com/owncloud" : "ניתן לשתף עם אנשים אחרים המשתמשים ב- owncloud.onlines בעזרת הפורמט הבא username@example.com/owncloud",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "תהליך העדכון לא הושלם בהצלחה. נא דווח את הבעיה ב<a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">קהילת owncloud.online</a>.",
    "The update was successful. There were warnings." : "העדכון בוצע בהצלחה. היו הזהרות.",
    "The update was successful. Redirecting you to owncloud.online now." : "תהליך העדכון הסתיים בהצלחה. עכשיו מנתב אותך אל owncloud.online.",
    ...
    "This owncloud.online instance is currently in single user mode." : "הפעלת owncloud.online זו עובדת כרגע במצב של משתמש יחיד.",
