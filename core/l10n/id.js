OC.L10N.register(
    "core",
    {
    "Login paused for a moment" : "Masuk dijeda sejenak",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "Ada beberapa percobaan gagal dari koneksi Anda, jadi kami memperlambat proses masuk sebentar untuk melindungi akun Anda.",
    "You can try again in %s." : "Anda dapat mencoba lagi dalam %s.",
    "You can try again now." : "Anda dapat mencoba lagi sekarang.",
    "Forgotten your password? Use the reset link instead of trying again." : "Lupa kata sandi? Gunakan tautan setel ulang alih-alih mencoba lagi.",
    "_%n second_::_%n seconds_" : ["%n detik"],
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "Konfigurasi pengembalian awalan proxy tidak betul, atau anda mengakses owncloud.online dari proxy terpercaya. Jika anda tidak mengakses owncloud.online dari sebuah proxy terpercaya, ini merupakan masalah keamanan dan dapat memperbolehkan penyerang untuk menipu alamat IP mereka agar diperbolehkan oleh owncloud.online. Informasi lebih lanjut dapat ditemukan dalam <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">dokumentasi</a> kami.",
    ...
    "Password" : "Sandi",
    "Recipients can view, download and edit contents." : "Penerima dapat melihat, mengunduh, dan menyunting konten.",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "Pembaruan gagal. Silakan laporkan masalah ini ke <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">komunitas owncloud.online</a>.",
    "The update was successful. There were warnings." : "Pembaruan telah berhasil. Terdapat peringatan.",
    "The update was successful. Redirecting you to owncloud.online now." : "Pembaruan sukses. Anda akan diarahkan ulang ke owncloud.online.",
    ...
    "This owncloud.online instance is currently in single user mode." : "owncloud.online ini sedang dalam mode pengguna tunggal.",
    "This means only administrators can use the instance." : "Ini berarti hanya administrator yang dapat menggunakan owncloud.online.",
