OC.L10N.register(
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "官方應用程式由 owncloud.online 社群開發，他們提供 owncloud.online 的主要功能，並確保穩定性足供正式使用",
    ...
    "Delete group" : "刪除群組",
    "Resend invitation email" : "重新發送邀請電子郵件",
    "never" : "永不",
    "unknown" : "未知",
    ...
    "Delete user" : "刪除使用者",
    "The invitation email for this user has been resent" : "此使用者的邀請電子郵件已重新發送",
    "The invitation email for this user could not be resent" : "無法重新發送此使用者的邀請電子郵件",
    ...
    "This app has no minimum server version assigned. This will be an error in version 11 and later." : "此應用程式沒有指定支援的最小 owncloud.online 版本，從 owncloud.online 11 之後這會是個錯誤",
    "This app has no maximum server version assigned. This will be an error in version 11 and later." : "此應用程式沒有指定支援的最大 owncloud.online 版本，從 owncloud.online 11 之後這會是個錯誤",
    ...
    "Encryption alone does not guarantee security of the system. Please see the owncloud.online documentation for more information about how the encryption app works, and the supported use cases." : "單純的加密不能保障系統的安全，請參閱 owncloud.online 說明文件以瞭解加密程式的運作，還有它支援的使用情境",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : " 您需要遷移您的加密金鑰從舊版的加密 (owncloud.online <= 8.0) 到新版，請啟用「預設加密模組」並執行 'occ encryption:migrate'",
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : " 您需要遷移您的加密金鑰從舊版的加密 (owncloud.online <= 8.0) 到新版",
    ...
    "Save" : "儲存",
    "Remove current license key" : "移除當前許可證密鑰",
