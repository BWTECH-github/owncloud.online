OC.L10N.register(
    ...
    "An error occurred while adding the external storage, please check the logs or contact the administrator" : "Es ist ein Fehler während des Hinzufügens von externem Storage aufgetreten. Bitte die Protokolldatei prüfen oder die Administration kontaktieren.",
    "External storage has been added successfully" : "Externer Speicher wurde erfolgreich hinzugefügt",
    "An error occurred while adding the external storage please check the logs" : "Es ist ein Fehler während des Hinzufügens von externem Storage aufgetreten. Bitte die Protokolldatei prüfen.",
    ...
    "Couldn't get the information from the remote server: {code} {type}" : "Es konnten keine Informationen aus dem owncloud.online -Server gelesen werden: {code} {type}",
