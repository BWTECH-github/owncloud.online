OC.L10N.register(
    ...
    "Server version %s or higher is required." : "É necessário um owncloud.online %s ou superior.",
    "Server version %s or lower is required." : "É necessário um owncloud.online %s ou inferior.",
    ...
    "_%n month ago_::_%n months ago_" : ["há %n mês atrás","há %n meses atrás","há %n meses atrás"],
    "last year" : "último ano",
    "_%n year ago_::_%n years ago_" : ["%n ano atrás","%n anos atrás","%n anos atrás"],
    "_%n hour ago_::_%n hours ago_" : ["há %n hora atrás","há %n horas atrás","há %n horas atrás"],
    "_%n minute ago_::_%n minutes ago_" : ["há %n minuto atrás","há %n minutos atrás","há %n minutos atrás"],
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "O aplicativo não pode ser instalado porque não é compatível com esta versão do owncloud.online",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "Ajustando esta configuração no php.ini irá fazer o owncloud.online rodar novamente",
