OC.L10N.register(
    ...
    "Server version %s or higher is required." : "Je vyžadován owncloud.online %s nebo vyšší.",
    "Server version %s or lower is required." : "Je vyžadován owncloud.online %s nebo nižší.",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "Aplikace nemůže být nainstalována, protože není kompatibilní s touto verzí owncloud.online",
    ...
    "User Authentication" : "Ověření uživatele",
    ...
    "%s is not supported and %s will not work properly on this platform. Use it at your own risk! " : "%s není podporována a %s nebude fungovat správně na této platformě. Používejte jen na vlastní nebezpečí! ",
    ...
    "%s" : "%s",
    "%s via %s" : "%s pomocí %s",
    "Sharing %s failed, because the backend does not allow shares from type %d" : "Sdílení %s selhalo, podpůrná vrstva nepodporuje typ sdílení %d",
    ...
    "Sharing %s failed, could not find %s, check spelling and server availability." : "Sdílení %s selhalo, %s se nepodařilo nalézt, zkontrolujte dostupnost serveru.",
    ...
    "The username must be at least 3 characters long" : "Uživatelské jméno musí mít délku alespoň 3 znaky",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "Úprava tohoto nastavení v php.ini opět rozběhne owncloud.online",
