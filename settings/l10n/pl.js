OC.L10N.register(
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "Oficjalne aplikacje są rozwijane przez społeczność owncloud.online. Oferowana funkcjonalność jest ważna dla owncloud.online i gotowa do użycia w środowisku produkcyjnym.",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "Należy dokonać migracji kluczy szyfrujących ze starej wersji (owncloud.online <= 8.0) do nowej. Włącz \"Domyślny moduł szyfrowania\" i uruchom 'occ encryption:migrate'",
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : "Należy dokonać migracji kluczy szyfrujących ze starej wersji (owncloud.online <= 8.0) do nowej.",
