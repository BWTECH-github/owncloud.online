...
class Connection extends \Doctrine\DBAL\Connection implements IDBConnection {
	...
	public function commit() {
		if($this->inTransaction() && $this->_conn instanceof \PDO && !$this->_conn->inTransaction()) {
			// See: https://www.doctrine-project.org/projects/doctrine-migrations/en/stable/explanation/implicit-commits
			return true;
		}
