OC.L10N.register(
    ...
    "Server version %s or higher is required." : "Diperlukan owncloud.online %s atau yang lebih tinggi.",
    "Server version %s or lower is required." : "owncloud.online %s atau yang lebih rendah diperlukan.",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "Apl tidak dapat diinstal karena tidak kompatibel dengan versi owncloud.online",
    ...
    "%s" : "%s",
    "%s via %s" : "%s melalui %s",
    "Sharing %s failed, because the backend does not allow shares from type %d" : "Gagal berbagi %s, karena backend tidak mengizinkan berbagi dengan tipe %d",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "Menyesuaikan pengaturan ini dalam php.ini akan menyebabkan owncloud.online berjalan kembali",
