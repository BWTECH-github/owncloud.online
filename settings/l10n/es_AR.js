OC.L10N.register(
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "Las aplicaciones oficiales son desarrolladas por y para la comunidad owncloud.online. Ellos ofrecen funcionalidades centrales a owncloud.online y están listas para ser utilizadas en su ambiente productivo.",
    ...
    "This app has no minimum server version assigned. This will be an error in version 11 and later." : "Esta aplicación no tiene asignado un mínimo de versión de owncloud.online. Esto puede provocar errores en owncloud.online 11 o superior.",
    "This app has no maximum server version assigned. This will be an error in version 11 and later." : "Esta aplicación no tiene asignado un máximo de versión de owncloud.online. Esto puede provocar errores en owncloud.online 11 o superior.",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "Necesitas migrar tus claves de encriptación desde la versión anterior (owncloud.online <= 8.0) hacia la nueva. Por favor habilita el \"Módulo de encriptación por defecto\" y ejecuta 'occ encryption:migrate'",
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : "Necesitas migrar tus claves de encriptación desde la versión anterior (owncloud.online <= 8.0) hacia la nueva.",
