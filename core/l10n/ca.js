OC.L10N.register(
    ...
    "Share with people on other servers using the syntax username@example.com/owncloud" : "Compartir amb la gent en altres owncloud.onlines utilitzant la sintaxi username@example.com/owncloud",
    "invisible" : "invisible",
    "Rename" : "Reanomena",
    "Delete" : "Esborra",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "L'actualització ha estat incorrecte. Comuniqueu aquest error a <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">la comunitat owncloud.online</a>.",
    "The update was successful. There were warnings." : "La actualització ha estat exitosa. Hi ha alertes.",
    "The update was successful. Redirecting you to owncloud.online now." : "L'actualització ha estat correcte. Ara us redirigim a owncloud.online.",
    ...
    "This owncloud.online instance is currently in single user mode." : "La instància owncloud.online està en mode d'usuari únic.",
