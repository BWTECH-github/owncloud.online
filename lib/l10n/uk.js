OC.L10N.register(
    ...
    "Server version %s or higher is required." : "Потрібен owncloud.online %s або вище.",
    "Server version %s or lower is required." : "Потрібна версія %s owncloud.online або нижча.",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "Неможливо встановити додаток, він є несумісним з даною версією owncloud.online",
    ...
    "Sharing %s failed, because the backend does not allow shares from type %d" : "Не вдалося поділитися %s, загальний доступ не допускає публікації з елементів типу %d",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "Установка цього параметру в php.ini дозволяє запуститися owncloud.online знову.",
