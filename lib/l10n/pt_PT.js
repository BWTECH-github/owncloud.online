OC.L10N.register(
    ...
    "Server version %s or higher is required." : "É necessário o owncloud.online %s ou superior.",
    "Server version %s or lower is required." : "É necessário o owncloud.online %s ou inferior.",
    "%s is member of a group not allowed to access through this login mechanism" : "%s é membro de um grupo sem permissão de acesso por meio deste mecanismo de login",
    "%s isn't member of a group allowed to access through this login mechanism" : "%s não é membro de um grupo com permissão de acesso por meio deste mecanismo de login",
    "A login policy has blocked the login" : "Uma política de login bloqueou o login",
    ...
    "_%n minute ago_::_%n minutes ago_" : ["%n minutos atrás","%n minutos atrás","%n minutos atrás"],
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "A aplicação não pode ser instalada por não ser compatível com esta versão do owncloud.online",
    ...
    "No license key available." : "Nenhuma chave de licença disponível.",
    "Invalid license key!" : "Chave de licença inválida!",
    "Please contact your administrator or %s for a new license key." : "Entre em contato com seu administrador %s para uma nova chave de licença.",
    "Your Enterprise license key has expired." : "Sua chave de licença corporativa expirou.",
    "Enterprise features have been disabled." : "Os recursos da empresa foram desativados.",
    "Evaluation - expires today." : "Avaliação - expira hoje.",
    "Evaluation - expires in %d days." : "Avaliação - expira em %d dias.",
    "Your Enterprise license key is about to expire (days remaining: %d)." : "Sua chave de licença Enterprise está prestes a expirar (dias restantes: %d).",
    "The registered enterprise license key expires in %d days" : "A chave de licença corporativa registrada expira em %d dias",
    ...
    "%s enter the database username." : "%s insira o nome de utilizador da base de dados.",
    "%s enter the database name." : "%s insira o nome da base de dados.",
    "%s enter the database name or connection string." : "%s insira o nome do banco de dados ou a string de conexão.",
    ...
    "You need to enter either an existing account or the administrator." : "Precisa de inserir uma conta existente ou de administrador.",
    ...
    "%s is not supported and %s will not work properly on this platform. Use it at your own risk! " : "%s não é suportado e %s não funcionará corretamente nesta plataforma. Use-o por sua conta e risco. ",
    ...
    "Can't create or write into the apps-external directory %s" : "Não é possível criar ou gravar no diretório apps-external %s",
    "Can't update %s - it is a directory" : "Não é possível atualizar %s - isto é um diretório",
    "Can't update %s" : "Não consigo atualizar %s",
    "Invalid Federated Cloud ID" : "Id. de Nuvem Federada Inválida",
    "Internal mail notification for shared files is not allowed" : "Notificação de correio interno para arquivos compartilhados não é permitida",
    "%s shared »%s« with you" : "%s partilhou »%s« consigo",
    "Public link mail notification is not allowed" : "Notificação de correio de linque público não é permitida",
    "%s" : "%s",
    "%s via %s" : "%s via %s",
    "Sharing %s failed, because the backend does not allow shares from type %d" : "O compartilhamento de %s falhou porque o back-end não permite compartilhamentos do tipo %d",
    ...
    "Sharing %s failed, could not find %s, check spelling and server availability." : "O compartilhamento  %s falhou, não foi possível encontrar %s, verifique o que foi digitado e a disponibilidade do servidor.",
    ...
    "Cannot set the requested share permissions for %s" : "Não é possível definir as permissões de compartilhamento solicitadas para %s",
    "Cannot set the requested share attributes for %s" : "Não é possível definir os atributos de compartilhamento solicitados para %s",
    ...
    "Could not find category \"%s\"" : "Não foi possível encontrar a categoria \"%s\"",
    "Only the following characters are allowed in a username: \"a-z\", \"A-Z\", \"0-9\", and \"+_.@-'\"" : "Somente os seguintes caracteres são permitidos em um nome de usuário: \"a-z\", \"A-Z\", \"0-9\", and \"+_.@-'\"",
    "A valid username must be provided" : "Deve ser fornecido um nome de utilizador válido",
    ...
    "The username can not be longer than 64 characters" : "O nome de usuário não pode ter mais de 64 caracteres",
    "The special username %s is not allowed" : "O nome de usuário especial %s não é permitido",
    ...
    "Access to this resource or one of its sub-items has been denied." : "O acesso a este recurso ou a um dos seus subitens foi negado.",
    "File cannot be downloaded" : "Não é possível baixar o arquivo",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "Ajustar esta configuração no php.ini fará com que o owncloud.online funcione de novo",
