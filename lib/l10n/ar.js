OC.L10N.register(
    ...
    "Server version %s or higher is required." : "إصدار owncloud.online %s أو أعلى مطلوب.",
    "Server version %s or lower is required." : "إصدار owncloud.online %s أو أقل مطلوب.",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "لا يمكن تثبيت التطبيق لأنه غير متوافق مع هذا الإصدار من owncloud.online",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "سيؤدي ضبط هذا الإعداد في php.ini إلى تشغيل owncloud.online مرة أخرى",
