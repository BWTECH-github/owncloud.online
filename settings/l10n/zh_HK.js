OC.L10N.register(
    ...
    "This app has no maximum server version assigned. This will be an error in version 11 and later." : "这个程序没有指定最高的owncloud.online版本。这是在owncloud.online11之后版本的错误。",
    ...
    "Encryption alone does not guarantee security of the system. Please see the owncloud.online documentation for more information about how the encryption app works, and the supported use cases." : "加密本身并不能保证系统的安全性。请参阅owncloud.online文档有关加密应用程序是如何工作和支持用例的详细信息等。",
