OC.L10N.register(
    ...
    "Could not reset password because the token expired" : "Das Passwort konnte nicht zurückgesetzt werden, da das Token abgelaufen ist.",
    "Could not reset password because the token does not match" : "Das Passwort konnte nicht zurückgesetzt werden, weil das Token nicht übereinstimmt.",
    ...
    "Recipients can view or download contents." : "Empfangende können Inhalte sehen und herunterladen.",
    "Download / View / Upload" : "Herunterladen / Ansehen / Hochladen",
    "Recipients can view, download and upload contents." : "Empfangende können Inhalte sehen, herunterladen und hochladen.",
    "Download / View / Edit" : "Herunterladen / Ansehen / Bearbeiten",
    "Recipients can view, download, edit, delete and upload contents." : "Empfangende können Inhalte sehen, herunterladen, bearbeiten, löschen und hochladen.",
    "Upload only" : "Nur Hochladen",
    "Receive files from multiple recipients without revealing the contents of the folder." : "Von mehreren Personen Dateien empfangen, ohne den Inhalt des Ordners zu sehen.",
    ...
    "You have enabled one or more Enterprise apps but your installation does not have a valid license yet." : "Sie haben eine oder mehrere owncloud.online Enterprise-Apps aktiviert, aber Ihre Installation verfügt noch nicht über einen gültigen Lizenzschlüssel.",
    "A grace period of 24 hours has started to allow you to get going right away. Once the grace period ends, all Enterprise apps will become disabled unless you supply a valid license key." : "Eine Demo ist gerade gestartet, damit Sie sofort loslegen können. Nach Ablauf von 24 Stunden werden alle Enterprise-Anwendungen deaktiviert, außer Sie geben einen gültigen Lizenzschlüssel an.",
    "To try the Enterprise apps, just start a 30-day demo and enter the provided license key below." : "Um owncloud.online Enterprise auszuprobieren, starten Sie eine 30-tägige Demo und geben Sie den dort angegebenen Lizenzschlüssel unten ein.",
    "Upgrade to Enterprise" : "Upgrade auf owncloud.online Enterprise",
    ...
    "No support key available." : "Kein Support-Key vorhanden.",
    "Invalid support key!" : "Ungültiger Support-Key!",
    "Please contact your administrator for a new support key." : "Bitte kontaktieren Sie Ihre Administration für einen neuen Support-Key.",
    "Your Enterprise support key has expired." : "Ihr Enterprise-Support-Key ist abgelaufen.",
    "Enterprise features have been disabled." : "Enterprise-Funktionen wurden deaktiviert.",
    "Your Enterprise support key is about to expire (days remaining: %d)." : "Ihr Enterprise-Support-Key läuft bald ab (verbleibende Tage: %d).",
    "The registered enterprise support key expires in %d days" : "Der registrierte Enterprise-Support-Key läuft in %d Tagen ab",
    "Set new key" : "Neuen Lizenzschlüssel eingeben:",
    "The link to reset your password has been sent to your email. If you do not receive it within a reasonable amount of time, check your spam/junk folders.<br>If it is not there ask your local administrator." : "Der Link zum Rücksetzen Ihres Passworts ist an Ihre E-Mail-Adresse versandt worden. Sollten Sie ihn innerhalb eines annehmbaren Zeitraums nicht empfangen, prüfen Sie bitte Ihren Spam-Ordner.<br>Wenn er sich nicht darin befindet, fragen Sie bitte bei Ihrer lokalen Administration nach.",
    "Your files are encrypted. If you haven't enabled the recovery key, there will be no way to get your data back after your password is reset.<br />If you are not sure what to do, please contact your administrator before you continue. <br />Do you really want to continue?" : "Ihre Dateien sind verschlüsselt. Wenn Sie den Wiederherstellungsschlüssel nicht aktiviert haben, werden Sie keinen Zugriff mehr auf Ihre Daten haben, nachdem Ihr Passwort zurückgesetzt wurde.<br />Wenn Sie sich nicht sicher sind, was Sie tun sollen, wenden Sie sich bitte an Ihre Administration, bevor Sie fortfahren.<br />Wollen Sie wirklich fortfahren?",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "Die Einstellung der Reverse Proxy Kopfzeile is falsch oder Sie greifen über einen gesicherten Proxy auf owncloud.online zu. Falls Sie nicht über einen gesicherten Proxy auf owncloud.online zugreifen handelt es sich um eine Sicherheitslücke, die es Angreifern erlaubt ihre IP-Adresse owncloud.online gegenüber als sichtbar darzustellen. Weitere Informationen hierzu finden Sie in unserer <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">Dokumentation</a>.",
    ...
    "You are running in DEBUG mode, this can cause unwanted side effects. Please remove the \"debug\" flag from \"config.php\"." : "owncloud.online wird im DEBUG Modus ausgeführt. Dies kann zu unerwünschten Seiteneffekten führen. Bitte entfernen Sie das \"debug\" flag in der \"config.php\".",
    ...
    "Choose an expiration date" : "Wählen Sie ein Ablaufdatum",
    ...
    "Choose a password - password policy may apply" : "Wählen Sie ein Passwort - möglicherweise gelten Passwortrichtlinien",
    "Password required" : "Passwort erforderlich",
    "Link name" : "Name des Links",
    "Name" : "Name",
    "Filename" : "Dateiname",
    "Password" : "Passwort",
    "Download / View / Upload / Edit" : "Download / Ansehen / Hochladen / Editieren",
    ...
    "Share with people on other servers using the syntax username@example.com/owncloud" : "Mit Benutzern anderer owncloud.onlines unter Verwendung der Syntax benutzername@beispiel.com/owncloud teilen",
    "Share with users…" : "Mit Benutzern teilen…",
    "Share with users, groups or federated users…" : "Freigabe für Benutzer, Gruppen oder Verbundbenutzer...",
    "Share with users or groups…" : "Mit Benutzern oder Gruppen teilen…",
    "Share with users or federated users…" : "Freigabe für Benutzer oder Verbundbenutzer...",
    "Could not be shared with the following users: {users}" : "Konnte nicht mit den folgenden Benutzern geteilt werden: {users}",
    "Add multiple users" : "Mehrere Benutzer hinzufügen",
    ...
    "({scope})" : "({scope})",
    "Rename" : "Umbenennen",
    "Do you really want to remove the tag \"{tagName}\" and unassign it from all files and folders ?" : "Möchten Sie wirklich die Markierung \"{tagName}\" entfernen und sie allen Dateien und Ordnern nicht mehr zuweisen?",
    ...
    "No tags selected for deletion." : "Es wurden keine Schlagworte zum Löschen ausgewählt.",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "Das Update ist fehlgeschlagen. Bitte melden Sie dieses Problem an die <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online Community</a>.",
    "The update was successful. There were warnings." : "Das Update war erfolgreich. Warnungen wurden ausgegeben.",
    "The update was successful. Redirecting you to owncloud.online now." : "Das Update war erfolgreich. Sie werden nun zu owncloud.online weitergeleitet.",
    ...
    "Please try again or contact your administrator." : "Bitte versuchen Sie es noch einmal oder kontaktieren Sie Ihren Administration.",
    "Login" : "Anmelden",
    "Username or email" : "Benutzername oder E-Mail",
    "Login paused for a moment" : "Anmeldung kurz angehalten",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "Von Ihrer Verbindung kamen mehrere fehlgeschlagene Versuche. Zum Schutz Ihres Kontos wird die Anmeldung deshalb kurz verlangsamt.",
    "You can try again in %s." : "Sie können es in %s erneut versuchen.",
    "You can try again now." : "Sie können es jetzt erneut versuchen.",
    "Forgotten your password? Use the reset link instead of trying again." : "Passwort vergessen? Nutzen Sie den Link zum Zurücksetzen statt es erneut zu versuchen.",
    "_%n second_::_%n seconds_" : ["%n Sekunde","%n Sekunden"],
    ...
    "This owncloud.online instance is currently in single user mode." : "Diese ownClound-Instanz befindet sich derzeit im Einzelbenutzermodus.",
    ...
    "Contact your system administrator if this message persists or appeared unexpectedly." : "Kontaktieren Sie Ihren Systemadministration, wenn diese Meldung dauerhaft oder unerwartet erscheint.",
    ...
    "Please contact your administrator. If you are an administrator of this instance, configure the \"trusted_domains\" setting in config/config.php. " : "Bitte kontaktieren Sie Ihre Administration. Wenn Sie Administratorin oder Administrator dieser Instanz sind, konfigurieren Sie bitte die „trusted_domains“-Einstellung in config/config.php.",
    ...
    "Upgrade needed" : "Upgrade erforderlich",
    "It looks like your instance may host many files and/or users. To ensure a smooth upgrade process, please use the command line upgrade command (occ upgrade)." : "Es sieht so aus, als ob Ihre Instanz viele Dateien und/oder Benutzer hosten könnte. Um einen reibungslosen Upgrade-Prozess zu gewährleisten, verwenden Sie bitte den Kommandozeilen-Upgrade-Befehl (occ upgrade).",
    "Automatic upgrading is not enabled in config.php. To upgrade your instance, please use the command line updater (occ upgrade)." : "Die automatische Aktualisierung ist in der config.php nicht aktiviert. Um Ihre Instanz zu aktualisieren, verwenden Sie bitte den Command Line Updater (occ upgrade).",
