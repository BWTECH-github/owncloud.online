OC.L10N.register(
    "core",
    {
    "Login paused for a moment" : "Innlogginga er sett på pause ei lita stund",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "Det kom fleire mislukka forsøk frå tilkoplinga di, så vi bremsar innlogginga ei kort stund for å verne kontoen din.",
    "You can try again in %s." : "Du kan prøve igjen om %s.",
    "You can try again now." : "Du kan prøve igjen no.",
    "Forgotten your password? Use the reset link instead of trying again." : "Gløymt passordet? Bruk tilbakestillingslenkja i staden for å prøve igjen.",
    "_%n second_::_%n seconds_" : ["%n sekund", "%n sekund"],
    "_%n minute_::_%n minutes_" : ["%n minutt", "%n minutt"],
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "Konfigurasjon for overskrift/hode for reversert mellomtenar er feil, eller du brukar owncloud.online fra en klarert mellomtener. Hvis du ikkje brukar owncloud.online fra en klarert mellomtener, er dette eit sikkerhetsproblem og kan tillate ein angripar å forfalske sin IP-adresse som er synlig for owncloud.online. Ytterligere informasjon finn du i vår <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">dokumentasjon</a>.",
    ...
    "Share with people on other servers using the syntax username@example.com/owncloud" : "Del med folk på annan owncloud.online med syntaks username@example.com/owncloud",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "Oppdateringa feila. Ver venleg og rapporter feilen til <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online-fellesskapet</a>.",
    "The update was successful. There were warnings." : "Forbetring var vellukka. Det var åtvaring.",
    "The update was successful. Redirecting you to owncloud.online now." : "Oppdateringa er fullført. Sender deg vidare til owncloud.online no.",
    ...
    "This owncloud.online instance is currently in single user mode." : "Denne owncloud.online førekomsten er i ein-brukar modus.",
