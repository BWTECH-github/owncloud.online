OC.L10N.register(
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "Uppsetning gagnstæðs milliþjónshauss (reverse proxy header) er röng, eða að þú ert að tengjast owncloud.online frá treystum milliþjóni. Ef þú ert ekki að tengjast owncloud.online frá treystum milliþjóni, þá er þetta er öryggisvandamál og getur leyft árásaraðilum að dulbúa IP-vistfang þeirra sem sýnilegt owncloud.online. Nánari upplýsingar má finna í <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">hjálparskjölum</a> okkar.",
    ...
    "Password" : "Lykilorð",
    "Download / View / Upload / Edit" : "Sækja / Skoða / Senda inn / Breyta",
    ...
    "An error occurred while sending email" : "Villa við að senda tölvupóst",
    ...
    "No users or groups found" : "Engir notendur eða hópar fundust",
    ...
    "Add multiple users" : "Bæta við mörgum notendum",
    "Error removing share" : "Villa við að fjarlægja sameign",
    "Unknown Share" : "Óþekkt sameign",
    ...
    "({scope})" : "({scope})",
    "Rename" : "Endurnefna",
    "Do you really want to remove the tag \"{tagName}\" and unassign it from all files and folders ?" : "Ertu viss um að þú viljir fjarlægja tagið \"{tagName}\" og aftengja það frá öllum skrám og möppum ?",
    "Remove tag" : "Fjarlægja tag",
    "Delete" : "Eyða",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "Uppfærslan tókst ekki. Sendu inn tilkynningu um vandamálið til <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online samfélagsins</a>.",
    "The update was successful. There were warnings." : "Uppfærslan tókst. Það komu upp viðvaranir.",
    "The update was successful. Redirecting you to owncloud.online now." : "Uppfærslan heppnaðist. Beini þér núna á owncloud.online.",
    ...
    "Personal note from the sender: \n %s." : "Persónuleg athugasemd frá sendanda: \n %s.",
    "Cheers!" : "Til hamingju!",
    ...
    "You took too long to log in, please try again now" : "Þú varst of lengi að skrá þig inn, reyndu núna aftur",
    ...
    "Personal note from the sender: <br> %s." : "Persónuleg athugasemd frá sendanda: <br> %s.",
    "This owncloud.online instance is currently in single user mode." : "Þetta owncloud.online-tilvik er nú í eins-notanda ham.",
    ...
    "Upgrade needed" : "Þarfnast uppfærslu",
