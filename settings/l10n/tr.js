OC.L10N.register(
    ...
    "Updated log level" : "Güncellenen günlük seviyesi",
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "Resmi uygulamalar owncloud.online topluluğu tarafından geliştirilir. owncloud.online'a işlevsellik merkezli olarak hazırlanırlar ve günlük kullanıma hazırdırlar.",
    ...
    "Resend invitation email" : "Davet e-postasını tekrar gönder",
    "never" : "hiçbir zaman",
    "unknown" : "bilinmiyor",
    ...
    "This app has no minimum server version assigned. This will be an error in version 11 and later." : "Bu uygulama atanmış bir en düşük owncloud.online sürümü içermiyor. owncloud.online 11 ve sonrasında bu bir hata olacaktır.",
    "This app has no maximum server version assigned. This will be an error in version 11 and later." : "Bu uygulama atanmış bir en yüksek owncloud.online sürümü içermiyor. owncloud.online 11 ve sonrasında bu bir hata olacaktır.",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "Eski şifreleme anahtarlarınızı eski şifrelemeden (owncloud.online <= 8.0) yenisine taşımanız gerekli. Lütfen \"Öntanımlı şifreleme modülü\"nü etkinleştirin ve 'occ encryption:migrate' çalıştırın",
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : "Eski şifreleme anahtarlarınızı eski şifrelemeden (owncloud.online <= 8.0) yenisine taşımanız gerekli.",
    "Start migration" : "Taşınmayı başlat",
    "Two-factor Authentication" : "İki Faktörlü Kimlik Doğrulama",
    "This section requires a two-factor authentication app to be installed in owncloud.online" : "Bu bölüm owncloud.online'a iki faktörlü bir kimlik doğrulama uygulamasının yüklenmesini gerektirir",
    "Enforce two-factor authentication" : "İki faktörlü kimlik doğrulamayı zorunlu kılın",
    "Before enforcing the two-factor authentication, check the following requirements:" : "İki faktörlü kimlik doğrulamayı uygulamadan önce aşağıdaki gereksinimleri kontrol edin:",
    "At least one two-factor authentication app is installed and enabled in owncloud.online." : "owncloud.online'da en az bir iki faktörlü kimlik doğrulama uygulaması kurulu ve etkinleştirilmiştir.",
    "The users can setup at least one two-factor app from the challenge page. Some apps might not be prepared for this" : "Kullanıcılar, meydan okuma sayfasından en az bir adet iki faktörlü uygulama kurabilir. Bazı uygulamalar bunun için hazırlanmamış olabilir",
    "The \"twofactor_totp\" app fulfills those requirements, and might be used as a fallback so the users can enter their accounts in order to configure other two-factor authentication apps" : "\"twofactor_totp\" uygulaması bu gereksinimleri karşılar ve kullanıcıların diğer iki faktörlü kimlik doğrulama uygulamalarını yapılandırmak için hesaplarına girebilmeleri için bir yedek olarak kullanılabilir",
    "Enforce two-factor authentication to all the users" : "Tüm kullanıcılara iki faktörlü kimlik doğrulamayı zorunlu kılın",
    "Exclude the following groups from enforcing two-factor authentication" : "Aşağıdaki grupları iki faktörlü kimlik doğrulamayı zorunlu kılmaktan hariç tutun",
    "Note: Users in these groups can use two-factor authentication on their own" : "Not: Bu gruplardaki kullanıcılar iki faktörlü kimlik doğrulamayı kendi başlarına kullanabilir",
    "Sharing" : "Paylaşım",
    ...
    "Set default expiration date for federated shares" : "Birleştirilmiş paylaşımlar için varsayılan sona erme tarihini ayarla",
    ...
    "Save" : "Kaydet",
    "Remove current license key" : "Mevcut lisans anahtarını kaldır",
    ...
    "Test receiver email" : "Alıcı e-postasını test et",
    "Test email settings" : "E-posta ayarlarını sına",
    ...
    "Enable manual file locking in the web interface" : "Web arayüzünde manuel dosya kilitlemeyi etkinleştir",
    "Allow users in the following groups to unlock files they have access to:" : "Aşağıdaki gruplardaki kullanıcıların erişimleri olan dosyaların kilidini açmasına izin verin:",
    "Users in these groups can unlock files even if they are not the owner of the lock." : "Bu gruplardaki kullanıcılar, kilidin sahibi olmasalar bile dosyaların kilidini açabilir.",
    ...
    "Your database does not run with \"READ COMMITTED\" transaction isolation level. This can cause problems when multiple actions are executed in parallel." : "Veritabanınız \"READ COMMITTED\" işlem izolasyon seviyesi ile çalışmıyor. Bu, birden çok eylem paralel olarak yürütüldüğünde sorunlara neden olabilir.",
    ...
    "Our imprint conditions:" : "Baskı koşullarımız:",
    ...
    "Done" : "Bitti",
    "To access your files through WebDAV, please use the following URL:" : "Dosyalarınıza WebDAV aracılığıyla erişmek için lütfen aşağıdaki URL'yi kullanın:",
    "Version" : "Sürüm",
    ...
    "Show creation time" : "Oluşturma zamanını göster",
