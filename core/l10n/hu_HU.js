OC.L10N.register(
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "A fordított proxy fejlécek konfigurációs beállításai helytelenek, vagy egy megbízható proxy-ból próbálja az owncloud.online-ot elérni. Ha nem megbízható proxy-ból próbálja elérni az owncloud.online-ot, akkor ez egy biztonsági probléma, a támadó az owncloud.online számára látható IP cím csalást tud végrehajtani. Bővebb információt a <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">dokumentációban</a> találhat.",
    ...
    "Share with people on other servers using the syntax username@example.com/owncloud" : "Megosztás más owncloud.online szerverekkel, a következő formátum használatával felhasználó@példa.hu/owncloud",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "A frissítés nem sikerült. Kérem értesítse erről a problémáról az <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online közösséget</a>.",
    "The update was successful. There were warnings." : "A frissítés sikerült. Figyelmeztetések találhatók.",
    "The update was successful. Redirecting you to owncloud.online now." : "A frissítés sikeres volt. Visszairányítjuk az owncloud.online szolgáltatáshoz.",
    ...
    "This owncloud.online instance is currently in single user mode." : "Ez az owncloud.online szolgáltatás jelenleg egyfelhasználós üzemmódban működik.",
