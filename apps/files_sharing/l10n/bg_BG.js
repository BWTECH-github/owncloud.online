OC.L10N.register(
    ...
    "Add" : "Добавяне",
    "No compatible server installation found at {remote}" : "Не е намерена инсталация на owncloud.online (7 или по-висока версия) в {remote}",
    "Invalid server url" : "Невалиден owncloud.online URL адрес.",
    "Share" : "Споделяне",
