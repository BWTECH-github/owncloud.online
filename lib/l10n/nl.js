OC.L10N.register(
    ...
    "Server version %s or higher is required." : "owncloud.online %s of hoger vereist.",
    "Server version %s or lower is required." : "owncloud.online %s of lager vereist.",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "De app kan niet worden geïnstalleerd, omdat die niet compatible is met deze versie van owncloud.online",
    ...
    "%s is not supported and %s will not work properly on this platform. Use it at your own risk! " : "%s wordt niet ondersteund en %s zal niet goed werken op dit platform. Gebruik het op uw eigen risico!",
    ...
    "%s" : "%s",
    "%s via %s" : "%s via %s",
    "Sharing %s failed, because the backend does not allow shares from type %d" : "Delen van %s is mislukt, omdat de share-backend niet toestaat om type %d te delen",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "Het in php.ini bijstellen hiervan laat owncloud.online weer werken",
