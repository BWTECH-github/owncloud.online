OC.L10N.register(
    ...
    "Server version %s or higher is required." : "owncloud.online %s edo haundiagoa behar da.",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "Aplikazioa ezin da instalatu owncloud.online bertsio honekin bateragarria ez delako",
    ...
    "%s via %s" : "%s %s bidez",
    "Sharing %s failed, because the backend does not allow shares from type %d" : "%s partekatzeak huts egin du, motorrak %d motako partekatzeak baimentzen ez dituelako",
