OC.L10N.register(
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "As aplicacións oficiais son desenvolvidas pola comunidade dentro do owncloud.online. Ofrecen una funcionalidade central para owncloud.online e están preparadas para o seu uso en produción.",
    ...
    "This app has no minimum server version assigned. This will be an error in version 11 and later." : "Esta aplicación non ten asignada unha versión mínima do owncloud.online. Isto será un erro no owncloud.online 11 e posteriores.",
    "This app has no maximum server version assigned. This will be an error in version 11 and later." : "Esta aplicación non ten asignada unha versión máxima do owncloud.online. Isto será un erro no owncloud.online 11 e posteriores.",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "É necesario migrar as súas claves de cifrado do antigo cifrado (owncloud.online <= 8,0) cara ao novo. Active o «Módulo predeterminado de cifrado» e execute «occ encryption:migrate»",
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : "É necesario migrar as claves de cifrado do antigo cifrado (owncloud.online <= 8,0) cara ao novo.",
    ...
    "Show creation time" : "Ensinar a data de creación",
