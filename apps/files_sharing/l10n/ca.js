OC.L10N.register(
    ...
    "%2$s shared %1$s with %3$s" : "%2$s ha compartit %1$s amb %3$s",
    "You shared %1$s with group %2$s" : "has compartit %1$s amb el grup %2$s",
    "%2$s shared %1$s via link" : "%2$s ha compartit %1$s via enllaç",
    "You shared %1$s via link" : "Heu compartit %1$s via enllaç",
    "%2$s shared %1$s with you" : "%2$s ha compartit %1$s amb tu",
    "Shared with %2$s" : "Compartit amb %2$s",
    "Shared by %2$s" : "Compartida per %2$s",
    "Shares" : "Compartits",
