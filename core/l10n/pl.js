OC.L10N.register(
    ...
    "You have enabled one or more Enterprise apps but your installation does not have a valid license yet." : "Włączyłeś jedną lub więcej aplikacji owncloud.online Enterprise, ale instalacja nie ma jeszcze ważnej licencji.",
    "A grace period of 24 hours has started to allow you to get going right away. Once the grace period ends, all Enterprise apps will become disabled unless you supply a valid license key." : "Okres próbny wynoszący 24 godziny pozwala od razu rozpocząć pracę. Po zakończeniu okresu próbnego wszystkie aplikacje Enterprise zostaną wyłączone, chyba że dostarczysz ważny klucz licencyjny.",
    "To try the Enterprise apps, just start a 30-day demo and enter the provided license key below." : "Aby wypróbować owncloud.online Enterprise, wystarczy uruchomić 30 dniową wersję demonstracyjną i wpisać poniżej podany klucz licencyjny.",
    "Upgrade to Enterprise" : "Zaktualizuj do owncloud.online Enterprise",
    ...
    "Password" : "Hasło",
    "Download / View / Upload / Edit" : "Pobierz / Zobacz / Prześlij / Edytuj",
    "Recipients can view, download and edit contents." : "Odbiorcy mogą przeglądać, pobierać i edytować zawartość.",
    ...
    "No users or groups found" : "Nie znaleziono użytkowników ani grup",
    ...
    "User" : "Użytkownik",
    "Group" : "Grupa",
    "Federated Group" : "Grupa połączona",
    "Guest" : "Gość",
    "At {server}" : "Na {server}",
    "Federated" : "Połaczona",
    ...
    "Add multiple users" : "Dodaj wielu użytkowników",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "Aktualizacja zakończyła się niepowodzeniem. Zgłoś ten problem <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">spoleczności owncloud.online</a>.",
    "The update was successful. There were warnings." : "Aktualizacja przebiegła pomyślnie. Pojawiły się ostrzeżenia.",
    "The update was successful. Redirecting you to owncloud.online now." : "Aktualizacji zakończyła się powodzeniem. Przekierowuję do owncloud.online.",
    ...
    "This owncloud.online instance is currently in single user mode." : "Ta instalacja owncloud.online działa obecnie w trybie pojedynczego użytkownika.",
    ...
    "You are accessing the server through an untrusted domain." : "Uzyskujesz dostęp do serwera za pośrednictwem niezaufanej domeny.",
    ...
    "Upgrade needed" : "Wymagana jest aktualizacja",
