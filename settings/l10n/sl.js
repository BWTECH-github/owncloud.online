OC.L10N.register(
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "Uradno odobrene programe razvija skupnost owncloud.online. Ti omogočajo osnovne zmožnosti v oblaku in so vedno posodobljeni za uporabo.",
    ...
    "This app has no minimum server version assigned. This will be an error in version 11 and later." : "Program nima določene najstarejše podprte različice oblaka owncloud.online. Tovrstne napake javljajo različice owncloud.online 11 in novejše.",
    "This app has no maximum server version assigned. This will be an error in version 11 and later." : "Program nima določene najnovejše podprte različice oblaka owncloud.online. Tovrstne napake javljajo različice owncloud.online 11 in novejše.",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "Preseliti je treba šifrirne ključe iz starega sistema (owncloud.online <= 8.0) na novega. Omogočite »Privzeti šifrirni modul» in zaženite ukaz 'occ encryption:migrate', ali pa stopite v stik s skrbnikom sistema.",
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : "Prenesti je treba šifrirne ključe iz stare šifrirne sheme (owncloud.online ≤ 8.0) na novo.",
