OC.L10N.register(
    "core",
    {
    "Login paused for a moment" : "登录已暂停片刻",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "您的连接有多次失败的登录尝试，为保护您的账户，我们暂时放慢了登录速度。",
    "You can try again in %s." : "您可以在 %s 后重试。",
    "You can try again now." : "您现在可以重试了。",
    "Forgotten your password? Use the reset link instead of trying again." : "忘记密码？请使用重置链接，而不要继续尝试。",
    ...
    "Dismiss" : "忽略",
    "seconds ago" : "几秒前",
    "You have enabled one or more Enterprise apps but your installation does not have a valid license yet." : "你已启用一个或多个 owncloud.online Enterprise 应用程序，但你的安装还没有有效的许可证。",
    "A grace period of 24 hours has started to allow you to get going right away. Once the grace period ends, all Enterprise apps will become disabled unless you supply a valid license key." : "24 小时的宽限期已开始允许你立即开始工作。 宽限期结束后，除非你提供有效的许可证密钥，否则所有企业应用程序都将被禁用。",
    "To try the Enterprise apps, just start a 30-day demo and enter the provided license key below." : "要试用 owncloud.online Enterprise，只需开始一个 30 天的演示并在下面输入提供的许可证密钥。",
    "Upgrade to Enterprise" : "升级到owncloud.online Enterprise",
    "Remaining time: {rtime}" : "剩余时间：{rtime}",
    "Get your demo key" : "获取您的演示密钥",
    ...
    "This server has no working Internet connection. This means that some of the features like mounting external storage, notifications about updates or installation of third-party apps will not work. Accessing files remotely and sending of notification emails might not work, either. We suggest to enable Internet connection for this server if you want to have all features." : "此服务器上没有可用的因特网连接. 这意味着某些特性将无法工作，例如挂载外部存储器, 提醒更新或安装第三方应用等. 从远程访问文件和发送提醒电子邮件也可能无法工作. 如果你想要owncloud.online的所有特性, 我们建议启用此服务器的因特网连接.",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "反向代理头配置不正确，或者您正从一个受信任的代理访问owncloud.online。如果你不是通过受信任的代理访问 owncloud.online，这将引发一个安全问题，可能由于 owncloud.online IP 地址可见导致欺骗攻击。更多信息可以查看我们的 <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">文档</a>。",
    ...
    "An error occurred while sending email" : "发送电子邮件时出错",
    ...
    "({scope})" : "({scope})",
    "Rename" : "重命名",
    "Do you really want to remove the tag \"{tagName}\" and unassign it from all files and folders ?" : "您真的要删除标签“{tagName}”并从所有文件和文件夹中取消分配它吗？",
    "Remove tag" : "删除标签",
    "Delete" : "删除",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "更新不成功。请汇报将此问题汇报给  <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online 社区</a>。",
    "The update was successful. There were warnings." : "更新成功。有警告。",
    "The update was successful. Redirecting you to owncloud.online now." : "更新成功。正在重定向至 owncloud.online。",
    ...
    "Wrong password." : "密码错误",
    "You took too long to log in, please try again now" : "您登录时间过长，请重新登录",
    "Stay logged in" : "保持登录",
    ...
    "This owncloud.online instance is currently in single user mode." : "当前owncloud.online实例运行在单用户模式下。",
    ...
    "Detailed logs" : "详细日志",
    "Upgrade needed" : "需要升级",
    "It looks like your instance may host many files and/or users. To ensure a smooth upgrade process, please use the command line upgrade command (occ upgrade)." : "看起来您的实例可能托管许多文件和/或用户。 为确保升级过程顺利进行，请使用命令行升级命令（occ upgrade）。",
    "Automatic upgrading is not enabled in config.php. To upgrade your instance, please use the command line updater (occ upgrade)." : "config.php 中未启用自动升级。 要升级您的实例，请使用命令行更新程序 (occ upgrade)。",
