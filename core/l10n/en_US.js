OC.L10N.register(
    "core",
    {
    "Login paused for a moment" : "Login paused for a moment",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account.",
    "You can try again in %s." : "You can try again in %s.",
    "You can try again now." : "You can try again now.",
    "Forgotten your password? Use the reset link instead of trying again." : "Forgotten your password? Use the reset link instead of trying again.",
    "_%n second_::_%n seconds_" : ["%n second", "%n seconds"],
    ...
    "You have enabled one or more Enterprise apps but your installation does not have a valid license yet." : "You have enabled one or more owncloud.online Enterprise apps but your installation does not have a valid licence yet.",
    "A grace period of 24 hours has started to allow you to get going right away. Once the grace period ends, all Enterprise apps will become disabled unless you supply a valid license key." : "A grace period of 24 hours has started to allow you to get going right away. Once the grace period ends, all Enterprise apps will become disabled unless you supply a valid licence key.",
    "To try the Enterprise apps, just start a 30-day demo and enter the provided license key below." : "To try owncloud.online Enterprise, just start a 30-day demo and enter the provided licence key below.",
    "Upgrade to Enterprise" : "Upgrade to owncloud.online Enterprise",
    "Remaining time: {rtime}" : "Remaining time: {rtime}",
    "Get your demo key" : "Get your demo key",
    "Enter license key" : "Enter licence key",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "The reverse proxy headers configuration is incorrect, or you are accessing owncloud.online from a trusted proxy. If you are not accessing owncloud.online from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to owncloud.online. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>.",
    ...
    "The \"{header}\" HTTP header is misconfigured. Expected values are \"none\" or \"noindex, nofollow\". This is a potential security or privacy risk and we recommend adjusting this setting." : "The \"{header}\" HTTP header is misconfigured. Expected values are \"none\" or \"noindex, nofollow\". This is a potential security or privacy risk and we recommend adjusting this setting.",
    ...
    "Filename" : "Filename",
    "Password" : "Password",
    "Download / View / Upload / Edit" : "Download / View / Upload / Edit",
    ...
    "No users or groups found" : "No users or groups found",
    ...
    "User" : "User",
    "Group" : "Group",
    "Federated Group" : "Federated Group",
    "Guest" : "Guest",
    "At {server}" : "At {server}",
    "Federated" : "Federated",
    ...
    "Share with people on other servers using the syntax username@example.com/owncloud" : "Share with people on other owncloud.onlines using the syntax username@example.com/owncloud",
    "Share with users…" : "Share with users…",
    "Share with users, groups or federated users…" : "Share with users, groups or federated users…",
    "Share with users or groups…" : "Share with users or groups…",
    "Share with users or federated users…" : "Share with users or federated users…",
    "Could not be shared with the following users: {users}" : "Could not be shared with the following users: {users}",
    ...
    "({scope})" : "({scope})",
    "Rename" : "Rename",
    "Do you really want to remove the tag \"{tagName}\" and unassign it from all files and folders ?" : "Do you really want to remove the tag \"{tagName}\" and unassign it from all files and folders ?",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online community</a>.",
    "The update was successful. There were warnings." : "The update was successful. There were warnings.",
    "The update was successful. Redirecting you to owncloud.online now." : "The update was successful. Redirecting you to owncloud.online now.",
    ...
    "Cheers!" : "Cheers!",
    "The application was authorized successfully. You will now get redirected to the requested page, otherwise you can close this window." : "The application was authorized successfully. You will now get redirected to the requested page, otherwise you can close this window.",
    ...
    "You took too long to log in, please try again now" : "You took too long to log in, please try again now",
    ...
    "This owncloud.online instance is currently in single user mode." : "This owncloud.online instance is currently in single user mode.",
    ...
    "You are accessing the server through an untrusted domain." : "You are accessing the server through an untrusted domain.",
    ...
    "Automatic upgrading is not enabled in config.php. To upgrade your instance, please use the command line updater (occ upgrade)." : "Automatic upgrading is not enabled in config.php. To upgrade your instance, please use the command line updater (occ upgrade).",
