OC.L10N.register(
    ...
    "Image too large" : "Bilden är för stor",
    ...
    "Could not reset password because the token is invalid" : "Kunde inte återställa lösnordet på grund av felaktig token",
    "Could not reset password because the token expired" : "Kunde inte återställa lösnordet eftersom token har utgått",
    "Could not reset password because the token does not match" : "Kunde inte återställa lösnordet på grund av token matchar inte",
    ...
    "Recipients can view or download contents." : "Mottagare kan visa eller ladda ner innehåll",
    "Download / View / Upload" : "Ladda ner / Granska / Ladda upp",
    "Recipients can view, download and upload contents." : "Mottagare kan visa, ladda ner eller ladda upp innehåll",
    "Download / View / Edit" : "Ladda ner / Granska / Ändra",
    "Recipients can view, download, edit, delete and upload contents." : "Mottagare kan visa, ladda ner, redigera, ta bort och ladda upp innehåll",
    "Upload only" : "Ladda bara upp",
    "Receive files from multiple recipients without revealing the contents of the folder." : "Ta emot filer från flera mottagare utan att avslöja innehållet i mappen",
    ...
    "You have enabled one or more Enterprise apps but your installation does not have a valid license yet." : "Du har aktiverat en eller fler av owncloud.online Enterprise appar men din installation har ännu ingen giltig licens.",
    "A grace period of 24 hours has started to allow you to get going right away. Once the grace period ends, all Enterprise apps will become disabled unless you supply a valid license key." : "En provperiod på 24 timmar har börjat för att tillåta dig att komma igång direkt. När provperioden är slut kommer alla Enterprise appar att inaktiveras om du inte tillhandahåller en giltig licensnyckel.",
    "To try the Enterprise apps, just start a 30-day demo and enter the provided license key below." : "För att prova owncloud.online Enterprise, starta bara en 30-dagars demo och ange den tillhandahållna licensnyckeln nedan.",
    "Upgrade to Enterprise" : "Uppgradera till owncloud.online Enterprise",
    "Remaining time: {rtime}" : "Återstående tid: {rtime}",
    "Get your demo key" : "Få din demo nyckel",
    "Enter license key" : "Skriv in din licensnyckel",
    "Set new key" : "Sätt en ny nyckel",
    ...
    "Error adding {addItem}: {addItem} already exists" : "Fel vid tillägg av {addItem}: {addItem} finns redan.",
    "No" : "Nej",
    "Yes" : "Ja",
    "Choose" : "Välj",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "Konfiguration för \"reverse proxy headers\" är felaktig eller så försöker du nå Owncloud från en betrodd proxy. Om du inte försöker nå Owncloud från en betrodd proxy, detta är en säkerhetsrisk och kan möjliggöra att en hacker att förfalska sin IP adress som är synlig för Owncloud. Vidare information kan finnas i vår <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">dokumentation</a>.",
    ...
    "You are running in DEBUG mode, this can cause unwanted side effects. Please remove the \"debug\" flag from \"config.php\"." : "Du kör i DEBUG-läge, detta kan orsaka oönskade bieffekter. Ta bort \"debug\"-flaggan från \"config.php\".",
    ...
    "The \"{header}\" HTTP header is misconfigured. Expected values are \"none\" or \"noindex, nofollow\". This is a potential security or privacy risk and we recommend adjusting this setting." : "\"{header}\" HTTP-huvudet är felkonfigurerat. Förväntade värden är \"none\" eller \"noindex, nofollow\". Detta är en potentiell säkerhets- eller integritetsrisk och vi rekommenderar att du justerar denna inställning.",
    ...
    "Expiration" : "Upphör",
    "Choose an expiration date" : "Välj ett utgångdatum",
    ...
    "Filename" : "Filnamn",
    "Password" : "Lösenord",
    "Download / View / Upload / Edit" : "Ladda ner / Visa / Ladda upp / Redigera",
    "Recipients can view, download and edit contents." : "Mottagare kan visa, ladda ner och redigera innehåll.",
    "Can not remove required password" : "Kan inte ta bort obligatoriskt lösenord",
    ...
    "An error occurred while sending email" : "Ett fel inträffade när emailet skulle skickas",
    "Email link to person" : "E-posta länk till person",
    "Send copy to self" : "Skicka kopia till dig själv",
    "Send link via email" : "Skicka länk via e-post",
    "Add personal message" : "Lägg till ett personligt meddelande",
    "Sending" : "Skickar",
    ...
    "Email notification was sent!" : "Email notifikation skickades!",
    "Email notification not sent" : "Email notifikation skickades inte",
    "Share details could not be loaded for this item." : "Delningsdetaljer kunde inte laddas för detta objekt.",
    "No users or groups found" : "Inga användare eller grupper funna.",
    ...
    "_Please enter at least {chars} character for suggestions_::_Please enter at least {chars} characters for suggestions_" : ["Please enter at least {chars} character for suggestions","Vänligen ange minst fyra tecken för förslag"],
    "An error occurred. Please try again" : "Ett fel uppstod. Vänligen försök igen",
    "User" : "Användare",
    "Group" : "Grupp",
    "Federated Group" : "Allierad grupp",
    "Guest" : "Gäst",
    "At {server}" : "Vid {server}",
    "Federated" : "Federerad",
    "User and Groups" : "Användare och grupper",
    "Public Links" : "Publika länkar",
    "Sharing is not allowed" : "Delning är inte tillåten",
    "Share with people on other servers using the syntax username@example.com/owncloud" : "Dela med folk på andra owncloud.onlines med följande syntax username@example.com/owncloud",
    ...
    "Share with users or federated users…" : "Dela med användare eller allierade användare...",
    "Could not be shared with the following users: {users}" : "Kunde inte delas med följande användare: {users}",
    "Add multiple users" : "Lägg till flera användare",
    "Error removing share" : "Fel uppstod när delning försökte tas bort",
    "Unknown Share" : "Okänd Delning",
    ...
    "({scope})" : "({scope})",
    "Rename" : "Byt namn",
    "Do you really want to remove the tag \"{tagName}\" and unassign it from all files and folders ?" : "Vill du verkligen ta bort taggen \"{tagName}\" och avmarkera den från alla filer och mappar?",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "Uppdateringen misslyckades. Rapportera detta problem till <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online Community</a>.",
    "The update was successful. There were warnings." : "Uppdateringen lyckades. Det finns varningar.",
    "The update was successful. Redirecting you to owncloud.online now." : "Uppdateringen lyckades. Du omdirigeras nu till OwnCloud.",
    ...
    "Personal note from the sender: \n %s." : "Personligt meddelande ifrån avsändaren: \n%s.",
    "Cheers!" : "Ha de fint!",
    "The application was authorized successfully. You will now get redirected to the requested page, otherwise you can close this window." : "Ansökan godkändes framgångsrikt. Du kommer nu att omdirigeras till den begärda sidan, annars kan du stänga detta fönster.",
    ...
    "Please contact the server administrator if this error reappears multiple times and include the technical details below in your report." : "Vänligen kontakta serveradministratören om detta fel återkommer flera gånger, vänligen inkludera nedanstående tekniska detaljer i din felrapport.",
    "More details can be found in the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">server log</a>." : "Mer detaljer kan hittas i <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">server loggen</a>.",
    ...
    "You took too long to log in, please try again now" : "Du tog för lång tid på dig att logga in, försök igen nu",
    ...
    "Personal note from the sender: <br> %s." : "Personligt meddelande ifrån avsändaren: <br> %s.",
    "This owncloud.online instance is currently in single user mode." : "Denna owncloud.online instans är för närvarande i enanvändarläge",
    ...
    "You are accessing the server through an untrusted domain." : "Du ansluter till servern via en obetrodd domän.",
    "Please contact your administrator. If you are an administrator of this instance, configure the \"trusted_domains\" setting in config/config.php. " : "Var god kontakta din administratör. Om du är en administratör för denna installationen konfigurera inställningen \"trusted_domains\" i config/config.php.",
    "An example configuration is provided in config/config.sample.php or at the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">documentation</a>." : " En exempelkonfiguration finns tillgänglig i config/config.sample.php eller i dokumentationen <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">dokumentation</a>.",
    ...
    "Upgrade needed" : "Uppdatering krävs",
    "It looks like your instance may host many files and/or users. To ensure a smooth upgrade process, please use the command line upgrade command (occ upgrade)." : "Instansen hostar för många filer eller användare. För ett erbjuda en smidig uppgraderingsprocess, snälla använda command line för uppgradering (occ upgrade)",
    "Automatic upgrading is not enabled in config.php. To upgrade your instance, please use the command line updater (occ upgrade)." : "Automatisk uppgradering är inte aktiverad i config.php. För att uppgradera din instans, använd kommandoradsuppdateraren (occ upgrade).",
