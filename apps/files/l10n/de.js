OC.L10N.register(
    ...
    "The server did not report whether \"{file}\" was assembled. Reload the folder later to check whether the file is there." : "Der Server hat nicht gemeldet, ob \"{file}\" zusammengesetzt wurde. Lade den Ordner später neu, um zu prüfen, ob die Datei da ist.",
    ...
    "Directory \"{dir}\" is unavailable, please contact the administrator" : "Das Verzeichnis \"{dir}\" ist nicht verfügbar. Bitte wenden Sie sich an den Administrator",
    ...
    "%1$s was deleted due to automation rule" : "%1$s wurde aufgrund der Automatisierungsregel gelöscht",
