OC.L10N.register(
    "core",
    {
    "Login paused for a moment" : "Најавата е накратко паузирана",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "Од вашата конекција имаше повеќе неуспешни обиди, па накратко ја забавуваме најавата за да ја заштитиме вашата сметка.",
    "You can try again in %s." : "Можете да се обидете повторно за %s.",
    "You can try again now." : "Можете да се обидете повторно сега.",
    "Forgotten your password? Use the reset link instead of trying again." : "Ја заборавивте лозинката? Користете ја врската за ресетирање наместо повторни обиди.",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "Конфигурација на заглавјето за прокси е неточна, или пристапувате до OwnCloud преку доверлив прокси. Ако не пристапувате до owncloud.online од доверлив прокси, ова е безбедносно прашање и може да дозволите напаѓачот да ја измами нивната IP адреса како што е видлива за owncloud.online. Повеќе информации може да најдете во нашата <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\"> документација </ a>.",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "Надградбата беше неуспешна. Ве молиме пријавете го овој проблем на <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online community</a>.",
    "The update was successful. There were warnings." : "Ажурирањето беше успешно. Имаше предупредувања.",
    "The update was successful. Redirecting you to owncloud.online now." : "Надградбата беше успешна. Веднаш ве префрлам на вашиот owncloud.online.",
    ...
    "This owncloud.online instance is currently in single user mode." : "Оваа owncloud.online инстанца е моментално во режим на еден корисник.",
