OC.L10N.register(
    ...
    "Only notification for app updates are available, because the selected update channel for the server itself does not allow notifications." : "Доступны только уведомления для обновлений приложений, так как выбранный канал обновления для самого owncloud.online не поддерживает уведомления.",
    "Online updater has been automatically disabled as you are currently running an Enterprise edition. Please update your instance manually." : "Автоматическое обновление отключено, так как вы используете версию owncloud.online Enterprise. Пожалуйста, обновите вашу owncloud.online вручную."
},
