OC.L10N.register(
    ...
    "Invalid url '%s'. Urls should be set up like 'http://www.example.com' or 'https://www.example.com'" : "Invalid URL '%s'. URLs should be set up like 'http://www.example.com' or 'https://www.example.com'",
    ...
    "Updated log level" : "Updated log level",
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "Official apps are developed by and within the owncloud.online community. They offer functionality central to owncloud.online and are ready for production use.",
    ...
    "The invitation email for this user has been resent" : "The invitation email for this user has been resent",
    "The invitation email for this user could not be resent" : "The invitation email for this user could not be resent",
    ...
    "This app has no minimum server version assigned. This will be an error in version 11 and later." : "This app has no minimum owncloud.online version assigned. This will be an error in owncloud.online 11 and later.",
    "This app has no maximum server version assigned. This will be an error in version 11 and later." : "This app has no maximum owncloud.online version assigned. This will be an error in owncloud.online 11 and later.",
    ...
    "Encryption alone does not guarantee security of the system. Please see the owncloud.online documentation for more information about how the encryption app works, and the supported use cases." : "Encryption alone does not guarantee security of the system. Please see owncloud.online documentation for more information about how the encryption app works, and the supported use cases.",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "You need to migrate your encryption keys from the old encryption (owncloud.online <= 8.0) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'",
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : "You need to migrate your encryption keys from the old encryption (owncloud.online <= 8.0) to the new one.",
    "Start migration" : "Start migration",
    "Two-factor Authentication" : "Two-factor Authentication",
    "This section requires a two-factor authentication app to be installed in owncloud.online" : "This section requires a two-factor authentication app to be installed in owncloud.online",
    "Enforce two-factor authentication" : "Enforce two-factor authentication",
    "Before enforcing the two-factor authentication, check the following requirements:" : "Before enforcing the two-factor authentication, check the following requirements:",
    "At least one two-factor authentication app is installed and enabled in owncloud.online." : "At least one two-factor authentication app is installed and enabled in owncloud.online.",
    "The users can setup at least one two-factor app from the challenge page. Some apps might not be prepared for this" : "The users can setup at least one two-factor app from the challenge page. Some apps might not be prepared for this",
    "The \"twofactor_totp\" app fulfills those requirements, and might be used as a fallback so the users can enter their accounts in order to configure other two-factor authentication apps" : "The \"twofactor_totp\" app fulfills those requirements, and might be used as a fallback so the users can enter their accounts in order to configure other two-factor authentication apps",
    "Enforce two-factor authentication to all the users" : "Enforce two-factor authentication to all the users",
    ...
    "Set default expiration date for federated shares" : "Set default expiration date for federated shares",
    ...
    "Privacy Policy URL" : "Privacy Policy URL",
    "Enterprise license key" : "Enterprise licence key",
    "Enter a new license:" : "Enter a new licence:",
    "Save" : "Save",
    "Remove current license key" : "Remove current licence key",
    ...
    "Test receiver email" : "Test receiver email",
    "Test email settings" : "Test email settings",
    ...
    "Enable manual file locking in the web interface" : "Enable manual file locking in the web interface",
    "Allow users in the following groups to unlock files they have access to:" : "Allow users in the following groups to unlock files they have access to:",
    "Users in these groups can unlock files even if they are not the owner of the lock." : "Users in these groups can unlock files even if they are not the owner of the lock.",
    ...
    "Our imprint conditions:" : "Our imprint conditions:",
    ...
    "Done" : "Done",
    "To access your files through WebDAV, please use the following URL:" : "To access your files through WebDAV, please use the following URL:",
    "Version" : "Version",
