OC.L10N.register(
    ...
    "This app has no minimum server version assigned. This will be an error in version 11 and later." : "Diese App hat keine minimale owncloud.online Version zugeordnet. Dies wird ein Fehler in owncloud.online 11 und später sein.",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "Du musst deine Verschlüsselungsschlüssel von der alten Verschlüsselung (owncloud.online <= 8.0) zur Neuen migrieren. Bitte aktiviere das \"Default Encryption Module\" und rufe 'occ encryption:migrate' auf.",
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : "Du musst deine Verschlüsselungsschlüssel von der alten Verschlüsselung (owncloud.online <= 8.0) zur Neuen migrieren.",
    ...
    "At least one two-factor authentication app is installed and enabled in owncloud.online." : "Mindestens eine Zwei-Faktor-Authentifizierungs App muss in owncloud.online installiert und aktiviert sein.",
    ...
    "Set default expiration date for federated shares" : "Standardmäßiges Ablaufdatum für Federated-Shares",
    ...
    "Test receiver email" : "Test Empfänger E-Mail Adresse",
    "Test email settings" : "E-Mail-Einstellungen testen",
    ...
    "Allow users in the following groups to unlock files they have access to:" : "Erlaube Benutzern der folgenden Gruppen, Dateien zu entsperren, auf die sie Zugriff haben:",
    "Users in these groups can unlock files even if they are not the owner of the lock." : "Benutzer in diesen Gruppen können Dateien entsperren, auch wenn sie nicht der Eigentümer der Datei sind.",
    ...
    "Your database does not run with \"READ COMMITTED\" transaction isolation level. This can cause problems when multiple actions are executed in parallel." : "Die Datenbank wurde nicht mit dem \"READ COMMITTED\" Transaktions Isolation Level eingerichtet. Das kann zu Problemen führen wenn mehrere Aktionen parallel ausgeführt werden.",
