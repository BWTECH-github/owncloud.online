OC.L10N.register(
    ...
    "Enter the server address to add the content to" : "Введите адрес сервера для добавления содержимого",
    "Add" : "Добавить",
    "No compatible server installation found at {remote}" : "На удаленном ресурсе {remote} не установлен owncloud.online версии 7 или выше",
    "Invalid server url" : "Неверный адрес owncloud.online",
    "Share" : "Общий доступ",
    ...
    "These groups will not be available to share with. Members of the group are not restricted in initiating shares and receiving personal shares/invitations. Furthermore they can receive shares addressed to other groups they are members of as usual." : "Эти группы не будут доступны для совместного использования. Члены группы не ограничены в инициировании акций и получении личных акций/приглашений. Кроме того, они могут получать акции, адресованные другим группам, членами которых они являются, как обычно.",
    "Only certain groups are allowed to create public links" : "Только отдельным группам разрешено создавать общедоступные ссылки"
},
