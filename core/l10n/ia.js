OC.L10N.register(
    "core",
    {
    "Login paused for a moment" : "Session pausate pro un momento",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "Il habeva plure tentativas fallite ab tu connexion, dunque nos relenta brevemente le initio de session pro proteger tu conto.",
    "You can try again in %s." : "Tu pote reprobar post %s.",
    "You can try again now." : "Tu pote reprobar ora.",
    "Forgotten your password? Use the reset link instead of trying again." : "Contrasigno oblidate? Usa le ligamine de reinitialisation in loco de reprobar.",
    "_%n second_::_%n seconds_" : ["%n secunda", "%n secundas"],
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "O le configuration del capites del proxy inverse es incorrecte, o tu accede a owncloud.online ab un proxy de confidentia. Si tu non accede a owncloud.online ab un proxy de confidentia, isto es un problema de securitate que pote permitter a un attaccator de falsificar su adresse IP como visibile pro owncloud.online. Ulterior information se trova in nostre <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>.",
    ...
    "Group" : "Gruppo",
    "Share with people on other servers using the syntax username@example.com/owncloud" : "Compartir con personas sur altere owncloud.onlines usante le syntaxe username@example.com/owncloud",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "Le actualisation terminava sin successo. Per favor reporta iste problema al  <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">communitate de owncloud.online</a>.",
    "The update was successful. There were warnings." : "Le actualisation ha succedite, ma il ha avisos.",
    "The update was successful. Redirecting you to owncloud.online now." : "Le actualisation terminava con successo. Le systema te redirige ora a owncloud.online.",
    ...
    "This owncloud.online instance is currently in single user mode." : "Iste installation owncloud.online es actualmente in modo usator singule.",
