OC.L10N.register(
    "core",
    {
    "Login paused for a moment" : "Пријава је накратко паузирана",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "Са ваше везе било је више неуспешних покушаја, па накратко успоравамо пријаву да бисмо заштитили ваш налог.",
    "You can try again in %s." : "До следећег покушаја преостало је: %s.",
    "You can try again now." : "Сада можете покушати поново.",
    "Forgotten your password? Use the reset link instead of trying again." : "Заборавили сте лозинку? Користите везу за ресетовање уместо поновних покушаја.",
    "_%n second_::_%n seconds_" : ["%n секунда", "%n секунде", "%n секунди"],
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "Ažuriranje nije uspelo. Molimo obavestite <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online zajednicu</a>.",
    "The update was successful. There were warnings." : "Ажурирање је успело. Било је упозорења.",
    "The update was successful. Redirecting you to owncloud.online now." : "Ажурирање је успело. Преусмеравам вас на оунКлауд.",
    ...
    "This owncloud.online instance is currently in single user mode." : "Овај оунКлауд тренутно ради у режиму једног корисника.",
