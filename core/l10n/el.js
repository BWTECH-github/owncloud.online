OC.L10N.register(
    ...
    "You have enabled one or more ownCloud Enterprise apps but your installation does not have a valid license yet." : "Έχετε ενεργοποιήσει μία ή περισσότερες εφαρμογές στο ownCloud Enterprise, αλλά η εγκατάστασή σας δεν έχει ακόμη έγκυρη άδεια.",
    ...
    "To try ownCloud Enterprise, just start a 30-day demo and enter the provided license key below." : "Για να δοκιμάσετε το ownCloud Enterprise, απλώς ξεκινήστε μια επίδειξη 30 ημερών και εισαγάγετε παρακάτω το παρεχόμενο κλειδί άδειας χρήσης.",
    "Upgrade to ownCloud Enterprise" : "Αναβάθμιση στο ownCloud Enterprise",
