OC.L10N.register(
    ...
    "Compatibility with Mac NFD encoding (slow)" : "Përputhje me kodim Mac NFD (e ngadaltë)",
    "Sharing cannot be enabled due to the chosen authentication method" : "Ndarja me të tjerët s’mund të aktivizohet, për shkak të metodës së mirëfilltësimit të përzgjedhur",
    ...
    "Couldn't get the information from the remote server: {code} {type}" : "S’u morën dot hollësi nga shërbyesi owncloud.online: {code} {type}",
    ...
    "Some of the configured external mount points are not connected. Please click on the red row(s) for more information" : "Disa nga pikat e jashtme të formësuara të montimit s’janë të lidhura. Për më tepër hollësi, ju lutemi, klikoni në shigjetën(at) e kuqe",
    ...
    "Username as share" : "Emër përdoruesi si emër pjese",
    "<b>Note:</b> " : "<b>Shënim:</b> ",
