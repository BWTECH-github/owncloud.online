OC.L10N.register(
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "Officielt program er udviklet af owncloud.online fællesskabet. Funktionerne spiller en central rolle i owncloud.online og kan bruges i produktionsmiljøer.",
    ...
    "This app has no minimum server version assigned. This will be an error in version 11 and later." : "Denne app har ikke fået tildelt en minimal owncloud.online-version. Dette vil give en fejlmeddelelse i owncloud.online 11 og nyere.",
    "This app has no maximum server version assigned. This will be an error in version 11 and later." : "Denne app har ikke fået tildelt en maximal owncloud.online-version. Dette vil give en fejlmeddelelse i owncloud.online 11 og nyere.",
    ...
    "Encryption alone does not guarantee security of the system. Please see the owncloud.online documentation for more information about how the encryption app works, and the supported use cases." : "Kryptering alene garanterer ikke for systemets sikkerhed. Se venligst owncloud.online dokumentationen for mere information om, hvordan krypterings app fungerer, samt de understøttede brugseksempler.",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "Du skal immigrere dine krypteringsnøgler fra den gamle kryptering (owncloud.online <= 8.0) til den nye af slagsen. Slå venligst \"Standardmodul til kryptering\" til, og kør \"occ encryption:migrate\"",
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : "Du skal immigrere dine krypteringsnøgler fra den gamle kryptering (owncloud.online <= 8.0) til den nye af slagsen.",
