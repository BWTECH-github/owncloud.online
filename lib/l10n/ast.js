OC.L10N.register(
    ...
    "Server version %s or higher is required." : "Necesítase owncloud.online %s o superior.",
    "Server version %s or lower is required." : "Necesítase owncloud.online %s o anterior.",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "Nun pue instalase l'aplicación porque nun ye compatible con esta versión d'owncloud.online.",
    ...
    "%s" : "%s",
    "%s via %s" : "%s via %s",
    "Sharing %s failed, because the backend does not allow shares from type %d" : "Compartir %s falló, por cuenta qu'el backend nun dexa acciones de tipu %d",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "Axuste de la configuración en php.ini va executar de nueves owncloud.online",
