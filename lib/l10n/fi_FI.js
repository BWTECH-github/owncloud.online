OC.L10N.register(
    ...
    "Server version %s or higher is required." : "owncloud.online %s tai uudempi vaaditaan.",
    "Server version %s or lower is required." : "owncloud.online %s tai aiempi vaaditaan.",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "Sovellusta ei voi asentaa, koska se ei ole yhteensopiva käytössä olevan owncloud.online-version kanssa",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "Tämän asetuksen muuttaminen php.ini-tiedostossa saattaa owncloud.onlinein jälleen toimintakykyiseksi",
