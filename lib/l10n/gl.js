OC.L10N.register(
    ...
    "Server version %s or higher is required." : "Requírese owncloud.online %s ou superior.",
    "Server version %s or lower is required." : "Requírese owncloud.online %s ou inferior.",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "Non é posíbel instalar a aplicación por non ser compatíbel  con esta versión do owncloud.online.",
    ...
    "No license key available." : "Non hai unha clave de licenza dispoñíbel.",
    "Invalid license key!" : "Clave de licenza non válida!",
    "Please contact your administrator or %s for a new license key." : "Contacte co administrador ou %s para obter unha nova clave de licenza.",
    "Your Enterprise license key has expired." : "A súa clave de licenza Empresarial caducou.",
    "Enterprise features have been disabled." : "Desactivaronse as funcións de empresa.",
    "Evaluation - expires in %d days." : "Avaliación, caduca en %d días.",
    "Your Enterprise license key is about to expire (days remaining: %d)." : "A súa clave de licenza Empresarial está a piques de caducar (restan %d días).",
    "The registered enterprise license key expires in %d days" : "A clave de licenza empresarial rexistrada caduca en %d días",
    "New Design" : "Novo deseño",
    "Apps" : "Aplicacións",
    "General" : "Xeral",
    ...
    "Can't update %s - it is a directory" : "Non é posíbel actualizar %s: é un directorio",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "Facer este axuste en php.ini fará que owncloud.online volva executarse",
    ...
    "User unknown" : "Usuario descoñecido",
