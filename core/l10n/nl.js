OC.L10N.register(
    ...
    "Image too large" : "Afbeelding te groot",
    ...
    "Download / View / Edit" : "Download / Bekijk / Bewerk",
    ...
    "You have enabled one or more Enterprise apps but your installation does not have a valid license yet." : "U heeft een of meer owncloud.online Enterprise apps ingeschakeld, maar uw installatie heeft nog geen geldige licentie.",
    "A grace period of 24 hours has started to allow you to get going right away. Once the grace period ends, all Enterprise apps will become disabled unless you supply a valid license key." : "Er is een bedenktijd van 24 uur ingegaan, zodat u meteen aan de slag kunt. Zodra de bedenktijd is afgelopen, worden alle Enterprise-apps uitgeschakeld, tenzij u een geldige licentiecode opgeeft.",
    "To try the Enterprise apps, just start a 30-day demo and enter the provided license key below." : "Om owncloud.online Enterprise te proberen, start u gewoon een demo van 30 dagen en voert u de meegeleverde licentiesleutel hieronder in.",
    "Upgrade to Enterprise" : "Upgrade naar owncloud.online Enterprise",
    "Remaining time: {rtime}" : "Resterende tijd: {rtime}",
    "Get your demo key" : "Ontvang uw demo-sleutel",
    "Enter license key" : "Licentiecode invoeren",
    "Set new key" : "Nieuwe sleutel instellen",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "De reverse proxy headerconfiguratie is onjuist, of u hebt toegang tot owncloud.online via een vertrouwde proxy. Als u owncloud.online niet via een vertrouwde proxy benadert, dan levert dan een beveiligingsrisico op, waardoor een aanvaller het IP-adres dat owncloud.online ziet kan spoofen. Meer informatie is te vinden in onze <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentatie</a>.",
    ...
    "You are running in DEBUG mode, this can cause unwanted side effects. Please remove the \"debug\" flag from \"config.php\"." : "U draait in de DEBUG-modus, dit kan ongewenste bijwerkingen veroorzaken. Verwijder a.u.b. de \"debug\"-vlag van \"config.php\".",
    ...
    "The \"{header}\" HTTP header is misconfigured. Expected values are \"none\" or \"noindex, nofollow\". This is a potential security or privacy risk and we recommend adjusting this setting." : "De HTTP-header \"{header}\" is verkeerd geconfigureerd. Verwachte waarden zijn \"geen\" of \"noindex, nofollow\". Dit is een potentieel beveiligings- of privacyrisico en we raden aan deze instelling aan te passen.",
    ...
    "Choose a password - password policy may apply" : "Kies een wachtwoord - wachtwoordbeleid kan van toepassing zijn",
    "Password required" : "Wachtwoord vereist",
    "Link name" : "Naam link",
    "Name" : "Naam",
    "Filename" : "Bestandsnaam",
    "Password" : "Wachtwoord",
    "Download / View / Upload / Edit" : "Downloaden / Bekijken / Uploaden / Bewerken",
    "Recipients can view, download and edit contents." : "Ontvangers kunnen de inhoud bekijken, downloaden en bewerken.",
    "Can not remove required password" : "Kan het vereiste wachtwoord niet verwijderen",
    ...
    "_Please enter at least {chars} character for suggestions_::_Please enter at least {chars} characters for suggestions_" : ["Voer ten minste {chars} teken in voor suggesties","Voer ten minste {chars} tekens in voor suggesties"],
    "An error occurred. Please try again" : "Er trad een fout op. Probeer het opnieuw",
    "User" : "Gebruiker",
    "Group" : "Groep",
    "Federated Group" : "Federatieve Groep",
    "Guest" : "Gast",
    "At {server}" : "Op {server}",
    ...
    "Share with people on other servers using the syntax username@example.com/owncloud" : "Delen met mensen op andere owncloud.onlines via de syntax gebruikersnaam@voorbeeld.org/owncloud",
    "Share with users…" : "Delen met gebruikers...",
    "Share with users, groups or federated users…" : "Delen met gebruikers, groepen of federatieve gebruikers...",
    "Share with users or groups…" : "Delen met gebruikers of groepen...",
    "Share with users or federated users…" : "Delen met gebruikers of federatieve gebruikers...",
    "Could not be shared with the following users: {users}" : "Kan niet worden gedeeld met de volgende gebruikers: {users}",
    "Add multiple users" : "Meerdere gebruikers toevoegen",
    "Error removing share" : "Fout bij verwijderen share",
    "Unknown Share" : "Onbekend Share",
    ...
    "Do you really want to remove the tag \"{tagName}\" and unassign it from all files and folders ?" : "Wil je echt de tag \"{tagName}\" verwijderen en de toewijzing uit alle bestanden en mappen ongedaan maken?",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "De update is niet geslaagd. Meld dit probleem bij de <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online community</a>.",
    "The update was successful. There were warnings." : "De update is geslaagd. Er zijn wel waarschuwingen.",
    "The update was successful. Redirecting you to owncloud.online now." : "De update is geslaagd. U wordt teruggeleid naar uw eigen owncloud.online.",
    ...
    "The application was authorized successfully. You will now get redirected to the requested page, otherwise you can close this window." : "De applicatie is met succes geautoriseerd. U wordt nu doorgestuurd naar de opgevraagde pagina, anders kunt u dit venster sluiten.",
    ...
    "Please specify the port number along with the host name (e.g., localhost:5432)." : "Geef het poortnummer op samen met de hostnaam (bijv. localhost:5432).",
    ...
    "You took too long to log in, please try again now" : "Je hebt er te lang over gedaan om je aan te melden, probeer het nu opnieuw",
    ...
    "Personal note from the sender: <br> %s." : "Persoonlijke notitie van de afzender: <br> %s.",
    "This owncloud.online instance is currently in single user mode." : "Deze owncloud.online werkt momenteel in enkele gebruiker modus.",
    ...
    "You are accessing the server through an untrusted domain." : "U probeert toegang tot de server te krijgen via een niet-vertrouwd domein.",
    "Please contact your administrator. If you are an administrator of this instance, configure the \"trusted_domains\" setting in config/config.php. " : "Neem contact op met uw beheerder. Als je een beheerder van dit exemplaar bent, configureer dan de instelling \"trusted_domains\" in config/config.php.",
    "An example configuration is provided in config/config.sample.php or at the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">documentation</a>." : "Een voorbeeld configuratie is te vinden in config/config.sample.php of bij de <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">documentatie</a>.",
    ...
    "Automatic upgrading is not enabled in config.php. To upgrade your instance, please use the command line updater (occ upgrade)." : "Automatisch upgraden is niet ingeschakeld in config.php. Als u uw exemplaar wilt upgraden, gebruikt u de command line updater (occ upgrade).",
