OC.L10N.register(
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "反向代理伺服器標頭配置不正確或者您正從一個受信任的代理伺服器訪問owncloud.online，如果您不是從受信任的代理伺服器訪問owncloud.online，表示這是一個安全性問題，攻擊者可利用IP詐騙存取owncloud.online。更多資訊請至我們的<a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">說明文件</a>。",
    ...
    "The update was successful. Redirecting you to owncloud.online now." : "更新成功",
    ...
    "This owncloud.online instance is currently in single user mode." : "這個 owncloud.online 伺服器目前運作於單一使用者模式",
