OC.L10N.register(
    ...
    "Server version %s or higher is required." : "Требуется owncloud.online %s или выше.",
    "Server version %s or lower is required." : "Требуется owncloud.online версии %s или ниже.",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "Приложение невозможно установить. Не совместимо с текущей версией owncloud.online.",
    ...
    "No license key available." : "Лицензионный ключе недоступен.",
    "Invalid license key!" : "Неправильный лицензионный ключ!",
    "Please contact your administrator or %s for a new license key." : "Пожалуйста, свяжитесь с вашим администратором, или %s, чтобы получить новый лицензионный ключ.",
    "Your Enterprise license key has expired." : "Ваш лицензионный ключ для Enterprise устарел.",
    "Enterprise features have been disabled." : "Возможности Enterprise были отключены.",
    "Evaluation - expires today." : "Пробный период — истекает сегодня.",
    "Evaluation - expires in %d days." : "Пробный период истекает через %d дней.",
    "Your Enterprise license key is about to expire (days remaining: %d)." : "Ваш лицензионный ключ для Enterprise скоро устареет (осталось дней: %d).",
    "The registered enterprise license key expires in %d days" : "Зарегистрированный лицензионный ключ для Enterprise устареет через %d days",
    ...
    "%s enter the database name or connection string." : "1%s введите название базы данных или строку подключения",
    ...
    "%s is not supported and %s will not work properly on this platform. Use it at your own risk! " : "%s не поддерживается и %s не будет работать правильно на этой платформе. Используйте на свой страх и риск! ",
    ...
    "Can't create or write into the apps-external directory %s" : "Не удалось создать или записать в каталоге внешних приложений %s",
    "Can't update %s - it is a directory" : "Невозможно обновить %s - это каталог",
    "Can't update %s" : "Не получается обновить %s",
    "Invalid Federated Cloud ID" : "Неверный ID в объединении облачных хранилищ.",
    "Internal mail notification for shared files is not allowed" : "Внутреннее уведомление почтой для совместного доступа к файлам не разрешено",
    "%s shared »%s« with you" : "%s поделился »%s« с вами",
    "Public link mail notification is not allowed" : "Почтовые уведомления для общедоступных ссылок не разрешены",
    "%s" : "%s",
    "%s via %s" : "%s через %s",
    "Sharing %s failed, because the backend does not allow shares from type %d" : "Не удалось предоставить общий доступ к %s,  так как бэкенд не разрешает общий доступ для типа %d",
    ...
    "Sharing %s failed, because this item is already shared with %s" : "Не удалось поделиться %s, так как элемент находится в общем доступе у %s",
    ...
    "Sharing %s failed, because the group %s does not exist" : "Не удалось поделиться %s, файл %sне существует",
    ...
    "Sharing %s failed, could not find %s, check spelling and server availability." : "Не удалось предоставить доступ к %s, не удалось найти %s, проверьте написание и доступность сервера.",
    ...
    "Sharing backend %s must implement the interface OCP\\Share_Backend" : "Общий бэкэнд %s должен реализовать интерфейс OCP\\Share_Backend",
    ...
    "Invalid permissions" : "Недопустимые права",
    "Cannot remove all permissions" : "Не могу удалить все права",
    "Cannot set the requested share permissions for %s" : "Не удалось получить запрошенные права доступа для %s",
    "Cannot set the requested share attributes for %s" : "Не удалось установить запрошенные атрибуты общего доступа для %s",
    ...
    "Only the following characters are allowed in a username: \"a-z\", \"A-Z\", \"0-9\", and \"+_.@-'\"" : "В имени пользователя допустимы только следующие символы: «a—z», «A—Z», «0—9», и «+_.@-'»",
    ...
    "The username must be at least 3 characters long" : "Имя пользователя должно быть не менее 3 символов в длину",
    "The username can not be longer than 64 characters" : "Имя пользователя не может быть длиннее 64 символов",
    "The special username %s is not allowed" : "Специальное имя пользователя %s не допустимо",
    ...
    "Access to this resource or one of its sub-items has been denied." : "Запрещён доступ к этому ресурсу или к одному из его подчинённых элементов.",
    "File cannot be downloaded" : "Скачать файл не удалось",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "Установка этого параметра в php.ini позволит запуститься owncloud.online снова.",
