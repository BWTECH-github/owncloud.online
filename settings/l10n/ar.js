OC.L10N.register(
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "يتم تطوير التطبيقات الرسمية من خلال مجتمع owncloud.online، كما أنها توفر وظيفة مركزية لـ owncloud.online، وهي جاهزة لاستخدام الإنتاج.",
    ...
    "This app has no minimum server version assigned. This will be an error in version 11 and later." : "لا يحتوي هذا التطبيق على حد أدنى لإصدار owncloud.online المخصص. سيكون هذا خطأ في owncloud.online 11 والإصدارات الأحدث.",
    "This app has no maximum server version assigned. This will be an error in version 11 and later." : "لا يحتوي هذا التطبيق على حد أقصى لإصدار owncloud.online المخصص. سيكون هذا خطأ في owncloud.online 11 والإصدارات الأحدث.",
    ...
    "Encryption alone does not guarantee security of the system. Please see the owncloud.online documentation for more information about how the encryption app works, and the supported use cases." : "لا يضمن التشفير وحده أمان النظام؛ لذلك يُرجى الاطلاع على وثائق owncloud.online لمزيد من المعلومات حول كيفية عمل تطبيق التشفير وحالات الاستخدام المدعومة.",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : "تحتاج إلى ترحيل مفاتيح التشفير من التشفير القديم (owncloud.online <= 8.0) إلى الجديد.",
