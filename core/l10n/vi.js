OC.L10N.register(
    "core",
    {
    "Login paused for a moment" : "Đăng nhập tạm dừng trong giây lát",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "Đã có nhiều lần đăng nhập thất bại từ kết nối của bạn, vì vậy chúng tôi tạm thời làm chậm việc đăng nhập để bảo vệ tài khoản của bạn.",
    "You can try again in %s." : "Bạn có thể thử lại sau %s.",
    "You can try again now." : "Bây giờ bạn có thể thử lại.",
    "Forgotten your password? Use the reset link instead of trying again." : "Quên mật khẩu? Hãy dùng liên kết đặt lại thay vì thử lại.",
    "_%n second_::_%n seconds_" : ["%n giây"],
    "_%n minute_::_%n minutes_" : ["%n phút"],
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "Cập nhật không thành công . Vui lòng thông báo đến <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\"> Cộng đồng owncloud.online </a>.",
    "The update was successful. Redirecting you to owncloud.online now." : "Cập nhật thành công .Hệ thống sẽ đưa bạn tới owncloud.online.",
    "Personal" : "Cá nhân",
    "Users" : "Người dùng",
    "Apps" : "Ứng dụng",
    "Admin" : "Quản trị",
    ...
    "This owncloud.online instance is currently in single user mode." : "OwnCloud trong trường hợp này đang ở chế độ người dùng duy nhất.",
