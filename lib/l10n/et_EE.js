OC.L10N.register(
    ...
    "Server version %s or higher is required." : "owncloud.online %s või uuem on nõutav.",
    "Server version %s or lower is required." : "owncloud.online %s või vanem on nõutav.",
    "Unknown filetype" : "Tundmatu failitüüp",
    "Invalid image" : "Vigane pilt",
    "Avatar image is not square" : "Avatari pilt pole ruudukujuline",
    "today" : "täna",
    "yesterday" : "eile",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "Rakendit ei saa paigaldada, kuna see pole ühilduv selle owncloud.online versiooniga.",
    ...
    "No license key available." : "Ühtegi litsentsivõtit pole saadaval.",
    "Invalid license key!" : "Vigane litsentsivõti!",
    "Apps" : "Rakendused",
    "General" : "Üldine",
    ...
    "Can't update %s" : "Ei saa uuendada %s",
    ...
    "Invalid permissions" : "Vigased õigused",
    "Cannot remove all permissions" : "Kõiki õigusi ei saa eemaldada",
