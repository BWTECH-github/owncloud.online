OC.L10N.register(
    ...
    "Add" : "Додади",
    "No compatible server installation found at {remote}" : "Не е пронајдена owncloud.online инсталација (верзија 7 или поголема) на {remote}",
    "Invalid server url" : "Неисправен owncloud.online url",
    "Share" : "Сподели",
