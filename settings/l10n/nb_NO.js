OC.L10N.register(
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "Offisielle apper utvikles av og innenfor owncloud.online-fellesskapet. De tilbyr funksjonalitet som er sentral for owncloud.online og er forberedt for produksjonsbruk.",
    ...
    "This app has no minimum server version assigned. This will be an error in version 11 and later." : "Denne appen har ingen minimumsversjon av owncloud.online. Dette vil være en feil i owncloud.online 11 og senere.",
    "This app has no maximum server version assigned. This will be an error in version 11 and later." : "Denne appen har ingen maksimumsversjon av owncloud.online. Dette vil være en feil i owncloud.online 11 og senere.",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "Du må migrere krypteringsnøklene din fra den gamle krypteringen (owncloud.online <= 8.0) til den nye. Vennligst aktiver \"Standard krypteringsmodul\" og kjør 'occ encryption:migrate'",
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : "Du må migrere krypteringsnøklene din fra den gamle krypteringen (owncloud.online <= 8.0) til den nye.",
