OC.L10N.register(
    "core",
    {
    "Login paused for a moment" : "O inicio de sesión está en pausa un momento",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "Houbo varios intentos errados desde a súa conexión, polo que ralentizamos brevemente o inicio de sesión para protexer a súa conta.",
    "You can try again in %s." : "Pode tentalo de novo en %s.",
    "You can try again now." : "Pode tentalo de novo agora.",
    "Forgotten your password? Use the reset link instead of trying again." : "Esqueceu o contrasinal? Use a ligazón de restabelecemento no canto de tentalo de novo.",
    "_%n second_::_%n seconds_" : ["%n segundo", "%n segundos"],
    ...
    "You have enabled one or more Enterprise apps but your installation does not have a valid license yet." : "Activou unha ou varias aplicacións owncloud.online Empresarial mais a súa instalación aínda non ten unha licenza válida.",
    ...
    "To try the Enterprise apps, just start a 30-day demo and enter the provided license key below." : "Para probar owncloud.online Empresarial, só ten que iniciar unha demostración de 30 días e escriba a clave de licenza indicada a seguir.",
    "Upgrade to Enterprise" : "Anovar a owncloud.online Empresarial",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "A configuración de cabeceiras do proxy inverso é incorrecta, ou vostede está accedendo ao owncloud.online dende un proxy no que confía. Se non, isto é un problema de seguridade que pode permitir a un atacante disfrazar o seu enderezo IP como visíbel para o owncloud.online. Pode atopar máis información na nosa <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentación</a>.",
    ...
    "Recipients can view, download and edit contents." : "Os destinatarios poden ver, descargar e editar contido.",
    ...
    "Share with people on other servers using the syntax username@example.com/owncloud" : "Comparta con outra xente ou con outros owncloud.onlines empregando a sintaxe «nomeusuario@exemplo.com/ouwncloud»",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "A actualización non foi satisfactoria, informe deste problema á  <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">comunidade de owncloud.online</a>.",
    "The update was successful. There were warnings." : "A actualización realizouse correctamente. Houbo algún aviso.",
    "The update was successful. Redirecting you to owncloud.online now." : "A actualización realizouse correctamente. Redirixíndoo agora á owncloud.online.",
    ...
    "This owncloud.online instance is currently in single user mode." : "Esta instancia do owncloud.online está actualmente en modo de usuario único.",
