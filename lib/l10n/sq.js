OC.L10N.register(
    ...
    "This can usually be fixed by giving the webserver write access to the config directory" : "Zakonisht kjo mund të ndreqet duke i akorduar shërbyesit të drejta shkrimi mbi drejtorinë e formësimeve",
    "See %s" : "Shihni %s",
    "This can usually be fixed by %sgiving the webserver write access to the config directory%s." : "Zakonisht kjo mund të ndreqet duke %si akorduar shërbyesit të drejta shkrimi mbi drejtorinë e formësimeve%s.",
    ...
    "PHP %s or higher is required." : "Lypset PHP %s, ose më sipër.",
    ...
    "The library %s is not available." : "Biblioteka %s s’është e passhme.",
    ...
    "Server version %s or higher is required." : "Lypset owncloud.online %s ose më sipër.",
    "Server version %s or lower is required." : "Lypset owncloud.online %s ose më poshtë.",
    "%s is member of a group not allowed to access through this login mechanism" : "%s është anëtar i një grupi jo të lejuar të hyjë përmes këtij mekanizmi hyrjesh",
    "%s isn't member of a group allowed to access through this login mechanism" : "%s s’është anëtar i një grupi të lejuar të hyjë përmes këtij mekanizmi hyrjesh",
    "A login policy has blocked the login" : "Hyrjen e ka bllokuar një rregull mbi hyrjet",
    ...
    "4-byte characters are not supported in file names" : "Në emra kartelash s’mbulohen shenjat 4-bajtshe",
    ...
    "Failed to open archive when installing app" : "S’u arrit të hapet arkiv teksa instalohej aplikacioni",
    "App does not provide an info.xml file" : "Aplikacioni s’ofron kartelë të vlefshme .xml",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "Aplikacioni s’mund të instalohet, ngaqë s’është i përputhshëm me këtë version të owncloud.online-it",
    ...
    "No license key available." : "S’ka kyç licence.",
    "Invalid license key!" : "Kyç licence i pavlefshëm!",
    "Please contact your administrator or %s for a new license key." : "Ju lutemi, lidhuni me përgjegjësin tuaj ose %s për një kyç të ri licence.",
    "Your Enterprise license key has expired." : "Kyçi juaj i licencës për Ndërmarrje ka skaduar.",
    "Enterprise features have been disabled." : "Veçoritë për Ndërmarrje janë çaktivizuar.",
    "Evaluation - expires today." : "Vlerësim - skadon sot.",
    "Evaluation - expires in %d days." : "Vlerësim - skadon për %d ditë.",
    "Your Enterprise license key is about to expire (days remaining: %d)." : "Kyçi juaj i licencës për Ndërmarrje është duke skaduar (ditë akoma: %d).",
    "The registered enterprise license key expires in %d days" : "Kyçi i regjistruar për licencë ndërmarrjeje skadon për %d ditë",
    "New Design" : "Dizajn i Ri",
    "Apps" : "Aplikacione",
    ...
    "%s enter the database name or connection string." : "%s jepni emrin e bazës së të dhënave ose varg lidhjeje.",
    ...
    "Can't create or write into the data directory %s" : "S’krijohet dot drejtoria e të dhënave %s, ose shkruhet dot në të",
    "Can't create or write into the apps-external directory %s" : "S’krijohet dot drejtoria e aplikacioneve të jashtme %s, ose s’shkruhet dot në të",
    "Can't update %s - it is a directory" : "S’përditësohet dot %s - është drejtori",
    "Can't update %s" : "S’përditësohet dot %s",
    "Invalid Federated Cloud ID" : "ID e pavlefshme Reje të Federuar",
    "Internal mail notification for shared files is not allowed" : "Për kartela të ndara me të tjerët nuk lejohet njoftim i brendshëm me email",
    "%s shared »%s« with you" : "%s ndau me ju »%s«",
    "Public link mail notification is not allowed" : "Nuk lejohen njoftime me email për lidhje publike",
    "%s" : "%s",
    "%s via %s" : "%s përmes %s",
    "Sharing %s failed, because the backend does not allow shares from type %d" : "Ndarja me të tjerët e %s dështoi, ngaqë mekanizmi i pasmë nuk lejon pjesë të llojit %d",
    ...
    "Not allowed to create a federated share with the same user" : "S’ka leje të krijojë një pjesë të federuar me të njëjtin përdorues",
    "Sharing %s failed, could not find %s, check spelling and server availability." : "Ndarja me të tjerët e %s dështoi, s’u gjet dot %s, kontrollori i drejtshkrimit dhe shërbyesi në punë.",
    "Share type %s is not valid for %s" : "Lloji i pjesës %s s’është i vlefshëm për %s",
    ...
    "Cannot set expiration date. Shares cannot expire later than %s after they have been shared" : "S’caktohet dot data e skadimit. Pjesët s’mund të skadojnë më vonë se %s pasi të jenë ofruar",
    ...
    "Cannot clear expiration date. Shares are required to have an expiration date." : "S’hiqet dot data e skadimit. Pjesët lypset të kenë një datë skadimi.",
    ...
    "Sharing %s failed, because resharing is not allowed" : "Ndarja e %s me të tjerët dështoi, ngaqë s’lejohen rindarje",
    ...
    "Invalid permissions" : "Leje të pavlefshme",
    "Cannot remove all permissions" : "S’mund të hiqen krejt lejet",
    "Cannot set the requested share permissions for %s" : "S’caktohen dot lejet e domosdoshme pjesësh për %s",
    "Cannot set the requested share attributes for %s" : "S’caktohen dot atributet e domosdoshme pjesësh për %s",
    ...
    "The special username %s is not allowed" : "Emri special i përdoruesit %s nuk lejohet",
    ...
    "Settings" : "Rregullime",
    "Users" : "Përdorues",
    "App \"%s\" cannot be installed because the following dependencies are not fulfilled: %s" : "Aplikacioni “%s” s’instalohet dot, ngaqë s’plotësohen varësitë vijuese: %s.",
    ...
    "File cannot be downloaded" : "Kartela s’shkarkohet dot",
    ...
    "This can usually be fixed by <a href=\"%s\" target=\"_blank\" rel=\"noreferrer\">giving the webserver write access to the root directory</a>." : "Zakonisht kjo mund të ndreqet duke <a href=\"%s\" target=\"_blank\" rel=\"noreferrer\">i akorduar shërbyesit të drejta shkrimi mbi drejtorinë rrënjë</a>.",
    "Permissions can usually be fixed by %sgiving the webserver write access to the root directory%s." : "Zakonisht lejet mund të ndreqen duke %si akorduar shërbyesit të drejta shkrimi mbi drejtorinë rrënjë%s.",
    "Setting locale to %s failed" : "Caktimi i gjuhës si %s dështoi",
    "Please install one of these locales on your system and restart your webserver." : "Ju lutemi, instaloni te sistemi juaj një prej këtyre vendoreve dhe rinisni shërbyesin tuaj.",
    ...
    "PHP setting \"%s\" is not set to \"%s\"." : "Parametri PHP “%s” s’është vënë si “%s”.",
    "Adjusting this setting in php.ini will make owncloud.online run again" : "Saktësimi i këtij rregullimi te php.ini do të bëjë që owncloud.online-i të punojë sërish",
    ...
    "To fix this issue update your libxml2 version and restart your web server." : "Për të ndrequr këtë problem, përditësoni libxml2 dhe rinisni shërbyesin tuaj.",
    "PHP is apparently set up to strip inline doc blocks. This will make several core apps inaccessible." : "Me sa duket, PHP-ja është ujdisur që të heqë blloqe të brendshëm dokumentimi. Kjo do t’i nxjerrë nga funksionimi disa aplikacione bazë.",
    ...
    "Please ask your server administrator to restart the web server." : "Ju lutemi, kërkojini përgjegjësit të shërbyesit tuaj të rinisë shërbyesin.",
    "PostgreSQL >= 9 required" : "Lypset PostgreSQL >= 9",
    "Please upgrade your database version" : "Ju lutemi, përmirësoni versionin e bazës tuaj të të dhënave",
    ...
    "Your Data directory is readable by other users" : "Drejtoria juaj “Të dhëna” është e lexueshme nga përdorues të tjerë",
    "Your Data directory must be an absolute path" : "Drejtoria juaj “Të dhëna” duhet të përfaqësohet nga një shteg absolut",
    "Check the value of \"datadirectory\" in your configuration" : "Kontrolloni vlerën e “datadirectory” te formësimi juaj",
    "Your Data directory  is invalid" : "Drejtoria juaj “Të dhëna” është e pavlefshme",
