OC.L10N.register(
    ...
    "Server version %s or higher is required." : "需要owncloud.online %s 或更高版本",
    "Server version %s or lower is required." : "需要owncloud.online %s 或更低版本",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "無法安裝應用程式因為它和此版本的 owncloud.online 不相容。",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "調整php.ini裡的這項設定會讓owncloud.online再次運行",
