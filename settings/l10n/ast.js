OC.L10N.register(
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "Les aplicaciones oficiales desendolquenles la comunidá y dientro d'owncloud.online. Ufierten una funcionalidá perimportante pa owncloud.online y tán llistos pal so usu en producción.",
    ...
    "This app has no minimum server version assigned. This will be an error in version 11 and later." : "Esta aplicación nun tien nenguna versión mínima owncloud.online asignada. Esti va ser un fallu en owncloud.online 11 y posteriores.",
    "This app has no maximum server version assigned. This will be an error in version 11 and later." : "Esta aplicación nun tien nenguna versión másica owncloud.online asignada. Esti va ser un fallu en owncloud.online 11 y posteriores.",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "Ye necesariu migrar les tos claves de cifráu de la vieya encriptación  (owncloud.online <= 8.0) pa la nueva. Por favor, activa'l \"Módulu de cifráu por defectu\" y executa  'occ encryption:migrate'",
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : "Ye necesariu migrar les tos claves de cifráu de la vieya encriptación (owncloud.online <= 8.0) pa la nueva.",
