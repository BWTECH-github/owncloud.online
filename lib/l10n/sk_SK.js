OC.L10N.register(
    ...
    "Server version %s or higher is required." : "Požadovaná verzia owncloud.onlineu %s alebo vyššia.",
    "Server version %s or lower is required." : "Požadovaná verzia owncloud.onlineu %s alebo nižšia.",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "Aplikácia nemôže byť nainštalovaná pre nekompatibilitu z touto verziou owncloud.onlineu",
    ...
    "%s via %s" : "%s cez %s",
    "Sharing %s failed, because the backend does not allow shares from type %d" : "Zdieľanie %s zlyhalo, pretože backend nepodporuje typ zdieľania %d",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "Zmenou tejto voľby v php.ini znovu uvediete váš owncloud.online do prevádzky",
