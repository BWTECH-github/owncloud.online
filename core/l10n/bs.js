OC.L10N.register(
    ...
    "Forgotten your password? Use the reset link instead of trying again." : "Zaboravili ste lozinku? Koristite link za resetovanje umjesto ponovnog pokušavanja.",
    ...
    "This server has no working Internet connection. This means that some of the features like mounting external storage, notifications about updates or installation of third-party apps will not work. Accessing files remotely and sending of notification emails might not work, either. We suggest to enable Internet connection for this server if you want to have all features." : "Ovaj server nema ispravnu internetsku vezu. To znači da neke funkcije poput postavljanja vanjske memorije, obavijesti o ažuriranjima ili instalacije aplikacija trećih strana neće raditi. Daljinski pristup datotekama i slanje e -mailova s obavijestima možda neće funkcionirati. Predlažemo da omogućite internetsku vezu za ovaj poslužitelj ako želite imati sve mogućnosti.",
    ...
    "_download %n file_::_download %n files_" : ["preuzmite %n datoteku","preuzmite %n datoteka","preuzmite %n datoteka"],
    "Please reload the page." : "Molim, ponovno učitajte stranicu",
    "The update was successful. Redirecting you to owncloud.online now." : "Ažuriranje je uspjelo. Preusmjeravam vas na owncloud.online.",
    "Personal" : "Osobno",
    "Users" : "Korisnici",
    "Apps" : "Aplikacije",
    "Admin" : "Admin",
    ...
    "This owncloud.online instance is currently in single user mode." : "Ova owncloud.online instanca je trenutno u jednokorisničkom načinu rada.",
