OC.L10N.register(
    "core",
    {
    "Login paused for a moment" : "ورود برای لحظه‌ای متوقف شده است",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "چند تلاش ناموفق از اتصال شما انجام شده است، بنابراین برای محافظت از حساب شما، ورود را برای مدت کوتاهی کند می‌کنیم.",
    "You can try again in %s." : "می‌توانید پس از %s دوباره تلاش کنید.",
    "You can try again now." : "اکنون می‌توانید دوباره تلاش کنید.",
    "Forgotten your password? Use the reset link instead of trying again." : "رمز عبور را فراموش کرده‌اید؟ به جای تلاش دوباره از پیوند بازنشانی استفاده کنید.",
    "_%n second_::_%n seconds_" : ["%n ثانیه", "%n ثانیه"],
    ...
    "You have enabled one or more Enterprise apps but your installation does not have a valid license yet." : "شما یک یا چند برنامه سازمانی owncloud.online را فعال کرده اید اما نصب شما هنوز مجوز معتبری ندارد .",
    ...
    "To try the Enterprise apps, just start a 30-day demo and enter the provided license key below." : "برای امتحان پروژه owncloud.online، فقط یک نسخه آزمایشی 30 روزه را شروع کنید و کلید مجوز ارائه شده را در زیر وارد کنید.",
    "Upgrade to Enterprise" : "به پروژه owncloud.online آپلود کن",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "پیکربندی سرفصل های پروکسی معکوس نادرست است، یا از یک پروکسی قابل اعتماد به owncloud.online دسترسی دارید. اگر از طریق یک پروکسی قابل اعتماد به owncloud.online دسترسی ندارید، این یک مشکل امنیتی است و می تواند به مهاجم اجازه دهد آدرس IP خود را به عنوان قابل مشاهده برای owncloud.online جعل کند. اطلاعات بیشتر را می توان در <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">اسناد </a>ما یافت.",
    ...
    "Share with people on other servers using the syntax username@example.com/owncloud" : "اشتراک‌گذاری با دیگر افراد بر روی owncloud.onlines بصورت username@example.com/owncloud",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "به روز رسانی ناموفق بود. لطفا این خطا را به  <a href=\"https://github.com/owncloud/core/issues\" target=\"_blank\">جامعه ی OwnCloud</a> گزارش نمایید.",
    "The update was successful. There were warnings." : "بروزرسانی با موفقیت انجام شد، اخطارهایی وجود دارد.",
    "The update was successful. Redirecting you to owncloud.online now." : "به روزرسانی موفقیت آمیز بود. در حال انتقال شما به OwnCloud.",
    ...
    "This owncloud.online instance is currently in single user mode." : "این نمونه owncloud.online اکنون در وضعیت تک کاربر است.",
