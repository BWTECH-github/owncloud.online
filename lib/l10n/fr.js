OC.L10N.register(
    ...
    "Server version %s or higher is required." : "owncloud.online %s ou supérieur est requis.",
    "Server version %s or lower is required." : "owncloud.online %s ou inférieur est requis.",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "L'application ne peut être installée car elle n'est pas compatible avec cette version de owncloud.online",
    ...
    "No license key available." : "Aucune clé de licence disponible",
    "Invalid license key!" : "Clé de licence non valide",
    "Please contact your administrator or %s for a new license key." : "Veuillez contacter votre administrateur ou %s pour une nouvelle clé de licence.",
    "Your Enterprise license key has expired." : "Votre clé de licence \"Entreprise\" est expirée.",
    "Evaluation - expires in %d days." : "L'évaluation prend fin dans %d jours.",
    "Your Enterprise license key is about to expire (days remaining: %d)." : "Votre clé de licence \"Entreprise\" va bientôt expirer (jours restants : %d).",
    "The registered enterprise license key expires in %d days" : "La clé de licence 3entreprise\" expire dans %d jours",
    "Apps" : "Applications",
    "General" : "Généraux",
    "Storage" : "Stockage",
    "Security" : "Sécurité",
    ...
    "Workflows & Tags" : "Flux et étiquettes",
    "Sharing" : "Partage",
    "Search" : "Rechercher",
    ...
    "%s is not supported and %s will not work properly on this platform. Use it at your own risk! " : "%sn'est pas supporté et %sne fonctionnera pas correctement sur cette plateforme. Utilisez le à vos propres risques!",
    ...
    "Can't update %s" : "Impossible de mettre à jour %s",
    "Invalid Federated Cloud ID" : "ID Federated Cloud incorrect",
    "%s shared »%s« with you" : "%s a partagé «%s» avec vous",
    "%s" : "%s",
    "%s via %s" : "%s via %s",
    "Sharing %s failed, because the backend does not allow shares from type %d" : "Le partage de %s a échoué car l’infrastructure n'autorise pas les partages de type %d",
    ...
    "Sharing %s failed, could not find %s, check spelling and server availability." : "Le partage de %s a échoué, impossible de trouver %s. Veuillez vérifier l'orthographe ainsi que la disponibilité du serveur.",
    ...
    "The username can not be longer than 64 characters" : "Le nom d'utilisateur ne peut pas dépasser 64 caractères",
    ...
    "File cannot be downloaded" : "Le fichier ne peut pas être téléchargé",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "Ajuster ce paramètre dans php.ini permettra à owncloud.online de fonctionner à nouveau",
