OC.L10N.register(
    ...
    "Server version %s or higher is required." : "owncloud.online %s jest w wersji nowszej niż wymagana.",
    "Server version %s or lower is required." : "owncloud.online %s jest w wersji starszej niż wymagana.",
    "Unknown filetype" : "Nieznany typ pliku",
    "Invalid image" : "Błędne zdjęcie",
    "Avatar image is not square" : "Obrazek awatara nie jest kwadratowy",
    "today" : "dziś",
    "yesterday" : "wczoraj",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "Aplikacja nie może zostać zainstalowana ponieważ jest niekompatybilna z tą wersja owncloud.online",
