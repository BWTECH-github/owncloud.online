OC.L10N.register(
    ...
    "Server version %s or higher is required." : "owncloud.online 버전 %s 이상이 필요합니다.",
    "Server version %s or lower is required." : "owncloud.online %s 이하가 필요합니다.",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "현재 owncloud.online 버전과 호환되지 않기 때문에 앱을 설치할 수 없습니다",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "php.ini에서 이 설정을 변경하면 owncloud.online가 다시 실행됩니다",
