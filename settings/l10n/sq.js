OC.L10N.register(
    ...
    "Unable to change display name" : "S’arrihet të ndryshohet emri i shfaqur",
    ...
    "Official apps are developed by and within the owncloud.online project. They offer functionality central to owncloud.online and are ready for production use." : "Aplikacionet zyrtare ndërtohen brenda bashkësisë owncloud.online. Ato ofrojnë funksione qendrore për owncloud.online dhe janë gati për t’u përdorur në prodhim.",
    ...
    "The invitation email for this user has been resent" : "Email-i ftesë për këtë përdorues u ridërgua",
    "The invitation email for this user could not be resent" : "Email-i ftesë për këtë përdorues s’u ridërgua dot",
    ...
    "This app has no minimum server version assigned. This will be an error in version 11 and later." : "Ky aplikacion nuk ka të përcaktuar version minimum për owncloud.online-in. Kjo do të përbëjë një gabim për owncloud.online 11 dhe të mëvonshëm.",
    "This app has no maximum server version assigned. This will be an error in version 11 and later." : "Ky aplikacion nuk ka të përcaktuar version maksimum për owncloud.online-in. Kjo do të përbëjë një gabim për owncloud.online 11 dhe të mëvonshëm.",
    ...
    "Last cron job execution: %s. Something seems wrong." : "Përmbushja e fundit e aktit cron: %s. Duket se diçka nuk shkon.",
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "Lypset të migroni kyçet tuaj të fshehtëzimit nga fshehtëzimi i vjetër (owncloud.online <= 8.0) te i riu. Ju lutemi, aktivizoni “Modul parazgjedhje fshehtëzimesh” dhe ekzekutoni “occ encryption:migrate”",
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one." : "Lypset të migroni kyçet tuaj të fshehtëzimit nga fshehtëzimi i vjetër (owncloud.online <= 8.0) te i riu.",
    "Start migration" : "Fillo migrimin",
    "Two-factor Authentication" : "Mirëfilltësim Dyfaktorësh",
    "This section requires a two-factor authentication app to be installed in owncloud.online" : "Kjo ndarje lyp të instaluar në owncloud.online një aplikacion mirëfilltësimi dyfaktorësh",
    ...
    "At least one two-factor authentication app is installed and enabled in owncloud.online." : "Në owncloud.online të jetë instaluar dhe aktivizuar të paktën një aplikacion mirëfilltësimi dyfaktorësh.",
    ...
    "Exclude the following groups from enforcing two-factor authentication" : "Përjashto nga zbatimi i detyruar i mirëfilltësimit dyfaktorësh grupet vijuese",
    "Note: Users in these groups can use two-factor authentication on their own" : "Shënim: Përdoruesit në këto grupe mund të përdorin mirëfilltësim dyfaktorësh të tyrin",
    ...
    "Set default expiration date for user shares" : "Caktoni datë parazgjedhje skadimesh për pjesë përdoruesish",
    "Set default expiration date for group shares" : "Caktoni datë parazgjedhje skadimesh për pjesë grupesh",
    "Set default expiration date for federated shares" : "Caktoni datë parazgjedhje skadimi për pjesë të federuara",
    ...
    "These groups will still be able to receive shares, but not to initiate them." : "Këto grupe prapë do të jenë në gjendje të marrin pjesë nga të tjerët, por jo të fillojnë të tilla.",
    "Allow username autocompletion in share dialog. If this is disabled the full username needs to be entered." : "Lejo vetëplotësim emrash përdoruesish te dialogu i ndarjes me të tjerët. Nëse kjo është e çaktivizuar, do të duhet të jepen emra përdoruesish.",
    ...
    "Everything (fatal issues, errors, warnings, info, debug)" : "Gjithçka (probleme fatale, gabime, sinjalizime, hollësi, diagnostikim)",
    "Info, warnings, errors and fatal issues" : "Hollësi, sinjalizime, gabime dhe probleme fatale",
    ...
    "In a clustered setup please make sure to sync the config.php file across all nodes." : "Në një instalim kluster sigurohuni të njëkohësoni kartelën config.php në krejt nyjat.",
    ...
    "php does not seem to be setup properly to query system environment variables. The test with getenv(\"PATH\") only returns an empty response." : "PHP-ja nuk duket të jetë ujdisur si duhet për të kërkuar ndryshore mjedisi sistemi. Testi me getenv(\"PATH\") kthen vetëm një përgjigje të zbrazët.",
    ...
    "The Read-Only config has been enabled. This prevents setting some configurations via the web-interface. Furthermore, the file needs to be made writable manually for every update." : "Rregullimi Vetëm-Lexim u aktivizua. Kjo parandalon rregullimin e disa parametrave përmes ndërfaqes web. Më tej, për çdo përditësim, kartela lypset të kalohet dorazi si e shkrueshme.",
    "PHP is apparently setup to strip inline doc blocks. This will make several core apps inaccessible." : "Duket se PHP-ja është ujdisur që të heqë blloqe të brendshme dokumentimi. Kjo do t’i bëjë të papërdorshme disa aplikacione bazë.",
    ...
    "Transactional file locking is disabled, this might lead to issues with race conditions. Enable 'filelocking.enabled' in config.php to avoid these problems. See the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">documentation ↗</a> for more information." : "Kyçja e kartelave gjatë transaksioneve është e çaktivizuar, kjo mund të sjellë probleme me gjendje <em>race conditions</em>. Që të shmangni këto probleme, aktivizoni “filelocking.enabled” te config.php. Për më tepër hollësi shihni <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">dokumentimin ↗</a>.",
    "Transactional file locking should be configured to use memory-based locking, not the default slow database-based locking. See the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">documentation ↗</a> for more information." : "Kyçja e kartelave gjatë transaksioneve duhet formësuar që të përdorë kyçje me bazë kujtesën, jo kyçjen parazgjedhje, të ngadaltë, të bazuar në bazë të dhënash. Për më tepër hollësi, shihni <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">dokumentimin ↗</a>.",
    ...
    "Our Privacy Policy conditions:" : "Kushte të Rregullave tona të Privatësisë:",
    ...
    "Done" : "U bë",
    "To access your files through WebDAV, please use the following URL:" : "Që të hyni në kartelat tuaja përmes WebDAV-it, ju lutemi, përdorni URL-në vijuese:",
    "Version" : "Version",
    ...
    "Show creation time" : "Shfaq kohë krijimi",
