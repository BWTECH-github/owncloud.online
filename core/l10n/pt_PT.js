OC.L10N.register(
    "core",
    {
    "Login paused for a moment" : "Início de sessão pausado por um momento",
    "There were several failed attempts from your connection, so we are briefly slowing sign-in down to protect your account." : "Houve várias tentativas falhadas a partir da sua ligação, por isso estamos a abrandar brevemente o início de sessão para proteger a sua conta.",
    "You can try again in %s." : "Pode tentar novamente dentro de %s.",
    "You can try again now." : "Pode tentar novamente agora.",
    "Forgotten your password? Use the reset link instead of trying again." : "Esqueceu-se da palavra-passe? Use a ligação de reposição em vez de tentar novamente.",
    ...
    "You have enabled one or more Enterprise apps but your installation does not have a valid license yet." : "Você ativou um ou mais aplicativos owncloud.online Enterprise, mas sua instalação ainda não possui uma licença válida.",
    ...
    "To try the Enterprise apps, just start a 30-day demo and enter the provided license key below." : "Para experimentar o owncloud.online Enterprise, basta iniciar uma demonstração de 30 dias e digite a chave de licença fornecida abaixo.",
    "Upgrade to Enterprise" : "Atualize para owncloud.online Enterprise",
    ...
    "This server has no working Internet connection. This means that some of the features like mounting external storage, notifications about updates or installation of third-party apps will not work. Accessing files remotely and sending of notification emails might not work, either. We suggest to enable Internet connection for this server if you want to have all features." : "Este servidor owncloud.online não tem uma ligação de Internet a funcionar. Isto significa que algumas funcionalidades como o acesso a locais externos, notificações sobre actualizações, ou a instalação de aplicações de terceiros não irá funcionar. Aceder aos ficheiros remotamente e enviar notificações de email poderão não funcionar também. Sugerimos que active uma ligação à Internet se pretende obter todas as funcionalidades do owncloud.online.",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing the server from a trusted proxy. If you are not accessing the server from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to the server. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "A configuração dos headers do proxy reverso está incorreta, ou então está a aceder ao owncloud.online através de um proxy de confiança. Se não está a aceder ao owncloud.online através de um proxy de confiança, isto é um problema de segurança e poderá permitir a um invasor falsificar um endereço IP como visível para o owncloud.online. Mais informação pode ser encontrada na nossa <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentação</a>.",
    ...
    "The \"{header}\" HTTP header is misconfigured. Expected values are \"none\" or \"noindex, nofollow\". This is a potential security or privacy risk and we recommend adjusting this setting." : "O cabeçalho HTTP \"{header}\" está configurado incorretamente. Os valores esperados são \"nenhum\" ou \"noindex, nofollow\". Este é um risco potencial de segurança ou privacidade e recomendamos ajustar esta configuração.",
    ...
    "Choose a password - password policy may apply" : "Escolha uma senha - uma política de senha pode ser aplicada",
    "Password required" : "Palavra-passe necessária",
    "Link name" : "Nome de hiperligação",
    "Name" : "Nome",
    "Filename" : "Nome do ficheiro",
    "Password" : "Palavra-passe",
    "Download / View / Upload / Edit" : "Baixar / Visualizar / Carregar / Editar",
    "Recipients can view, download and edit contents." : "Os destinatários podem visualizar, baixar e editar o conteúdo.",
    ...
    "No users or groups found" : "Nenhum usuário ou grupo foi encontrado",
    ...
    "Share with people on other servers using the syntax username@example.com/owncloud" : "Compartilhe com as pessoas nas outras owncloud.onlines utilizando a sintaxe username@example.com/owncloud",
    ...
    "Share with users or federated users…" : "Compartilhe com usuários ou usuários federados ...",
    "Could not be shared with the following users: {users}" : "Não foi possível compartilhar com o seguintes usuários: {users}",
    "Add multiple users" : "Adicionar múltiplos usuários",
    ...
    "({scope})" : "({scope})",
    "Rename" : "Renomear",
    "Do you really want to remove the tag \"{tagName}\" and unassign it from all files and folders ?" : "Tem certeza de que deseja remover a etiqueta \"{tagName}\" e cancelar a atribuição de todos os arquivos e pastas?",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online issue tracker</a>." : "A actualização falhou. Por favor reporte este incidente seguindo este link <a href=\"https://github.com/BWTECH-github/owncloud.online/issues\" target=\"_blank\">owncloud.online community</a>.",
    "The update was successful. There were warnings." : "A atualização foi bem sucedida. Tem alguns avisos.",
    "The update was successful. Redirecting you to owncloud.online now." : "A atualização foi bem sucedida. A redirecioná-lo agora para o owncloud.online.",
    ...
    "Cheers!" : "Parabéns!",
    "The application was authorized successfully. You will now get redirected to the requested page, otherwise you can close this window." : "O aplicativo foi autorizado com sucesso. Agora você será redirecionado para a página solicitada, caso contrário, você pode fechar esta janela.",
    ...
    "Please specify the port number along with the host name (e.g., localhost:5432)." : "Especifique o número da porta junto com o nome do host (por exemplo, localhost:5432).",
    ...
    "This owncloud.online instance is currently in single user mode." : "Esta instância do owncloud.online está atualmente configurada no modo de único utilizador.",
    ...
    "You are accessing the server through an untrusted domain." : "Você está acessando o servidor por meio de um domínio não confiável.",
    ...
    "Upgrade needed" : "Atualização necessária",
    "It looks like your instance may host many files and/or users. To ensure a smooth upgrade process, please use the command line upgrade command (occ upgrade)." : "Parece que sua instância pode hospedar muitos arquivos e / ou usuários. Para garantir um processo de atualização tranquilo, use o comando de atualização da linha de comando (atualização occ).",
    "Automatic upgrading is not enabled in config.php. To upgrade your instance, please use the command line updater (occ upgrade)." : "A atualização automática não está habilitada em config.php. Para atualizar sua instância, use o atualizador de linha de comando (atualização occ).",
