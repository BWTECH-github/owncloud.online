OC.L10N.register(
    ...
    "Server version %s or higher is required." : "Krafist er owncloud.online %s eða hærra.",
    "Server version %s or lower is required." : "Krafist er owncloud.online %s eða lægra.",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "Ekki var hægt að setja upp forritið vegna þess að það er ekki samhæft þessari útgáfu owncloud.online",
    ...
    "%s" : "%s",
    "%s via %s" : "%s með %s",
    "Sharing %s failed, because the backend does not allow shares from type %d" : "Deiling %s mistókst, því bakvinnslukerfið leyfir ekki sameignir af gerðinni %d",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "Breyting á þessari stillingu í php.ini mun gera owncloud.online kleift að keyra aftur",
