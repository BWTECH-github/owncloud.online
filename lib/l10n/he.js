OC.L10N.register(
    ...
    "Server version %s or higher is required." : "נדרש owncloud.online %s ומעלה.",
    "Server version %s or lower is required." : "נדרש owncloud.online %s ומטה.",
    ...
    "App can't be installed because it is not compatible with this version of owncloud.online" : "היישום לא ניתן להתקנה כיוון שהוא אינו תואם את גרסת ה- owncloud.online הזו",
    ...
    "No license key available." : "אין מפתח רישיון זמין",
    "Invalid license key!" : "מפתח רישיון לא חוקי!",
    "Please contact your administrator or %s for a new license key." : "יש ליצור קשר עם האדמיניסטרטור שלך או %s למפתח רישיון חדש.",
    "Your Enterprise license key has expired." : "מפתח הרישיון הארגוני פג תוקף.",
    "Enterprise features have been disabled." : "תכונות תכנית ארגונית נוטרלו.",
    "Evaluation - expires in %d days." : "הערכה - פג תוקף עוד %d ימים.",
    "Your Enterprise license key is about to expire (days remaining: %d)." : "תוקף מפתח רישיון תכנית ארגונית עומד לפוג (מספר ימים שנשארו: %d).",
    "The registered enterprise license key expires in %d days" : "תוקף רישיון תכנית עסקית רשום פג תוקף עוד %d ימים",
    ...
    "%s enter the database name or connection string." : "%s יש להכניס את שם מסד הנתונים או את נתיב החיבור.",
    ...
    "Can't create or write into the apps-external directory %s" : "לא ניתן ליצור או לכתוב לתיקייה החיצונית של היישום %s",
    "Can't update %s - it is a directory" : "לא ניתן לעדכן את %s - מדובר בתיקייה",
    "Can't update %s" : "לא ניתן לעדכן %s",
    "Invalid Federated Cloud ID" : "זיהוי ענן מאוגד לא חוקי",
    "Internal mail notification for shared files is not allowed" : "שליחת התראות דוא״ל פנימיות לקבצים משותפים אסורה",
    "%s shared »%s« with you" : "%s שיתף/שיתפה איתך את »%s«",
    "Public link mail notification is not allowed" : "שליחת התראות דוא״ל על קישורים ציבוריים אסורה",
    "%s" : "%s",
    "%s via %s" : "%s על בסיס %s",
    "Sharing %s failed, because the backend does not allow shares from type %d" : "שיתוף %s נכשל, כיוון שצד השרת אינו מאפשר שיתופים מסוג %d",
    ...
    "Invalid permissions" : "הרשאות לא חוקיות",
    "Cannot remove all permissions" : "לא ניתן להסיר את כל ההרשאות",
    "Cannot set the requested share permissions for %s" : "לא ניתן להגדיר הרשאות בקשת שיתוף %s",
    "Cannot set the requested share attributes for %s" : "לא ניתן להגדיר משתני בקשת שיתוף %s",
    ...
    "Only the following characters are allowed in a username: \"a-z\", \"A-Z\", \"0-9\", and \"+_.@-'\"" : "רק התווים הבאים מאושרים לשם משתמש: \"a-z\", \"A-Z\", \"0-9\", and \"+_.@-'\"",
    ...
    "The username can not be longer than 64 characters" : "שם המשתמש אינו יכול להיות ארוך מ- 64 תווים",
    ...
    "Access to this resource or one of its sub-items has been denied." : "הגישה נדרחתה למשאב זה או לאחד מפריטי המשנה שלו.",
    "File cannot be downloaded" : "לא ניתן להוריד את הקובץ",
    ...
    "Adjusting this setting in php.ini will make owncloud.online run again" : "שינוי הגדרה זו בקובץ php.ini יאפשר ל- owncloud.online לרוץ שוב",
